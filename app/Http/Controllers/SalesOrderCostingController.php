...
$class_idss = $request->input('class_idss');
    ...
    public function update(Request $request, $soc_code,SalesOrderFabricCostingDetailActivityLog $loggerDetail,SalesOrderCostingMasterActivityLog $loggerMaster)
    {
        ...
        ->select('fabric_value','sewing_trims_value','packing_trims_value', 'production_value', 'transaport_value', 'other_value', 'agent_commision_value', 'dbk_value', 'printing_value', 'embroidery_value',
        'ixd_value', 'garment_reject_value', 'testing_charges_value', 'finance_cost_value', 'extra_value', 'total_cost_value', 'narration', 'is_approved')  
        ...
        ->first();
             ...
             $MasterOld = (array) $MasterOldFetch;
                  ...
                  $MasterNew=['fabric_value' => isset($request->fabric_value) && !is_nan((float)$request->fabric_value) ? $request->fabric_value : 0, 
                'sewing_trims_value' => isset($request->sewing_trims_value) && !is_nan((float)$request->sewing_trims_value) ? $request->sewing_trims_value : 0, 
                'packing_trims_value' => isset($request->packing_trims_value) && !is_nan((float)$request->packing_trims_value) ? $request->packing_trims_value : 0,  
                'production_value' => isset($request->production_value) && !is_nan((float)$request->production_value) ? $request->production_value : 0, 
                'other_value' => isset($request->other_value) && !is_nan((float)$request->other_value) ? $request->other_value : 0,  
            ...
            ->select('sr_no','class_id','description', 
            'consumption', 'rate_per_unit', 'wastage')  
     ...
     public function GetCostingData($soc_code)
    {
          ...
          //DB::enableQueryLog();
            ...
            ->get(['sales_order_costing_master.*','buyer_purchse_order_master.sam','usermaster.username','ledger_master.Ac_name','buyer_purchse_order_master.total_qty',
            'costing_type_master.cost_type_name','season_master.season_name','currency_master.currency_name',
            'sub_style_master.substyle_name','main_style_master.mainstyle_id','main_style_master.mainstyle_name','buyer_purchse_order_master.style_img_path','buyer_purchse_order_master.total_qty','buyer_purchse_order_master.order_received_date']);
          //    $query = DB::getQueryLog();
            //  $query = end($query);
            //   dd($query);
        ...
        public function GetCostingSalesOrderWiseData($sales_order_no)
        {
              ...
              //DB::enableQueryLog();
                ...
                ->get(['sales_order_costing_master.*','buyer_purchse_order_master.sam','usermaster.username','ledger_master.Ac_name',
                'costing_type_master.cost_type_name','season_master.season_name','currency_master.currency_name','buyer_purchse_order_master.order_type',
                'sub_style_master.substyle_name','main_style_master.mainstyle_id','main_style_master.mainstyle_name','buyer_purchse_order_master.style_img_path','buyer_purchse_order_master.total_qty','buyer_purchse_order_master.order_received_date']);
              //    $query = DB::getQueryLog();
                //  $query = end($query);
                //   dd($query);
    ...
    public function costingProfitSheet2()
     {
        ...
        'costing_type_master.cost_type_name','season_master.season_name','currency_master.currency_name',
        'sub_style_master.substyle_name','main_style_master.mainstyle_name','buyer_purchse_order_master.style_img_path','buyer_purchse_order_master.order_received_date']);
        // $query = DB::getQueryLog();
        // $query = end($query);
        // dd($query);
      ...
      public function costingProfitSheet3(Request $request)
     {
        ...
        ->get(['sales_order_costing_master.*','usermaster.username','ledger_master.Ac_name',
        'costing_type_master.cost_type_name','season_master.season_name','currency_master.currency_name',
        'sub_style_master.substyle_name','main_style_master.mainstyle_name','buyer_purchse_order_master.style_img_path','buyer_purchse_order_master.order_received_date','brand_master.brand_name']);
        // $query = DB::getQueryLog();
        // $query = end($query);
        // dd($query);
