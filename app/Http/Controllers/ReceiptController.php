...
return view('Receipt_Transaction_List', compact('data','chekform'));
...
return view('Receipt_Transaction',compact('firmlist','cashbank','gstlist','itemlist','paytypelist','ledgerlist','billlist'));
...
DB::select("update ledgerentry_details set Pending='".$PendingAmount."' where BillNo='".$request->input('ref_no')."' and firm_id='".$request->input('firm_id')."' and TrType=42");
...
$update = DB::select("update counter_number set tr_no= tr_no + 1   where c_name ='C1' AND type='RECEIPT' AND firm_id='".$request->input('firm_id')."'");                     


  return redirect()->route('Receipt_Transaction.index')->with('message', 'Add Record Succesfully');
...
return view('Receipt_Transaction',compact('firmlist','cashbank','gstlist','itemlist','paytypelist','ledgerlist','billlist','Receiptfetch'));
...
'c_code' => $request->input('c_code')
 ...
 return redirect()->route('Receipt_Transaction.index')->with('message', 'Update Record Succesfully');
...
return redirect()->route('Receipt_Transaction.index')->with('delete', 'Delete Record Succesfully');  
