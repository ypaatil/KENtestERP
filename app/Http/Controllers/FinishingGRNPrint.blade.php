...
<div id="printInvoice">
    ...
    <div  class="col-md-4">
      ...
      <b style="display: inline-block;text-align: left;" class="mt-1">GRN No:  </b> <span style="display: inline-block;text-align: right;"> {{ $FinishingInhouseMaster[0]->fns_code }} </span></br>     
      <b style="display: inline-block;text-align: left;" class="mt-1">GRN Date:  </b> <span style="display: inline-block;text-align: right;"> {{ $FinishingInhouseMaster[0]->fns_date }} </span></br>
...
<!-- Passenger Details -->
<h4 class="text-center mt-2" style="color: #000;font-size:20px;font-weight:bold;">Finishing GRN Details:</h4>
<div class="">
