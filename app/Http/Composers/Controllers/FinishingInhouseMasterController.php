...
class FinishingInhouseMasterController extends Controller
{
    ...
    public function create()
    {
       ...
       if(Session::get('vendorId')==56 && Session::get('user_type')!=6)
        {
           $VendorPurchaseOrderList= VendorPurchaseOrderModel::select('vendor_purchase_order_master.vpo_code','vendor_purchase_order_master.sales_order_no')->where('process_id',2)->get();
           $Ledger = LedgerModel::where('ledger_master.delflag','=', '0')->where('ledger_master.ac_code','>', '39')->get();
        ...
        {  
            ...
            $VendorPurchaseOrderList= VendorPurchaseOrderModel::select('vendor_purchase_order_master.vpo_code','vendor_purchase_order_master.sales_order_no')->where('process_id',2)->where('vendor_purchase_order_master.vendorId',$vendorId)->get();
            $Ledger = LedgerModel::where('ledger_master.delflag','=', '0')->where('ledger_master.ac_code','=', $vendorId)->get();
            
        }
        
        
        return view('FinishingInhouseMaster',compact( 'ItemList', 'MainStyleList','SubStyleList','FGList','BuyerList', 'VendorPurchaseOrderList','Ledger',  'counter_number'));
    }
...
$data1=array
   ...
   $InsertSizeData=DB::select('call AddSizeQtyFromFinishingInhouse("'.$TrNo.'")');
    ...
    {   
       ...
       return view('FinishingInhouseMasterEdit',compact('FinishingInhouseDetailList','ColorList' ,'BuyerList',  'MasterdataList','SizeDetailList','FinishingInhouseMasterList',  'ItemList',  'MainStyleList','SubStyleList','FGList','VendorPurchaseOrderList','Ledger' ));
}
