...
class PackingInhouseMasterController extends Controller
{
    ...
    public function index()
    {
        ...
        ->get(['packing_inhouse_master.*','usermaster.username','L1.Ac_name','L2.Ac_name as vendor_name']);
    ...
    public function create()
    {
       ...
       $SalesOrderList= BuyerPurchaseOrderMasterModel::select('buyer_purchse_order_master.tr_code as sales_order_no')->get();
        return view('PackingInhouseMaster',compact( 'ItemList', 'SalesOrderList','MainStyleList','SubStyleList','FGList','BuyerList', 'VendorPurchaseOrderList','Ledger',  'counter_number'));
    }
...
$data1=array
 ...
 public function PackingGRNPrint($pki_code)
    ...
    //   DB::enableQueryLog();
        ...
        //   $query = end($query);
        //   dd($query);
             return view('PackingGRNPrint', compact('PackingInhouseMaster','PackingGRNList','SizeDetailList'));
    ...
    {   
      ...
      group by vendor_purchase_order_size_detail.color_id");
        ...
        return view('PackingInhouseMasterEdit',compact('PackingInhouseDetailList','ColorList' ,'BuyerList',  'MasterdataList','SizeDetailList','PackingInhouseMasterList',  'ItemList',  'MainStyleList','SubStyleList','FGList','VendorPurchaseOrderList','Ledger' ));
}
...
DB::table('packing_inhouse_size_detail')->where('pki_code', $request->input('pki_code'))->delete();
DB::table('packing_inhouse_size_detail2')->where('pki_code', $request->input('pki_code'))->delete();
DB::table('packing_inhouse_detail')->where('pki_code', $request->input('pki_code'))->delete();
...
//         dd($query);
      ...
      $html .= '  <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
        ...
        $html.=' <td> <select name="color_id[]" class="select2-select"  id="color_id0" style="width:250px; height:30px;" required>
        <option value="">--Select Color--</option>';
...
$total_qty=0;
          ...
          <input type="number" name="size_qty_total[]" class="size_qty_total" value="" id="size_qty_total" style="width:80px; height:30px; float:left;" required readOnly  />
        <input type="hidden" name="size_qty_array[]"  value="" id="size_qty_array" style="width:80px; float:left;"  />
