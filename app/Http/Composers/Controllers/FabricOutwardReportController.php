...
class FabricOutwardReportController extends Controller
{
    ...
    public function store(Request $request)
    {
         ...
         ->join('ledger_master', 'ledger_master.Ac_code', '=', 'fabric_outward_master.Ac_code')
    ...
    //   DB::enableQueryLog();
         ...
         ->join('vendor_purchase_order_master', 'vendor_purchase_order_master.vpo_code', '=','fabric_outward_master.vpo_code')
        ...
        //   $query = end($query);
        //   dd($query);
             return view('FabricOutwardPrint', compact('FabricOutwardMaster'));
    ...
    //   DB::enableQueryLog();
        ...
        //   $query = end($query);
        //   dd($query);
             return view('FabricOutwardRollsPrint', compact('FabricOutwardMaster'));
