...
class CutPanelIssueMasterController extends Controller
{
    ...
    public function index()
    {
        ...
        ->get(['cut_panel_issue_master.*','usermaster.username','L1.Ac_name','L2.Ac_name as vendor_name','line_master.line_name']);
 ...
 $color_id= $request->input('color_id');
    ...
    //   DB::enableQueryLog();
        ...
        sum(size_qty_total) as size_qty_total  from 	cut_panel_issue_size_detail 
         inner join item_master on item_master.item_code=	cut_panel_issue_size_detail.item_code 
        ...
        //   $query = end($query);
        //   dd($query);
             return view('CutPanelIssuePrint', compact('CutPanelIssueMaster','CutPanelIssueList','SizeDetailList'));
  ...
  public function CutPanelStockSummary()
{
   ...
   return view('CutPanelStockSummary',compact('VendorPurchaseOrderList',  'ItemList',  'MainStyleList','SubStyleList','FGList', 'Ledger' ));
 }  
   ...
   public function CutPanelGRNReport()
{
   ...
   return view('CutPanelGRNReport',compact('VendorPurchaseOrderList',  'ItemList',  'MainStyleList','SubStyleList','FGList', 'Ledger' ));
 }  
  ...
  public function GetLineList(Request $request)
{
    $LineList = DB::table('line_master')->select('line_master.line_id',
     'line_name')->where('Ac_code','=',$request->Ac_code)->DISTINCT()->get();
    if (!$request->Ac_code)
    {
