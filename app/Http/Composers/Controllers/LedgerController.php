...
class LedgerController extends Controller
{
    ...
    public function index()
    {
        ...
        ->where('ledger_master.delflag','=', '0')->where('ledger_master.Ac_code','>', '39')
        ...
        return view('Ledger_Master_List', compact('Ledger'));
    ...
    {   $AcGroup = DB::table('accountgroup')->get();
        ...
        return view('Ledger_Master',compact('AcGroup','Countrys','State','District','Taluka','BusinessType','Account_Type'));
    }
...
$data2=array(
    ...
    'company_address'=>$request->company_address[$x],
    'consignee_address'=>$request->consignee_address[$x],
    ...
    public function edit($id)
    {
        ...
        return view('Ledger_Master',compact('Ledger','AcGroup','Countrys','State','District','Taluka','BusinessType','Account_Type','LedgerDetailList'));
