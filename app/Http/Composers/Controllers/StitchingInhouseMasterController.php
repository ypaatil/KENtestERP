...
if( $vendorId==56 && $user_type!=6)
 {
        ...
        ->get(['stitching_inhouse_master.*','usermaster.username','L1.Ac_name','L2.Ac_name as vendor_name']);
    // $query = DB::getQueryLog();
    //     $query = end($query);
    //     dd($query);
 }
 elseif($vendorId!=56 && $user_type==6)
 { 
        ...
        return view('StitchingInhouseMasterList', compact('StitchingInhouseMasterList','chekform'));
    }
...
$data1=array(
   ...
   $InsertSizeData=DB::select('call AddSizeQtyFromStitchingInhouse("'.$TrNo.'")');
    ...
    public function StitchingGRNDashboard()
    {
        ...
        ->get(['stitching_inhouse_size_detail2.*', 'L1.Ac_name','L2.Ac_name as vendor_name','size_detail.size_name','line_master.line_name','main_style_master.mainstyle_name','color_master.color_name']);
    // $query = DB::getQueryLog();
    //     $query = end($query);
    //     dd($query); 
