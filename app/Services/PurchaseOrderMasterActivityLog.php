...
class PurchaseOrderMasterActivityLog
{
   
    
public function logIfChangedPurchaseOrderMaster(string $table, $recordId,array $oldData, array $newData,string $action, string $AttendanceDate, string $module)
{
