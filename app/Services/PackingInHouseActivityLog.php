...
class PackingInHouseActivityLog
{
public function logIfChanged(string $table, $recordId, $color_id,array $olddata, array $newData,string $size_array, string $action, string $AttendanceDate, string $module)
{
