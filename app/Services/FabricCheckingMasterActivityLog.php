...
class FabricCheckingMasterActivityLog
{
   
    
public function logIfChangedFabricCheckingMaster(string $table, $recordId,array $oldData, array $newData,string $action, string $AttendanceDate, string $module)
{
