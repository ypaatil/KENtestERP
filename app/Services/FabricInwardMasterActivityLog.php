...
class FabricInwardMasterActivityLog
{
   
    
public function logIfChangedFabricInwardMaster(string $table, $recordId,array $oldData, array $newData,string $action, string $AttendanceDate, string $module)
{
