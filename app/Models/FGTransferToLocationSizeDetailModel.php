...
class FGTransferToLocationSizeDetailModel extends Model
{
    use HasFactory;

    protected $table='fg_trasnfer_to_location_size_detail';
 
	protected $fillable = [
         'fgt_code', 'fgt_date', 'Ac_code', 'sales_order_no', 'mainstyle_id',
