...
class BuyerJobCardModel extends Model
{
    use HasFactory;
	...
	protected $fillable = [
        ...
        'season_id',   'rate_per_piece','prod_qty', 'total_amount','ppk_ratio','color_id',
         'piece_avg', 'narration', 'userId',  'created_at', 'updated_at','c_code','size_counter',
    ];
