...
class PackingInhouseSizeDetailModel extends Model
{
    use HasFactory;

    protected $table='packing_inhouse_size_detail';
 
	protected $fillable = [
         'pki_code', 'pki_date', 'vpo_code', 'Ac_code', 'sales_order_no', 'vendorId', 'mainstyle_id',
