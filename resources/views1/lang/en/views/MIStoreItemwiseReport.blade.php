...
<div class="card">
<div class="card-body">
<h4 class="card-title mb-4">Itemwise Material Inward Report</h4>
@if ($errors->any())
...
<form action="{{ route('MIitempdf')}}" method="POST" enctype="multipart/form-data">
@csrf 
<div class="row">
<div class="col-md-4">
    <div class="mb-3">
        <label for="po_date" class="form-label">Item</label>
