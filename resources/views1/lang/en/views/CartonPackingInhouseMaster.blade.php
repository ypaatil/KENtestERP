...
<form action="{{route('CartonPackingInhouse.store')}}" method="POST" enctype="multipart/form-data">
@csrf 
<div class="row">
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="cpki_date" class="form-control" id="cpki_date" value="{{date('Y-m-d')}}" required readOnly>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Corton Packing Entry</a>
        </h4>
      </div>
