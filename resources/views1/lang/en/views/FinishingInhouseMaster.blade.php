...
<form action="{{route('FinishingInhouse.store')}}" method="POST" enctype="multipart/form-data">
@csrf 
<div class="row">
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="fns_date" class="form-control" id="fns_date" value="{{date('Y-m-d')}}" required  >
