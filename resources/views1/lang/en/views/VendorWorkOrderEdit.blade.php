...
@foreach($CostTypeList as  $row)
{
    <option value="{{ $row->cost_type_id }}"
     {{ $row->cost_type_id == $VendorWorkOrderMasterList->cost_type_id ? 'selected="selected"' : '' }}  
...
@foreach($SeasonList as  $row)
{
    <option value="{{ $row->season_id }}"
     {{ $row->season_id == $VendorWorkOrderMasterList->season_id ? 'selected="selected"' : '' }}   
...
@foreach($CurrencyList as  $row)
{
    <option value="{{ $row->cur_id }}"
     {{ $row->cur_id == $VendorWorkOrderMasterList->currency_id ? 'selected="selected"' : '' }}
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="number" name="order_rate" class="form-control" id="order_rate" value="{{$VendorWorkOrderMasterList->order_rate}}" required readOnly>
    </div>
</div>
...
<div class="table-responsive">
  <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Work Order Qty</a>
        </h4>
      </div>
...
<td> <select name="color_id[]"   id="color_id" style="width:200px; height:30px;" required>
...
<td ><input style="width:80px; float:left;" max='{{$szQty}}' name="s@php echo $n++; @endphp[]" class="size_id" type="number" id="s1" value="{{$szQty}}" required />  </td>
...
<td> <select name="item_codesx[]" class="item_trim_fabric" id="item_codesx" style="width:200px; height:30px;" required disabled>
<option value="">--Item List--</option>
...
<td> <select name="unit_idsx[]" class="select2" id="unit_idsx" style="width:100px; height:30px;" required disabled >
<option value="">--Unit List--</option>
@foreach($UnitList as  $row)
{
    <option value="{{ $row->unit_id }}"
...
<tr>
<td><input type="text" name="id" value="@php echo $no; @endphp" id="id" style="width:50px;" readOnly/></td>
<td> <select name="item_codes[]" class="item_sewing_trims" id="item_codes" style="width:200px; height:30px;" required disabled>
<option value="">--Item List--</option>
...
<td><input type="text"    name="descriptions[]" readOnly value="{{$List->description}}" id="descriptions" style="width:200px; height:30px;" required /></td> 
...
<td> <select name="class_idss[]"   id="class_idss" style="width:200px; height:30px;" required>
<option value="">--Classification--</option>
...
<td>
<input type="text"    name="descriptionss[]" value="{{$List->description}}" id="descriptionss" style="width:200px; height:30px;" required /></td> 
...
<td> <select name="unit_idss[]" class="select2" id="unit_idss" style="width:100px; height:30px;" required >
<option value="">--Unit List--</option>
@foreach($UnitList as  $row)
{
    <option value="{{ $row->unit_id }}"
...
<div class="mb-3">
<input type="number" name="vendorRate" class="form-control" id="vendorRate"  value="{{  $VendorWorkOrderMasterList->vendorRate }}" required step="0.01" />
</div>
</div>      
