...
<form action="{{route('OtherPurchase.update',$purchasefetch)}}" method="POST">
...
<input type="text" name="pur_code" class="form-control" id="pur_code" value="{{ $purchasefetch->pur_code }}" readonly="readonly">
...
<input type="text" name="pur_bill_no" class="form-control" id="formrow-email-input" value="{{ $purchasefetch->pur_bill_no }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Purchase Bill Date</label>
<input type="date" name="pur_bill_date" class="form-control" id="formrow-email-input" value="{{ $purchasefetch->pur_bill_date }}">
</div>
</div>
...
{{ $rowledger2->ac_code == $purchasefetch->Purchase_Ac_code ? 'selected="selected"' : '' }}
...
<td><input readOnly style="width:80px;"  type="number" id="disc_amount" step="0.01" class="" name="disc_amounts[]" value="{{ $row->disc_amount }}"></td>
...
<input type="text" name="tds_per" class="form-control" id="tds_per" onkeyup="tds_payable();" value="{{ $purchasefetch->tds_per }}">
</div>
</div>
...
<input type="text" name="tds_amt" class="form-control" id="tds_amt" value="{{ $purchasefetch->tds_amt }}">
</div>
</div>
...
<input type="text" name="payable_amt" class="form-control" id="payable_amt" value="{{ $purchasefetch->payable_amt }}">
</div>
</div>
