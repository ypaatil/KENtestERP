...
<div class="col-md-2">
    <div class="mb-3">
       ...
       <select name="vw_code" class="form-control" id="vw_code" required  onChange="getSalesOrderDetails(this.value);" disabled>
...
<input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$StitchingInhouseMasterList->total_qty}}" required readOnly>
</div>
</div>
