...
<form action="{{route('MaterialOutward.update',$MaterialOutwardMasterList)}}" method="POST" enctype="multipart/form-data">
@method('put')    
@csrf 
<div class="row">
<div class="col-md-2">
...
<input type="hidden" name="MoCode" value="{{ $MaterialOutwardMasterList->MoCode  }}" class="form-control" id="formrow-email-input">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="out_date" class="form-control" id="out_date" value="{{ $MaterialOutwardMasterList->out_date  }}">
    </div>
</div>
