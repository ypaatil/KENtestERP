                                ...
                                <div class="card">
                                    ...
                                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                          <thead>
                                            ...
                                            @foreach($FabricOutwardList as $row)    
                                            <tr>
                                                ...
                                                <td>{{ $row->updated_at }}</td>
                                                 ...
                                                 @if($chekform->edit_access==1)
                                                         ...
                                                         <td> 
                                <a class="btn btn-outline-secondary btn-sm print" href="TrimOutwardPrint/{{ $row->trimOutCode }}" title="Print">
                                            <i class="fas fa-print"></i>
                                 </a>
                                    </td>
                                                
                                                 <td>
                                                <a class="btn btn-outline-secondary btn-sm edit" href="{{route('TrimsOutward.edit', $row->trimOutCode)}}" title="Edit">
        ...
        <td>
                                <a class="btn btn-outline-secondary btn-sm edit" href="" title="Edit">
                                   ...
                                   @endif
                                                ...
                                                <td>
                                                  <button  class="btn   btn-sm delete"  data-placement="top" id="DeleteRecord" data-token="{{ csrf_token() }}" data-id="{{ $row->trimOutCode }}"  data-route="{{route('TrimsOutward.destroy', $row->trimOutCode )}}" title="Delete">
