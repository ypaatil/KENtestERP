...
<h4 class="mb-sm-0 font-size-18">General  Sales</h4>

<div class="page-title-right">
<ol class="breadcrumb m-0">
<li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
<li class="breadcrumb-item active">General  Sales</li>
</ol>
</div>
...
<form action="{{route('GeneralSales.update',$salesfetch)}}" method="POST">
...
{{ $row->firm_id == $salesfetch->firm_id ? 'selected="selected"' : '' }}
...
<input type="text" name="bill_code" class="form-control" id="bill_code" value="{{ $salesfetch->bill_code }}" readonly="readonly">
<input type="hidden" name="c_code" id="c_code" value="{{ $salesfetch->c_code }}" />
...
<input type="date" name="bill_date" class="form-control" id="formrow-email-input" value="{{ $salesfetch->bill_date }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
...
{{ $rowpay->pay_type == $salesfetch->pay_type ? 'selected="selected"' : '' }}
...
{{ $rowgst->tax_type_id == $salesfetch->tax_type_id ? 'selected="selected"' : '' }}
...
{{ $rowledger->ac_code == $salesfetch->Ac_code ? 'selected="selected"' : '' }}
...
@php  if($detailsales->isEmpty()) { @endphp
...
<td><input style="width:80px;" type="number" step="0.01" class="" id="disc_per" name="disc_pers[]" value="{{ $row->disc_per }}"></td>
<td><input readOnly style="width:80px;"  type="number" step="0.01" class="" id="disc_amount" name="disc_amounts[]" value="{{ $row->disc_amount }}"></td>
<td><input readOnly style="width:80px;"  type="number" step="0.01" class="" id="mrp" name="mrps[]" value="{{ $row->mrp }}"></td>
<td><input readOnly style="width:80px;"  type="number" step="0.01"  class="" id="pur_cgst" name="pur_cgsts[]" value="{{ $row->pur_cgst }}"></td>
<td><input  style="width:80px;"  type="number" step="0.01" class="GSTAMT" name="camts[]" id="camt" value="{{ $row->camt }}"></td>
...
<td><input readOnly style="width:80px;"  type="number" step="0.01" class=""  id="pur_igst" name="pur_igsts[]" value="{{ $row->pur_igst }}"></td>
...
<br/>
<input type="hidden"   name="cnt" id="cnt" value="{{ count($detailsales) }}">
<div class="row">
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Gross Amount</label>
<input type="text" name="Gross_amount" class="form-control" id="Gross_amount" onChange="mycalc();"  value="{{ $salesfetch->Gross_amount }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Add 1</label>
<input type="text" name="add1" id="add1" class="form-control" id="add1" onkeyup="mycalc();" value="{{ $salesfetch->add1 }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Add 2</label>
<input type="text" name="add2" id="add2" class="form-control" id="add2" onkeyup="mycalc();" value="{{ $salesfetch->add2 }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Less 1</label>
<input type="text" name="less1"  class="form-control" id="less1" onkeyup="mycalc();" value="{{ $salesfetch->less1 }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Less 2</label>
<input type="text" name="less2"  class="form-control" id="less2" onkeyup="mycalc();" value="{{ $salesfetch->less2 }}">
</div>
</div>
...
<input type="text" name="Gst_amount" id="Gst_amount" class="form-control" id="Gst_amount" value="{{ $salesfetch->Gst_amount }}" OnChange="mycalc();">
</div>
</div>
</div>
...
<input type="text" name="Net_amount" id="Net_amount" class="form-control" id="Net_amount" value="{{ $salesfetch->Net_amount }}" OnChange="mycalc();">
</div>
</div>
...
<input type="text" name="narration" class="form-control" id="narration" value="{{ $salesfetch->narration }}">
</div>
</div>	
</div>
...
t7.id = "mrps"+index;
t7.name= "mrps[]";
t7.value=document.getElementById("mrp").value;
...
t8.type="number";
t8.step="0.01";
t8.id = "pur_cgsts"+index;
t8.name= "pur_cgsts[]";
t8.value=document.getElementById("pur_cgst").value;
...
t9.id = "camts"+index;
t9.name= "camts[]";
t9.value=document.getElementById("camt").value;
...
t10.type="number";
t10.step="0.01";
t10.id = "pur_sgsts"+index;
t10.name= "pur_sgsts[]";
t10.value=document.getElementById("pur_sgst").value;
...
t11.id = "samts"+index;
t11.name= "samts[]";
t11.value=document.getElementById("samt").value;
...
t12.type="number";
t12.step="0.01";
t12.id = "pur_igsts"+index;
t12.name= "pur_igsts[]";
t12.value=document.getElementById("pur_igst").value;
...
t13.type="number";
t13.step="0.01";
t13.className="GSTAMT";
t13.id = "iamts"+index;
t13.name= "iamts[]";
t13.value=document.getElementById("iamt").value;
...
t14.step="0.01";
t14.className="GROSS";
t14.id = "amounts"+index;
t14.name= "amounts[]";
t14.value=document.getElementById("amount").value;
...
t15.type="number";
t15.step="0.01";
t15.className='TOTAMT';
t15.id = "total_amounts"+index;
t15.name= "total_amounts[]";
t15.value=document.getElementById("total_amount").value;
