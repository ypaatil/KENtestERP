...
<div class="card">
<div class="card-body">
<h4 class="card-title mb-4">Material Inward</h4>
@if ($errors->any())
...
<form action="{{route('InwardStore.store')}}" method="POST">
...
<input type="text" class="form-control" id="formrow-email-input" readonly="readonly">
...
{
<option value="{{ $rowinwardtype->inwardTypeId }}">{{ $rowinwardtype->inwardType }}</option>
...
<input type="text" name="pur_bill_no" class="form-control" id="pur_bill_no" disabled="disabled">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Invoice Date</label>
<input type="date" name="pur_bill_date" class="form-control" id="pur_bill_date" disabled="disabled">
</div>
</div>
</div>
...
<input type="text" name="dc_no" class="form-control" id="dc_no" disabled="disabled">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Challan Date</label>
<input type="date" name="dc_date" class="form-control" id="dc_date" disabled="disabled">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-inputState" class="form-label">PO No</label>
<select name="po_no" class="form-select" id="pur_code" onchange="gettable(this.value);getDetails(this.value)" disabled="disabled">
...
<select name="loc_id" class="form-select" id="loc_id" required="required">
<option value="">--- Select Location ---</option>
@foreach($locationlist as  $rowLocation)
{
<option value="{{ $rowLocation->loc_id  }}">{{ $rowLocation->location }}</option>
...
<input type="text" name="totFreightAmt"  class="form-control" id="totFreightAmt" value="0">
</div>
</div>
...
function gettable(pur_code){

  //alert(pur_code);

$.ajax({
type:"GET",
url:"{{ route('getPoDetails') }}",
//dataType:"json",
...
function getDetails(pur_code){

$.ajax({
type:"GET",
url:"{{ route('getPoMasterDetails') }}",
//dataType:"json",
data:{pur_code:pur_code},
success:function(response){
console.log(response);
...
$("#Gross_amount").val(response[0].Gross_amount);
$("#Gst_amount").val(response[0].Gst_amount);
$("#totFreightAmt").val(response[0].totFreightAmt);
$("#Net_amount").val(response[0].Net_amount);
$("#narration").val(response[0].narration);
$("#gstNo").val(response[0].gstNo);
$("#address").val(response[0].address);
$("#deliveryAddress").val(response[0].deliveryAddress);
$("#supplierRef").val(response[0].supplierRef);
$("#firm_id").val(response[0].firm_id);
