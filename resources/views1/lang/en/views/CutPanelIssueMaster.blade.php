...
<form action="{{route('CutPanelIssue.store')}}" method="POST" enctype="multipart/form-data">
@csrf 
<div class="row">
...
<div class="col-md-2">
    <div class="mb-3">
       ...
       <select name="vw_code" class="form-control" id="vw_code" required  onChange="getVendorWorkOrderDetails(this.value);">
