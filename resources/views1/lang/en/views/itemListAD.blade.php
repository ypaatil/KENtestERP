...
<a href="{{ 0 }}"><button type="button" class="btn btn-success w-md float-right">Active</button></a>&nbsp; &nbsp; &nbsp;
 
<a href="{{ 1 }}"><button type="button" class="btn btn-danger w-md float-right">InActive</button></a>
</div>  
