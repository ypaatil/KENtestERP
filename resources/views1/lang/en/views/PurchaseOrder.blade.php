...
<select name="Ac_code" class="form-select" id="Ac_code" onchange="getPartyDetails();" required>
...
<select name="bom_type" class="form-select select2" id="bom_type" onchange="getBomDetail(this.value);">
