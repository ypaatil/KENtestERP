                     ...
                     <table id="footable_2" class="table  table-bordered table-striped m-b-0 footable_2">
                        ...
                        <tbody id="bomdis">
                           ...
                           <tr>
                              ...
                              <td><button type="button" onclick=" mycalc();" class="btn btn-warning pull-left">+</button> <input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone(this);" value="X" ><button type="button" onclick="stockAllocate();" class="Abutton btn btn-secondary pull-left">Allocate</button> </td>
                           </tr>
                           @php 
                               } 
                               else 
                           ...
                           <tr>
                              ...
                              <span onclick="openmodal({{ isset($po_sr_no[0]->sr_no) ? $po_sr_no[0]->sr_no : 'Opening'}},{{ $row->item_code }});" style="color:#556ee6; cursor: pointer;">  {{$row->item_code}} </span>
                              ...
                              <td>
                                 <select name="item_codes[]" class="select2" id="item_codes"  class="select2" style="width:200px;height:30px;" onchange="GetUnit(this);" disabled>
                                    ...
                                    <option value="{{ $rowitem->item_code  }}" {{ $rowitem->item_code == $row->item_code ? 'selected="selected"' : '' }}>{{ $rowitem->item_name }}-({{ $rowitem->item_code  }})</option>
                              ...
                              <td style="display: flex;">
                                  ...
                                  <button type="button" name="allocate[]"  onclick="stockAllocate(this);" item_code="{{$row->item_code}}" isClick="{{$isclick}}" qty="{{$row->item_qty}}" bom_code="{{$row->bom_code}}" cat_id="{{$row->cat_id}}" class_id="{{$row->class_id}}"  class="btn btn-success pull-left ml-2" style="margin-left: 10px;">Allocate</button> 
                              </td>
                           </tr>
                           @php    $no=$no+1;  @endphp
                           @endforeach
