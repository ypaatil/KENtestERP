...
<form action="{{ route('BundleBarcode.update',$BundleBarcodeList) }}" method="POST" enctype="multipart/form-data">
@method('put')
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="bb_date" class="form-control" id="bb_date" value="{{ $BundleBarcodeList->bb_date }}" required readOnly>
...
<select name="task_id" class="form-select" id="task_id" required disabled>
...
<input type="text" name="style_no" class="form-control" id="style_no" value="{{$BundleBarcodeList->style_no}}" required readOnly>
<input type="hidden" name="vpo_code" class="form-control" id="vpo_code" value="{{$BundleBarcodeList->vpo_code}}" required>
</div>
</div>
...
<input type="text" name="style_description" class="form-control" id="style_description" value="{{$BundleBarcodeList->style_description}}" required readOnly>
...
<td class="bdl"><input type="text" readOnly class="bundlenos"  name="bundleno[]" value="{{ $bundle }}" id="bundleno{{ $bundle }}" style="width:80px;" required /></td>
@endforeach
<td>
...
<div class="row">
    ...
    <div class="mb-3">
       ...
       <select name="jpart_id[]" class="form-select" id="jpart_id"   multiple>
