...
<h4 class="mb-sm-0 font-size-18">Purchase/Inward From Party</h4>
...
<form action="{{route('Fabric_Purchase.store')}}" method="POST">
...
<input type="text" name="pur_code" class="form-control" id="pur_code" value="" readonly="readonly">
...
<datalist id="pur_style_nos" name="pur_style_nos[]" style="width:200px;">
...
<input type="number" name="pur_tqty" id="pur_tqty" class="form-control" placeholder="TotalQty" value="" readOnly required/>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Total Meter</label>
<input type="number" name="pur_tmeter" id="pur_tmeter" class="form-control"  value="" placeholder="Total Meter"  readOnly required/>
</div>
</div>
...
<input type="number" step="0.01" name="pur_add1" id="pur_add1" class="form-control" placeholder="Add1" value="0" onkeyup="calculateGST();" required/>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Add2</label>
<input type="number" v name="pur_add2" id="pur_add2" class="form-control" placeholder=" Add2" value="0" onkeyup="calculateGST();" required/>
</div>
</div>
...
<input type="number" step="0.01" name="pur_less1" id="pur_less1" class="form-control" placeholder="Less1" value="0" onkeyup="calculateGST(); required"/>
</div>
</div>
...
<input type="number" step="0.01" name="pur_less2" id="pur_less2" class="form-control" placeholder=" Less2" value="0" onkeyup="calculateGST(); required"/>
</div>
</div> 
...
<input type="number" step="0.01" name="pur_CGST" id="pur_CGST" class="form-control" placeholder=" CGST" value="0" readOnly required/>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">CGST Amount</label>
<input type="number" step="0.01" name="pur_camt" id="pur_camt" class="form-control" placeholder=" C Amount" value="0" readOnly required/>
</div>
</div>
...
<input type="number" step="0.01" name="pur_SGST" id="pur_SGST" class="form-control" placeholder=" SGST" value="0" readOnly required/>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">SGST Amount</label>
<input type="number" step="0.01" name="pur_samt" id="pur_samt" class="form-control" placeholder=" S Amount" value="0" readOnly required/>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">IGST</label>
<input type="number" step="0.01" name="pur_IGST" id="pur_IGST" class="form-control" placeholder=" IGST" value="0" readOnly required/>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">IGST Amount</label>
<input type="number" step="0.01" name="pur_iamt" id="pur_iamt" class="form-control" placeholder="I Amount" value="0" readOnly required/>
</div>
</div>
...
<input type="number" step="0.01" name="pur_gamt" id="pur_gamt" class="form-control" placeholder=" Gross Amount" value="" onkeyup="calculateGST();" required/>
</div>
</div>
...
<input type="number" step="0.01" name="pur_gstamt" id="pur_gstamt" class="form-control" placeholder=" GST Amount" value="" readOnly required/>
</div>
</div>
...
<input type="number" step="0.01" name="pur_namt" id="pur_namt" class="form-control" placeholder=" Net Amount" value="" readOnly required/>
</div>
</div>
