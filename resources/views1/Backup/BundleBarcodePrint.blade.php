...
@foreach($BundleBarcodeSerialDetailList as $List) 
                ...
                @endphp
                        ...
                        <div class="column" style="border-style: solid;  border-width: 1px; height:200px; width:270px; ">
                          <h3>BNo: {{ $List->bundle_id }}</h3>  <span style="padding:10px;;" class="col-md-6 dot"></span>
                          ...
                          <table style="margin-left:40px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  <th>{{ $List->size_serial_no }}</th>
                                  <th>({{$results[0]->size_name}})</th>
                                  <th>{{ $List->layers }}</th>
                                 </tr>
                                    <tr>
                                  <th colspan="3">{{++$pc_no}} To {{ ($pc_no + $List->layers) }}</th>
                                </tr>
                            </tbody>
                          </table>
                           </p>
