...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">DHU-Stiching Operation Master</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
               <li class="breadcrumb-item active">DHU-Stiching Operation Master</li>
            </ol>
         </div>
      </div>
   </div>
   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            @if(isset($dhuList))
            <form action="{{ route('DHUStichingOperation.update',$dhuList) }}" method="POST">
               @method('put')
               @csrf 
               <div class="row">
                  <div class="col-md-6">
               ...
               <div>
                  ...
                  <a href="{{route('DHUStichingOperation.index')}}" class="btn btn-danger w-md">Cancel</a>
               </div>
            </form>
            @else
            <form action="{{route('DHUStichingOperation.store')}}" method="POST">
               @csrf 
               <div class="row">
                  <div class="col-md-6">
                     <div class="mb-3">
