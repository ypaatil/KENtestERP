...
<div id="printInvoice">
    ...
    State Code/ Name : 27 - Maharastra    
         ...
         <div  class="col-md-4" style="border: 1px solid;"  ><p><b>  PO No:  </b>    {{ $poMaster[0]->pur_code }}</p>
      ...
      <th> </th>
       <th> </th>
        <th style="text-align:right;">{{money_format('%!i',round($poMaster[0]->total_qty,2))}}</th>
         <th> </th>
         <th> </th>
    <th style="text-align:right;">{{money_format('%!i',round($poMaster[0]->Gross_amount,2))}} </th> 
...
<td class="font-weight-600" style="text-align:right;"> <h4>{{ money_format('%!i',$poMaster[0]->Net_amount) }}  </h4></td>
...
<td style="text-align:right;"><span  class="font-weight-600">For KEN GLOBAL DESIGNS PRIVATE LIMITED</span>
<br>
<br>
<br>
