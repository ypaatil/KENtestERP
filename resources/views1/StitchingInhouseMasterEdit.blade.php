...
<form action="{{ route('StitchingInhouse.update',$StitchingInhouseMasterList) }}" method="POST" enctype="multipart/form-data">
@method('put')
@csrf
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="sti_date" class="form-control" id="sti_date" value="{{$StitchingInhouseMasterList->sti_date}}" required  >
