...
<form action="{{ route('OutwardForPacking.update',$OutwardForPackingMasterList) }}" method="POST" enctype="multipart/form-data">
@method('put')
@csrf
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="ofp_date" class="form-control" id="ofp_date" value="{{$OutwardForPackingMasterList->ofp_date}}" required  >
        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $OutwardForPackingMasterList->c_code }}">
        <input type="hidden" name="ofp_code" class="form-control" id="ofp_code" value="{{$OutwardForPackingMasterList->ofp_code}}" required readOnly>
...
@foreach($VendorProcessOrderList as  $row)
{
    <option value="{{ $row->vpo_code }}"
      ...
      {{ $row->vpo_code == $OutwardForPackingMasterList->vpo_code ? 'selected="selected"' : '' }} 
...
<input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$OutwardForPackingMasterList->sales_order_no}}" required readOnly>
</div>
</div>
...
<input type="text" name="vendor_rate" class="form-control" id="vendor_rate" value="{{$OutwardForPackingMasterList->vendor_rate}}" required readOnly>
</div>
</div>   
...
<input type="text" name="style_no" class="form-control" id="style_no" value="{{$OutwardForPackingMasterList->style_no}}" required readOnly>
</div>
</div>
...
<input type="text" name="style_description" class="form-control" id="style_description" value="{{$OutwardForPackingMasterList->style_description}}" required readOnly>
</div>
</div>
   ...
   <div class="panel-group" id="accordion">
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapsex">Packing GRN Against Work Order Qty</a>
        </h4>
      </div>
...
<input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$OutwardForPackingMasterList->total_qty}}" required readOnly>
</div>
</div>
...
<input type="text" name="vendor_amount" class="form-control" id="vendor_amount" value="{{$OutwardForPackingMasterList->vendor_amount}}" required readOnly>
