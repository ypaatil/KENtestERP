                         ...
                         <tbody>
                            ...
                            <tr>
                               ...
                               //DB::enableQueryLog();            
                                ...
                                AND sales_order_no = '".$row->sales_order_no."' AND size_id=".$size5->size_id."
                               ...
                               @php
                                ...
                                AND sales_order_no = '".$row->sales_order_no."' AND size_id=".$size1->size_id."
                               ...
                               <td class="text-right" nowrap style="background: #eaefa2;">{{money_format('%!.0n',$passTotalQty)}}</td>
                                ...
                                $QCStitchingDetails1 = DB::select("SELECT ifnull((select  qcstitching_inhouse_size_reject_detail2.size_qty from 
