   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form action="{{ route('SalesOrderCosting.update',$SalesOrderCostingMasterList->soc_code) }}" method="POST" enctype="multipart/form-data">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="transport_ocr_cost" class="form-control" id="transport_ocr_cost" value="{{ $SalesOrderCostingMasterList->transport_ocr_cost }}" >
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Testing OCR Cost</label>
                        <input type="text" name="testing_ocr_cost" class="form-control" id="testing_ocr_cost" value="{{ $SalesOrderCostingMasterList->testing_ocr_cost }}">
                     </div>
                  </div>
               </div>
               <div class="row">
                        ...
                        <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <input type="text"    name="descriptions[]" value="0" id="descriptions" style="width:200px; height:30px;"   />
                                 </td>
                        ...
                        <table id="footable_4" class="table  table-bordered table-striped m-b-0  footable_4">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td> 
                                    <input type="text"    name="descriptionss[]" value="0" id="descriptionss" style="width:200px; height:30px;"   />
                                 </td>
               ...
               <div class="row">
                  ...
                  <table  >
                     ...
                     <tr>
                        ...
                        <td>   <input type="text" name="fabric_per" class="" id="fabric_per" style="width:150px;" value="{{ number_format((float)$percentOffabric, 2, '.', '') }}" required  readOnly>
                        </td>
                     ...
                     <tr>
                        ...
                        <td>  <input type="text" name="sewing_trims_per" class="" id="sewing_trims_per" style="width:150px;" value="{{  number_format((float)$percentOfsewing_trims_value, 2, '.', '') }}" required readOnly >
                        </td>
                     ...
                     <tr>
                        ...
                        <td>   <input type="text" name="packing_trims_per"  id="packing_trims_per" style="width:150px;" value="{{  number_format((float)$percentOfpacking_trims_value, 2, '.', '') }}" required readOnly ></td>
                        <td id="percentofpacking_trims_value">{{  number_format((float)$percentOfpacking_trims_value, 2, '.', '') }}</td>
                     </tr>
                     <tr>
                        <td>      
                           <label for="production_value" class="form-label">Manufacturing Cost</label>
                        </td>
                        ...
                        <td>   <input type="text" name="production_per" id="production_per" style="width:150px;" value="{{  number_format((float)$percentOfproduction_value, 2, '.', '')  }}" required  onchange="calculate_percentage_value();">
                        </td>
                     ...
                     <tr>
                        ...
                        <td>   <input type="text" name="agent_commission_per"  id="agent_commission_per" style="width:150px;" value="{{ number_format((float)$percentOfagent_commision_value, 2, '.', '') }}" required  onchange="calculate_percentage_value();">
                        </td>
                     ...
                     <tr>
                        ...
                        <td>  <input type="text" name="transport_per" class="" id="transport_per" style="width:150px;" value="{{  number_format((float)$percentOftransaport_value, 2, '.', '') }}" required  onchange="calculate_percentage_value();">
                        </td>
                     ...
                     <tr>
                        ...
                        <td>  <input type="text" name="other_per" class="" id="other_per" style="width:150px;" value="{{ number_format((float)$percentOfother_value, 2, '.', '') }}" required  onchange="calculate_percentage_value();">
                        </td>
                     ...
                     <tr>
                        ...
                        <td>  <input type="text" name="dbk_per" class="" id="dbk_per" style="width:150px;" value="{{ number_format((float)$percentOfdbk_value, 2, '.', '') }}" required  onchange="calculate_percentage_value();">
                        </td>
                     ...
                     <tr>
                        ...
                        <td>  <input type="text" name="total_cost_per" class="" id="total_cost_per" style="width:150px;" value="{{number_format((float)$percentOftotal_cost_value, 2, '.', '') }}" required readOnly>
                        </td>
                     ...
                     <tr>
                        ...
                        <td>  <input type="text" name="profit_per" class="" id="profit_per" style="width:150px;" value="{{number_format((float)$profitpercentage, 2, '.', '')}}" required readOnly>
                        </td>
               ...
               <div class="col-sm-12 mt-5 hide" id="imgDiv">  
                 <img id="mainstyle_image" width="700" height="300" src="https://ken.korbofx.com/uploads/MainStyleImages/">  
               </div>
         </form>
         @endif
         </div>
