      ...
      <div class="card-body">
         <div class="d-flex">
            <div class="flex-grow-1">
               ...
               <h4 class="mb-0" style="color:#fff;">{{money_format('%!i',round($Amt,2))}} </h4>
            </div>
                  ...
                  <tbody>
                    ...
                    @endphp
                     ...
                     <tr>
                        ...
                        <td style="text-align:right;"> {{ number_format( round(($row->item_qty-$row->out_qty)*$row->item_rate))}} </td>
                     ...
                     @php
                        $total_value = $total_value + (($row->item_qty-$row->out_qty) * $row->item_rate);
                     @endphp
                     @endforeach 
                     @if($isOpening == 2)
                     ...
                     @endforeach
                      @endif
                     <input type="hidden" id="total_value" value="{{round($total_value,2)}}">
                  </tbody>
               </table>
            </div>
         </div>
