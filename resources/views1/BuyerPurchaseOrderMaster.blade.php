               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="date" name="from_tna_date" class="form-control" id="from_tna_date" value="{{date('Y-m-d')}}" required>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="order_received_date" class="form-label">To TNA Date</label>
                        <input type="date" name="to_tna_date" class="form-control" id="to_tna_date" value="{{date('Y-m-d')}}" required>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                    <select name="item_code[]" class="select2-select select2"  id="item_code0" style="width:250px;" required>
                                 ...
                                 <td>
                                    <select name="color_id[]" class="select2-select select2"   id="color_id0" style="width:250px;" required>
                                 ...
                                 <td>
                                    <select name="sz_code[]" class="select2-select" id="sz_code0" style="width:150px;" required>
                                       <option value="">--Size--</option>
                                       @foreach($SizeList as  $row)
                                       {
                                       <option value="{{ $row->sz_code }}">{{ $row->sz_name }}</option>
                                 ...
                                 <td><input type="number" name="qty[]"   id="qty0" class="QTY"  value="0" style="width:80px;" required/></td>
                                 <td>
                                    <select name="unit_id[]"  id="unit_id0" class="select2-select" style="width:100px;" required>
                                 ...
                                 <td><input type="button" style="width:40px;" id="Abutton0"  name="button[]"  value="+" class="Abutton btn btn-warning pull-left">
                                    <input type="button" id="Bbutton0" class="btn btn-danger pull-left" onclick="deleteRowcone(this);" value="X" >
                                 </td>
                              </tr>
                           </tbody>
                        </table>
               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="number" name="shipped_qty" class="form-control" id="shipped_qty" value="0" required readOnly onkeyup="calculate();">
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="balance_qty" class="form-label">Order Close Date</label>
                        <input type="date" name="order_close_date" class="form-control" id="order_close_date"     >
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
