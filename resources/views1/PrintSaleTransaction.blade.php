                  ...
                  <table class="table table-bordered text-1 table-sm" style="height:10vh; ">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-right">{{$buyerData->order_qty}}</td>
                           <td class="text-right">{{$buyerData->order_rate}}</td>
                           <td class="text-right">{{$buyerData->order_qty * $buyerData->order_rate}}</td>
                           <td class="text-right">{{$buyerData->order_qty * $buyerData->order_rate}}</td>
                           <td class="text-right">{{$taxAmt}}</td>
                           <td class="text-right">{{($buyerData->order_qty * $buyerData->order_rate) + $taxAmt}}</td>
                        </tr
                        @php 
