...
<form action="{{ route('CutPanelIssue.update',$CutPanelIssueMasterList) }}" method="POST" enctype="multipart/form-data">
@method('put')
@csrf
...
<input type="text" name="vendor_rate" class="form-control" id="vendor_rate" value="{{$CutPanelIssueMasterList->vendor_rate}}" required readOnly>
</div>
</div>   
...
<input type="text" name="style_no" class="form-control" id="style_no" value="{{$CutPanelIssueMasterList->style_no}}" required readOnly>
</div>
</div>
...
<input type="text" name="style_description" class="form-control" id="style_description" value="{{$CutPanelIssueMasterList->style_description}}" required readOnly>
</div>
</div>
...
<input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$CutPanelIssueMasterList->total_qty}}" required readOnly>
</div>
</div>
