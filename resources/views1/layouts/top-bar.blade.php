...
<span class="logo-sm">
<img src="/images/logos.png" alt="" height="22">
</span>
<span class="logo-lg">
<img src="/images/logo-light.png" alt="" style="width:120px; height:40px;">
</span>
</a>
</div>
...
<input type="text" class="form-control" placeholder="" value="{{ Session::get('vendorId')}}">
...
<!-- item-->
<!--<p class="dropdown-item  " data-lang="en">-->
