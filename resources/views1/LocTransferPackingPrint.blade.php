...
<div id="printInvoice">
    ...
    <div  class="col-md-4">
      ...
      <b style="display: inline-block;text-align: left;" class="mt-1">Delivery No:  </b> <span style="display: inline-block;text-align: right;"> {{ $LocTransferPackingInhouseMaster[0]->ltpki_code }} </span></br>     
      <b style="display: inline-block;text-align: left;" class="mt-1">Delivery Date:  </b> <span style="display: inline-block;text-align: right;"> {{ $LocTransferPackingInhouseMaster[0]->ltpki_date }} </span></br>
      <b style="display: inline-block;text-align: left;" class="mt-1">Sales Order no:  </b> <span style="display: inline-block;text-align: right;"> {{ $LocTransferPackingInhouseMaster[0]->sales_order_no }} </span></br>
   <b style="display: inline-block;text-align: left;" class="mt-1">From Location:  </b> <span style="display: inline-block;text-align: right;"> {{ $LocTransferPackingInhouseMaster[0]->fromlocation }} </span></br>
   <b style="display: inline-block;text-align: left;" class="mt-1">To Location:  </b> <span style="display: inline-block;text-align: right;"> {{ $LocTransferPackingInhouseMaster[0]->tolocation }} </span>
   
   </div> <div  class="col-md-3" >
   
        </div>
    <div  class="col-md-5">         
    <b style="display: inline-block;text-align: left;" class="mt-1">Buyer: </b>  <span style="display: inline-block;text-align: right;">{{  $LocTransferPackingInhouseMaster[0]->Ac_name }} </span></br>
       <b style="display: inline-block;text-align: left;" class="mt-1">Address:</b>  <span style="display: inline-block;text-align: left;">{{  $LocTransferPackingInhouseMaster[0]->address }}</span></br>
       <b style="display: inline-block;text-align: left;" class="mt-1">GST No:</b>  <span style="display: inline-block;text-align: right;">{{  $LocTransferPackingInhouseMaster[0]->gst_no }}</span></br>
       <b style="display: inline-block;text-align: left;" class="mt-1">PAN No:</b>  <span style="display: inline-block;text-align: right;">{{  $LocTransferPackingInhouseMaster[0]->pan_no }}</span></br>
    </div>
...
<div class="">
  <table class="table table-bordered text-1 table-sm" style="height:10vh; ">
        ...
        @php   $no=1; $totalAmt=0; $totalQty=0;@endphp
          @foreach ($LocTransferPackingList as $row) 
...
<p class="text-center d-print-none"><a href="/LocTransferPackingInhouse">&laquo; Back to List</a></p>
</body>
