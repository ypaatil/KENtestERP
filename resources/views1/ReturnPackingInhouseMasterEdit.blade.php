   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form action="{{ route('ReturnPackingInhouseMaster.update',$ReturnPackingInhouseMasterList) }}" method="POST" enctype="multipart/form-data">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="sales_order_no" class="form-control select2" id="sales_order_no" required  onChange="getSalesOrderTableOpening(this.value);GetSaleInvoices(this.value);">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="sale_code" class="form-control select2" id="sale_code"    onchange="GetTaxType(this.value);">
                            @php 
                                $SaleInvoiceList = DB::select("SELECT  DISTINCT sale_code from sale_transaction_detail where sales_order_no='".$ReturnPackingInhouseMasterList->sales_order_no."'");
                            @endphp
                  ...
                  <div class="col-md-2">
                      <div class="mb-3">
                        ...
                        <select name="tax_type_id" class="form-control select2" id="tax_type_id" required>
                            <option value="">--GST Type--</option>
                            @foreach($gstlist as  $rowgst)
                            {
                            <option value="{{ $rowgst->tax_type_id  }}" {{ $rowgst->tax_type_id == $ReturnPackingInhouseMasterList->tax_type_id ? 'selected="selected"' : '' }} >{{ $rowgst->tax_type_name }}</option>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="vendor_rate" class="form-control" id="vendor_rate" value="{{$ReturnPackingInhouseMasterList->vendor_rate}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="vendorId" class="form-control" id="vendorId" required   >
                           ...
                           {{  $rowvendor->ac_code == $ReturnPackingInhouseMasterList->vendorId ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="form-check form-check-primary mb-3">
                        ...
                        @if($ReturnPackingInhouseMasterList->is_opening==1)checked @endif    >
                  ...
                  <div class="col-md-3" style="margin-bottom: 20px;">
                     ...
                     <select name="location_id" class="form-control select2  " id="location_id" required>
                        ...
                        {{ $row->loc_id == $ReturnPackingInhouseMasterList->location_id ? 'selected="selected"' : '' }}    
                        >{{ $row->location }}</option>
                        }
                        @endforeach
                     </select>
                                          ...
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><input type="text" name="hsn_code[]"  value="{{$List->hsn_code}}" id="hsn_code" style="width:80px;  float:left;"  /></td>
                                                   @php 
               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="number" step="any" name="rate" class="form-control" id="rate" value="{{$ReturnPackingInhouseMasterList->rate}}" required onchange="mycalc();">
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
