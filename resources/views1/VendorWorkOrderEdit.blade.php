   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form action="{{ route('VendorWorkOrder.update',$VendorWorkOrderMasterList) }}" method="POST" enctype="multipart/form-data">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$VendorWorkOrderMasterList->style_no}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$VendorWorkOrderMasterList->style_description}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title">
                                 <a data-toggle="collapse" data-parent="#accordion" href="#collapse0">Sales Order Qty</a>
                              </h4>
                           </div>
                                          ...
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td ><input style="width:80px; float:left;" max='{{$szQty}}' min="0" name="s@php echo $n++; @endphp[]" class="size_id" type="number" id="s1" value="{{$szQty}}" required />  </td>
                                                   @endforeach
                                          ...
                                          <table id="footable_1" class="table  table-bordered table-striped m-b-0  footable_1">
                                             ...
                                             <tbody id="FabricData">
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <select name="class_id[]"   id="class_id" style="width:200px; height:30px;" required disabled>
                                                   ...
                                                   <td><input type="number" step="0.01"    name="consumption[]" value="{{$List->consumption}}" id="consumption" style="width:80px; height:30px;" required  readOnly/></td>
                                                   <td>
                                                   ...
                                                   <td><input type="number" step="0.01"  max="5" min="0" class="WASTAGE" name="wastage[]" value="{{$List->wastage}}" id="wastage" style="width:80px; height:30px;" required /></td>
                                                   <td><input type="text"      name="bom_qty[]" value="{{$List->bom_qty}}" id="bom_qty" style="width:80px; height:30px;" required readOnly/>
                                          ...
                                          <table id="footable_5" class="table  table-bordered table-striped m-b-0  footable_5">
                                             ...
                                             <tbody id="TrimFabricData">
                                                ...
                                                <tr>
                                                   ...
                                                   <td><input type="text"    name="descriptionsx[]" readOnly value="{{$List->description}}" id="descriptionsx" style="width:200px; height:30px;"   /></td>
                                                   <td><input type="number" step="0.01"  readOnly  name="consumptionsx[]"  value="{{$List->consumption}}" id="consumptionsx" style="width:80px; height:30px;" required /></td>
                                                   <td>
                                                   ...
                                                   <td><input type="number" step="0.01" max="5" min="0" class="WASTAGE1"  name="wastagesx[]" value="{{$List->wastage}}" id="wastagesx" style="width:80px; height:30px;" required /></td>
                                                   <td><input type="text"     name="bom_qtysx[]" value="{{$List->bom_qty}}" id="bom_qtys" style="width:80px; height:30px;" required readOnly/>
                                                      <input type="hidden"     name="bom_qtysx1[]" value="{{$List->actual_qty}}" id="bom_qtys1" style="width:80px; height:30px;" required readOnly/>
                                                   </td>
                                       ...
                                       <div class="table-responsive">
                                          <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                                             ...
                                             <tbody id="SewingData">
                                                ...
                                                $ColorListpacking= App\Models\BOMSewingTrimsDetailModel::select('color_id')
...
<script>
   ...
   $(document).on("click", 'input[class^="size_btn"]', function (event) 
   {
      ...
      var no=1;
       ...
       $('#footable_2 tr td  input[name="size_qty_total[]"]').each(function() {
        ...
        // alert(color_id);
         ...
         if(size_qty_total!=0)
         {
           ...
           $.ajax({
           dataType: "json",
           url: "{{ route('GetTrimFabricConsumption') }}",
           data:{'color_id':color_id,'size_qty_total':size_qty_total,'sales_order_no':sales_order_no,'no':no,'size_qty_array':size_qty_array,'size_array':size_array},
           success: function(data){
