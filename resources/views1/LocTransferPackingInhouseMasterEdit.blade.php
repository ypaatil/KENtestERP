...
<form action="{{ route('LocTransferPackingInhouse.update',$TransferPackingInhouseMasterList) }}" method="POST" enctype="multipart/form-data">
@method('put')
@csrf
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="ltpki_date" class="form-control" id="ltpki_date" value="{{$TransferPackingInhouseMasterList->ltpki_date}}" required readOnly>
        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $TransferPackingInhouseMasterList->c_code }}">
        <input type="hidden" name="ltpki_code" class="form-control" id="ltpki_code" value="{{$TransferPackingInhouseMasterList->ltpki_code}}" required readOnly>
...
<a href="{{ Route('LocTransferPackingInhouse.index') }}" class="btn btn-warning w-md">Cancel</a>
</div>
</div>
