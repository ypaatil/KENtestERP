         ...
         <div class="invoice" id="invoice">
               ...
               <table class="table table-bordered text-1 table-sm" id="Summary0" style="height:10vh; ">
                  ...
                  <tbody>
                    ...
                    $invoice_qtyData = DB::select("select ifnull(sum(size_qty_total),0) as invoice_qty from carton_packing_inhouse_detail
                             ...
                             carton_packing_inhouse_detail.color_id = '".$List->color_id."' and carton_packing_inhouse_master.endflag=1 ");
          ...
          //dd(DB::getQueryLog());
                     ...
                     <tr>
                        ...
                        <td style="text-align: right;">{{number_format($work_order_qtyData[0]->work_order_qty)  }}</td>
                        <td style="text-align: right;">{{number_format($cut_order_qtyData[0]->cut_order_qty)  }}</td>
                        <td style="text-align: right;">{{number_format($ProductionOrderData[0]->prod_qty)}}</td>
                        <td style="text-align: right;">{{number_format($pass_order_qtyData[0]->pass_order_qty)  }}</td>
                        <td style="text-align: right;">{{number_format($reject_qty)  }}</td>
                        <td style="text-align: right;">{{number_format(($pass_order_qtyData[0]->pass_order_qty + $reject_qty))}}</td>
                        <td style="text-align: right;">{{number_format($cut_order_qtyData[0]->cut_order_qty-($pass_order_qtyData[0]->pass_order_qty + $reject_qty))  }}</td>
                        <td style="text-align: right;">{{number_format($packing_order_qtyData[0]->packing_order_qty)  }}</td>
                        <td style="text-align: right;">{{number_format($cut_order_qtyData[0]->cut_order_qty - $packing_order_qtyData[0]->packing_order_qty)  }}</td>
                        <td style="text-align: right;">{{number_format($invoice_qtyData[0]->invoice_qty)}}</td>
                        <td style="text-align: right;">{{number_format($packing_order_qtyData[0]->packing_order_qty -$invoice_qtyData[0]->invoice_qty)}}</td>
                        <td style="text-align: right;">{{number_format($packing_order_qtyData[0]->packing_order_qty -$invoice_qtyData[0]->invoice_qty)}}</td>
                        @if($invoice_qtyData[0]->invoice_qty > 0 && $cut_order_qtyData[0]->cut_order_qty > 0)
                        
                        <td style="text-align: right;">{{round((($invoice_qtyData[0]->invoice_qty/$cut_order_qtyData[0]->cut_order_qty)*100),2)  }}</td>
                        @else
               ...
               <div id="Sales">
                  ...
                  <table class="table table-bordered text-1 table-sm" style="height:10vh; "  id="Summary4">
                     ...
                     <tbody>
                        ...
                        ->join('ledger_master as lm1','lm1.Ac_code', '=', 'sale_transaction_detail.Ac_code')
