   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form action="{{ route('FabricInward.update',$FabricInwardMasterList) }}" method="POST" enctype="multipart/form-data">
               @method('put')
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="po_code" class="form-select select2" id="po_code" onchange="getPODetails();"   >
                     ...
                     <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <select name="item_code[]"  id="item_code" style="width:200px; height:30px;" required onchange="getRateFromPO(this);">
                              ...
                              <td>
                                 <select name="part_id[]"  id="part_id" style="width:200px; height:30px;" required>
                              ...
                              <td><input type="number" step="any"  name="gram_per_meter[]" onkeyup="mycalc();" value="{{ $List->gram_per_meter }}" id="gram_per_meter" style="width:80px; height:30px;" required/></td>
                              <td><input type="number" step="any" class="KG" name="kg[]" onkeyup="mycalc();" value="{{ $List->kg }}" id="kg" style="width:80px; height:30px;" required/></td>
                              ...
                              <td><input type="text" step="any" class="suplier_roll_no"  name="suplier_roll_no[]"   value="{{ $List->suplier_roll_no }}" id="suplier_roll_no" style="width:100px;height:30px;"/></td>
                           ...
                           <tr>
                              ...
                              <td>
                                 <select name="item_code[]" class="item"  id="item_code" style="width:100px;" required onchange="getRateFromPO(this);">
                                    <option value="">--Item--</option>
                                    @foreach($ItemList as  $row)
                                    {
                              ...
                              <td>
                                 <select name="part_id[]" class="part"   id="part_id" style="width:100px;" required>
                                    <option value="">--Part--</option>
                                    @foreach($PartList as  $row)
                                    {
                              ...
                              <td><input type="number" step="any"  name="gram_per_meter[]"  value="0" id="gram_per_meter" style="width:80px;" required/></td>
                              <td><input type="number" step="any" class="KG" name="kg[]" onkeyup="mycalc();" value="0" id="kg" style="width:80px;" required/></td>
                              ...
                              <td><input type="text" step="any" class="suplier_roll_no"  name="suplier_roll_no[]"   value="" id="suplier_roll_no" style="width:100px;height:30px;"/></td>
         ...
         {{ $vendors->vpo_code == $FabricInwardMasterList->vw_code ? 'selected="selected"' : '' }} 
