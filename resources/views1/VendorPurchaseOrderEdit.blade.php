         ...
         <div class="card-body">
            ...
            <form action="{{ route('VendorPurchaseOrder.update',$VendorPurchaseOrderMasterList) }}" method="POST" enctype="multipart/form-data">
               ...
               <div class="row">
                  ...
                  <input type="hidden" name="season_id" class="form-control" id="season_id" value="{{$VendorPurchaseOrderMasterList->season_id}}" required readOnly>
                  <input type="hidden" name="currency_id" class="form-control" id="currency_id" value="{{$VendorPurchaseOrderMasterList->currency_id}}" required readOnly>
                  <input type="hidden" name="order_rate" class="form-control" id="order_rate" value="{{$VendorPurchaseOrderMasterList->order_rate}}" required readOnly>
                  <div class="col-md-2">
                     <div class="mb-3">
                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      ...
                                                      <select name="color_id[]"   id="color_id" style="width:200px; height:30px;" required disabled>
                                       ...
                                       <div class="table-responsive">
                                          <table id="footable_4" class="table  table-bordered table-striped m-b-0  footable_4">
                                             ...
                                             <tbody id="PackingData">
                                                ...
                                                where('item_code', $List->item_code)->where('sales_order_no', $VendorPurchaseOrderMasterList->sales_order_no)->get();
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <input type="text"    name="descriptionss[]" value="{{$List->description}}" id="descriptionss" style="width:200px; height:30px;" required readOnly/>
                                                   </td>
               ...
               <div class="row">
                  <div class="col-sm-2">
                     ...
                     <div class="mb-3">
                        <input type="number" required step="0.01" name="final_bom_qty" class="form-control" id="final_bom_qty"  value="{{$VendorPurchaseOrderMasterList->final_bom_qty}}"  />
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
