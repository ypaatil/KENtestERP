    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('T_And_A_Master.update',$T_And_A_MasterList)}}" method="POST">
                    @csrf 
                    @method('put')
                    <div class="row">
                        <div class="col-md-4">
                                ...
                                <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                                    ...
                                    <tbody id="PlanData">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="date" name="target_date[]" id="target_date" style="width:110px;" value="{{$row->target_date}}"/></td>
