...
@section('content')
    ...
    <p class="text-muted mb-0 text-truncate">Production Manager</p>
    </div>
    ...
    <div class="card">
    <div class="card-body">
    <h4 class="card-title mb-4">Latest Dispatch</h4>
    ...
    <th class="align-middle">Outward No</th>
    <th class="align-middle">Party Name</th>
    ...
    <td><a href="javascript: void(0);" class="text-body fw-bold">OUT-2540</a> </td>
    <td>Neal Matthews</td>
    <td>
    07 Oct, 2019
    </td>
   ...
   By Cheque
    ...
    <td><a href="javascript: void(0);" class="text-body fw-bold">OUT-2541</a> </td>
    <td>Jamal Burnett</td>
    <td>
    07 Oct, 2019
    </td>
   ...
   &#8377;380
    ...
    <td><a href="javascript: void(0);" class="text-body fw-bold">OUT-2542</a> </td>
    <td>Juan Mitchell</td>
    <td>
    06 Oct, 2019
    </td>
   ...
   By Cheque
    ...
    <td><a href="javascript: void(0);" class="text-body fw-bold">OUT-2543</a> </td>
    <td>Barry Dick</td>
    <td>
    05 Oct, 2019
    </td>
    ...
    <td><a href="javascript: void(0);" class="text-body fw-bold">OUT-2544</a> </td>
    <td>Ronald Taylor</td>
    <td>
    04 Oct, 2019
    </td>
   ...
   By Cheque
    ...
    <td><a href="javascript: void(0);" class="text-body fw-bold">OUT-2545</a> </td>
    <td>Jacob Hunter</td>
    <td>
    04 Oct, 2019
    </td>
