                ...
                <table id="datatable-buttons" class="table table-bordered   nowrap w-100">
                      <thead>
                       ...
                       @foreach($SalesOrderCostingMaster as $row)   
                        ...
                        <td style="text-align:center; white-space:nowrap"> {{ $costingStatus }}</td> 
                        <td style="text-align:center; white-space:nowrap"> {{ $row->job_status_name }}</td> 
                        <td style="text-align:center; white-space:nowrap"> {{ $order_type }}</td> 
                        ...
                        <td>{{number_format((float)($percentOfother_value + $profitpercentage), 2, '.', '')}}</td>
