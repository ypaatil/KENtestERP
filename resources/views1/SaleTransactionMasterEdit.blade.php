         ...
         <div class="card-body">
            <form action="{{route('SaleTransaction.update',base64_encode($SaleTransactionMasterList->sale_code) )}}" method="POST">
               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="formrow-sales_invoice_no" class="form-label">Invoice No</label>
                        <input type="text" name="sales_invoice_no" class="form-control" id="sales_invoice_no" value="" readonly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="formrow-tax_type_id" class="form-label">GST</label>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="formrow-carton_packing_no" class="form-label">Carton Packing No</label>
                     ...
                     <table id="footable_2" class="table  table-bordered table-striped m-b-0 footable_2">
                        ...
                        <tbody id="bomdis">
                           ...
                           <tr>
                              ...
                              <td>
                                 <select name="unit_id[]" class="unit_id" id="unit_id" style="width:100px;" disabled>
                              ...
                              <td><input style="width:80px;" type="text" required class="ITEMQTY" name="order_qtys[]" value="{{ $row->order_qty }}" readOnly  id="order_qtys"></td>
                              <td><input  style="width:80px;" type="number" required step="any" class="" name="item_rates[]" value="{{ $row->order_rate }}" id="order_rate"></td>
                              ...
                              <td><input   style="width:80px;"  required type="number" id="sale_cgst" step="any"  class="" name="sale_cgsts[]" value="{{ $row->sale_cgst }}"></td>
                              <td><input  style="width:80px;" required type="number" readOnly step="any" id="camt" class="GSTAMT" name="camts[]" value="{{ $row->camt }}"></td>
                              <td><input   style="width:80px;"  required type="number" step="any" id="sale_sgst" class="" name="sale_sgsts[]" value="{{ $row->sale_sgst }}"></td>
                              <td><input style="width:80px;" required type="number" readOnly step="any" id="samt" class="GSTAMT" name="samts[]" value="{{ $row->samt }}"></td>
                              <td><input   style="width:80px;" required  type="number" step="any" id="sale_igst" class="" name="sale_igsts[]" value="{{ $row->sale_igst }}"></td>
                              <td><input  style="width:80px;"  type="number" required readOnly step="any" id="iamt" class="GSTAMT" name="iamts[]" value="{{ $row->iamt }}"></td>
                              <td><input  style="width:80px;"  type="number" required readOnly step="any" id="amount" class="GROSS" name="amounts[]" value="{{ $row->amount }}"></td>
                              <td><input  style="width:80px;"  type="number" required readOnly step="any" id="total_amount" class="TOTAMT" name="total_amounts[]" value="{{ $row->total_amount }}"></td>
...
<script>
   ...
   function getPartyDetails()
   {
     ...
     $(document).on("keyup", 'input[name^="order_qtys[]"],input[name^="item_rates[]"],input[name^="disc_pers[]"],input[name^="disc_amounts[]"],input[name^="sale_cgsts[]"],input[name^="camts[]"],input[name^="sale_sgsts[]"],input[name^="sale_igsts[]"],input[name^="iamts[]"],input[name^="amounts[]"],input[name^="freight_amt[]"],input[name^="total_amounts[]"]', function (event) {
       ...
       function CalculateRow(row)
       {
           ...
           var item_qtys=+row.find('input[name^="order_qtys[]"]').val();
           ...
           var TAmount=0;
              if(item_qtys>0)
            {
                ...
                if(sale_igsts!=0)
                {
                    var  Iamt=(Amount*(sale_igsts/100));
                     row.find('input[name^="iamts[]"]').val((Iamt).toFixed(2));
                     TAmount=parseFloat(Amount) + parseFloat(Iamt)  ;
                     //alert('1: '+TAmount);
                ...
                {
                    var Camt=(Amount*(sale_cgsts/100));
                     row.find('input[name^="camts[]"]').val((Camt).toFixed(2));
                     
                     var Samt=(Amount*(sale_sgsts/100));
                     row.find('input[name^="samts[]"]').val((Samt).toFixed(2));
                                     
                     TAmount=parseFloat(Amount) + parseFloat(Camt)  + parseFloat(Samt)   ;
                   //  alert('2: '+TAmount);
                    row.find('input[name^="total_amounts[]"]').val((TAmount).toFixed(2));
