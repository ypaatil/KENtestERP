...
<form action="{{ route('CutPanelGRN.update',$CutPanelGRNMasterList) }}" method="POST" enctype="multipart/form-data">
@method('put')
@csrf
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="hidden" name="cpg_code" class="form-control" id="cpg_code" value="{{$CutPanelGRNMasterList->cpg_code}}" required readOnly>
...
<input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$CutPanelGRNMasterList->sales_order_no}}" required readOnly>
</div>
</div>
...
<input type="text" name="vendor_rate" class="form-control" id="vendor_rate" value="{{$CutPanelGRNMasterList->vendor_rate}}" required readOnly>
</div>
</div>   
...
<input type="text" name="style_no" class="form-control" id="style_no" value="{{$CutPanelGRNMasterList->style_no}}" required readOnly>
</div>
</div>
...
<input type="text" name="style_description" class="form-control" id="style_description" value="{{$CutPanelGRNMasterList->style_description}}" required readOnly>
</div>
</div>
...
<input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$CutPanelGRNMasterList->total_qty}}" required readOnly>
</div>
</div>
...
<input type="text" name="vendor_amount" class="form-control" id="vendor_amount" value="{{$CutPanelGRNMasterList->vendor_amount}}" required readOnly>
