...
<td style="text-align:right">{{ number_format($BOMList[0]->sewing_trims_value) }}</td>
<td style="text-align:right">{{ number_format($BOMList[0]->packing_trims_value) }}</td>
<td style="text-align:right">{{ number_format($BOMList[0]->total_cost_value)  }}</td>
</tr>
