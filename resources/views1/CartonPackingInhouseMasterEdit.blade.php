   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form action="{{ route('CartonPackingInhouse.update',$CartonPackingInhouseMasterList) }}" method="POST" enctype="multipart/form-data">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="sales_order_no[]" class="form-control select2" id="sales_order_no" required  onChange="getPackingInhouseDetails(this.value);" multiple>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="mainstyle_id" class="form-control" id="mainstyle_id"  onchange="getSubStyle(this.value)" required disabled>
                           ...
                           {{ $row->mainstyle_id == $CartonPackingInhouseMasterList->mainstyle_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="substyle_id" class="form-control" id="substyle_id" onchange="getStyle(this.value)" required disabled>
                           ...
                           {{ $row->substyle_id == $CartonPackingInhouseMasterList->substyle_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$CartonPackingInhouseMasterList->style_no}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$CartonPackingInhouseMasterList->style_description}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="order_rate" class="form-label">Order Rate</label>
                        <input type="text" name="order_rate" class="form-control" id="order_rate" value="{{$CartonPackingInhouseMasterList->order_rate}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="mb-3">
               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="order_amount" class="form-control" id="order_amount" value="{{$CartonPackingInhouseMasterList->order_amount}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-sm-8">
