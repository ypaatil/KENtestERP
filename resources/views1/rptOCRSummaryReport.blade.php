            ...
            <div class="table-responsive">
               <table id="datatable-buttons" class="table table-bordered   nowrap w-100">
                  ...
                  <tbody>
                     ...
                     select('buyer_purchase_order_detail.*', 'Ac_name',  'item_master.item_name','mainstyle_name','fg_name','item_master.item_description',
                     'item_master.dimension','color_master.color_name','job_status_master.job_status_name','buyer_purchse_order_master.order_close_date')
                     ...
                     ->leftJoin('ledger_master', 'ledger_master.Ac_code', '=', 'buyer_purchse_order_master.Ac_code', 'left outer')
                     ...
                     ->where(DB::raw('month(buyer_purchse_order_master.order_close_date)'),"=",date('m'))
                      ->where(DB::raw('YEAR(buyer_purchse_order_master.order_close_date)'),"=",date('Y'))
                     ...
                     elseif($month_id==2)
                     {
                         //$Buyer_Purchase_Order_Detail_List=$Buyer_Purchase_Order_Detail_List->whereBetween( DB::raw('MONTH(order_close_date)'),[ 'LAST_DAY(CURDATE() - INTERVAL 1 MONTH)','LAST_DAY(CURDATE() - INTERVAL 1 MONTH)']);
                         ...
                         if($job_status_id==1)
                         {
                             ...
                             ->leftJoin('item_master','item_master.item_code', '=', 'buyer_purchase_order_detail.item_code')
                             ->join('color_master','color_master.color_id', '=', 'buyer_purchase_order_detail.color_id')
                             ->whereBetween( DB::raw('month(buyer_purchse_order_master.tr_date)'),[$startMonth ,$EndMonth])
                              ->where(DB::raw('YEAR(buyer_purchse_order_master.order_close_date)'),"=",date('Y'))
                             ->where('buyer_purchse_order_master.job_status_id','=', $job_status_id)
                             ->where('buyer_purchse_order_master.og_id','!=', '4')
                             ->get();
                         ...
                         else
                         {
                             ...
                             ->leftJoin('item_master','item_master.item_code', '=', 'buyer_purchase_order_detail.item_code')
                             ->join('color_master','color_master.color_id', '=', 'buyer_purchase_order_detail.color_id')
                             ->whereBetween( DB::raw('month(buyer_purchse_order_master.order_close_date)'),[$startMonth ,$EndMonth])
                              ->where(DB::raw('YEAR(buyer_purchse_order_master.order_close_date)'),"=",date('Y'))
                             ->where('buyer_purchse_order_master.job_status_id','=', $job_status_id)
                             ->where('buyer_purchse_order_master.og_id','!=', '4')
                             ->get();
                     ...
                     elseif($month_id==4)
                     {
                         //$Buyer_Purchase_Order_Detail_List=$Buyer_Purchase_Order_Detail_List->whereBetween( MONTH(order_close_date),[ 'LAST_DAY(CURDATE() - INTERVAL 1 MONTH)','LAST_DAY(CURDATE() - INTERVAL 3 MONTH)']);
                     ...
                     //
                      ...
                      if($job_status_id==1)
                         ...
                         $Buyer_Purchase_Order_Detail_List = DB::table('buyer_purchase_order_detail')->
                         select('buyer_purchase_order_detail.*', 'Ac_name',  'item_master.item_name','mainstyle_name','fg_name',
                         'item_master.item_description','item_master.dimension','color_master.color_name','job_status_master.job_status_name','buyer_purchse_order_master.order_close_date')
                         ->join('buyer_purchse_order_master','buyer_purchse_order_master.tr_code', '=', 'buyer_purchase_order_detail.tr_code')
                         ->leftJoin('merchant_master', 'merchant_master.merchant_id', '=', 'buyer_purchse_order_master.merchant_id')
                         ->leftJoin('ledger_master', 'ledger_master.Ac_code', '=', 'buyer_purchse_order_master.Ac_code', 'left outer')
                         ->leftJoin('main_style_master', 'main_style_master.mainstyle_id', '=', 'buyer_purchse_order_master.mainstyle_id', 'left outer')
                        ...
                        // DB::enableQueryLog();
                         ...
                         ->join('color_master','color_master.color_id', '=', 'buyer_purchase_order_detail.color_id')
                         ->where('buyer_purchse_order_master.job_status_id','=', $job_status_id)
                         ->where('buyer_purchse_order_master.order_close_date','=', DB::raw('DATE_SUB(CURDATE(), INTERVAL 1 DAY)'))
                         ->where('buyer_purchse_order_master.og_id','!=', '4')
                         ->whereNotNull('buyer_purchse_order_master.order_close_date')
                         ->get();
                         //  dd(DB::getQueryLog());
                         }
                     }
                     elseif($month_id==6)
                     {
                      ...
                      //  DB::enableQueryLog();
                         ...
                         ->where('buyer_purchse_order_master.og_id','!=', '4')
                         ->whereNotNull('buyer_purchse_order_master.order_close_date')
                         ->where('buyer_purchse_order_master.order_close_date','!=', date('Y-m-d'))
                         ->get();
