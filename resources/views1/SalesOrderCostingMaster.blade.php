            ...
            <form action="{{route('SalesOrderCosting.store')}}" method="POST" enctype="multipart/form-data">
               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="inr_rate" class="form-control" id="inr_rate" value="" required onkeyup="calOrderRate()" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="exchange_rate" class="form-label">Exchange Rate</label>
                        <input type="text" name="exchange_rate" class="form-control" id="exchange_rate" value="" required onkeyup="calOrderRate()" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="order_rate" class="form-label">FOB Rate  (INR)</label>
                        <input type="number" step="any" name="order_rate" class="form-control" id="order_rate" value="" required>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="sam" class="form-control" id="sam" value="" required onkeyup="calculateMfgCost(this.value);">
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Transport OCR Cost</label>
                        <input type="text" name="transport_ocr_cost" class="form-control" id="transport_ocr_cost" value="" >
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Testing OCR Cost</label>
                        <input type="text" name="testing_ocr_cost" class="form-control" id="testing_ocr_cost" value="">
                     </div>
                  </div>
               </div>
               <div class="row">
                        ...
                        <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                    <input type="text"    name="description[]" value="0" id="description" style="width:200px;height:30px;"   />
                                 </td>
                        ...
                        <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td><input type="text"    name="descriptions[]" value="0" id="descriptions" style="width:200px; height:30px;"   /></td>
                        ...
                        <table id="footable_4" class="table  table-bordered table-striped m-b-0  footable_4">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td> <input type="text"    name="descriptionss[]" value="0" id="descriptionss" style="width:200px; height:30px;"   /></td>
               ...
               <div class="row">
                  <table>
                     ...
                     <tr>
                        <td>  
                           <label for="packing_trims_value" class="form-label">Packing Trims Cost</label>
                        </td>
                     ...
                     <tr>
                        ...
                        <td><input type="text" name="production_value" id="production_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="production_per" id="production_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentofproduction_value"></td>
                     </tr>
                     <tr>
                        <td>      <label for="agent_commission_value" class="form-label">Commission Cost</label> </td>
                        <td><input type="text" name="agent_commission_value"  id="agent_commission_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="agent_commission_per"  id="agent_commission_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentofagent_commission_value"></td>
                     </tr>
                     <tr>
                        <td>      <label for="transport_value" class="form-label">Transport Cost</label> </td>
                        <td>  <input type="text" name="transport_value" class="" id="transport_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="transport_per" class="" id="transport_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentoftransport_value"></td>
                     </tr>
                     <tr>
                        <td>       <label for="other_value" class="form-label">Over Head Cost</label>  </td>
                        <td> <input type="text" name="other_value" class="" id="other_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="other_per" class="" id="other_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentofother_value"></td>
                     </tr>
                     <tr>
                        <td>       <label for="dbk_value" class="form-label">Garment Washing Cost</label>  </td>
                        <td> <input type="text" name="dbk_value" class="" id="dbk_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="dbk_per" class="" id="dbk_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentofdbk_value"></td>
                     </tr>
                     <tr>
                        <td>       <label for="dbk_value" class="form-label">Printing Cost</label>  </td>
                        <td> <input type="text" name="printing_value" class="" id="printing_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="printing_per" class="" id="printing_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentofprinting_value"></td>
                     </tr>
                     <tr>
                        <td>       <label for="dbk_value" class="form-label">Embroidery Cost</label>  </td>
                        <td> <input type="text" name="embroidery_value" class="" id="embroidery_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="embroidery_per" class="" id="embroidery_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentofembroidery_value"></td>
                     </tr>
                     <tr>
                        <td>       <label for="ixd_value" class="form-label">IXD Cost</label>  </td>
                        <td> <input type="text" name="ixd_value" class="" id="ixd_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="ixd_per" class="" id="ixd_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentofixd_value"></td>
                     </tr>
                     <tr>
                        <td>       <label for="garment_reject_value" class="form-label">Garment Rejection %</label>  </td>
                        <td> <input type="text" name="garment_reject_value" class="" id="garment_reject_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="garment_reject_per" class="" id="garment_reject_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentofgarment_reject_per_value"></td>
                     </tr>
                     <tr>
                        <td>       <label for="testing_charges_value" class="form-label">Testing Charges</label>  </td>
                        <td> <input type="text" name="testing_charges_value" class="" id="testing_charges_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="testing_charges_per" class="" id="testing_charges_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentoftesting_charges_value"></td>
                     </tr>
                     <tr>
                        <td>      
                           <label for="finance_cost_value" class="form-label">Finance Cost</label>  
                        </td>
                        <td> <input type="text" name="finance_cost_value" class="" id="finance_cost_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="finance_cost_per" class="" id="finance_cost_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentoffinance_cost_value"></td>
                     </tr>
                     <tr>
                        <td>      
                           <label for="extra_value" class="form-label">Other Cost</label>  
                        </td>
                        <td> <input type="text" name="extra_value" class="" id="extra_value" style="width:150px;" value="" required  onchange="mycalc(); calculatepercentage();">
                           <input type="text" name="extra_per" class="" id="extra_per" style="width:150px;" value="" required  onchange="calculate_percentage_value();">
                        </td>
                        <td id="percentofextra_value"></td>
                     </tr>
                     <tr>
               ...
               <div class="col-sm-12 mt-5 hide" id="imgDiv">  
                 <img id="mainstyle_image" width="700" height="300">  
               </div>
         </div>
         </form>
      </div>
         ...
         $.ajax({
               ...
               $("#order_rate").val(data[0]['order_rate']);
                ...
                $.ajax({
                   ...
                   {
                        $("#mainstyle_image").attr({ "src": "https://ken.korbofx.com/uploads/MainStyleImages/"+res});
