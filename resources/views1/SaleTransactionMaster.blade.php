               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="carton_packing_no[]" class="form-select select2" id="carton_packing_no" multiple onchange="getSalesOrder();">
...
<script>
   ...
   function getPartyDetails()
   {
    ...
    $("table.footable_2").on("keyup", 'input[name^="order_qty[]"],input[name^="order_rate[]"],input[name^="disc_pers[]"],input[name^="disc_amounts[]"],input[name^="sale_cgsts[]"],input[name^="camts[]"],input[name^="sale_sgsts[]"],input[name^="sale_igsts[]"],input[name^="iamts[]"],input[name^="amounts[]"],input[name^="freight_amt[]"],input[name^="total_amounts[]"]', function (event) {
       ...
       function CalculateRow(row)
       {
           ...
           var item_qtys=+row.find('input[name^="order_qty[]"]').val();
           var item_rates=+row.find('input[name^="order_rate[]"]').val();
