...
<div id="printInvoice">
    ...
    <div  class="col-md-4">
      ...
      <b style="display: inline-block;text-align: left;" class="mt-1">Delivery No:  </b> <span style="display: inline-block;text-align: right;"> {{ $OutwardForPackingMaster[0]->pki_code }} </span></br>     
      <b style="display: inline-block;text-align: left;" class="mt-1">Delivery Date:  </b> <span style="display: inline-block;text-align: right;"> {{ $OutwardForPackingMaster[0]->pki_date }} </span></br>
...
<b style="display: inline-block;text-align: left;" class="mt-1">Process Order No:  </b> <span style="display: inline-block;text-align: right;"> {{ $OutwardForPackingMaster[0]->vpo_code }} </span></br>  
 
</div> <div  class="col-md-3" >
   
        </div>
    <div  class="col-md-5">         
    <b style="display: inline-block;text-align: left;" class="mt-1">Vendor: </b>  <span style="display: inline-block;text-align: right;">{{  $OutwardForPackingMaster[0]->Ac_name }} </span></br>
...
<div class="">
  <table class="table table-bordered text-1 table-sm" style="height:10vh; ">
       ...
       @endforeach
            ...
            <tfoot>
                <tr>
                    <th colspan="{{count($SizeDetailList) + 3}}">Total</thd>
                    <th>{{$totalQty}}</th>
