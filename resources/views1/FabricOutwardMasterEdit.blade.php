...
<select name="out_type_id" class="form-control select2" id="out_type_id" required >
...
<td> 
<input type="text"   name="roll_no[]"  value="{{ $List->roll_no }}" id="widths" style="width:80px;" required  readOnly/></td>
...
<td> 
<input type="text"   name="widths[]" onkeyup="mycalc();" value="{{ $List->dimension }}" id="widths" style="width:80px;" required  /></td>
