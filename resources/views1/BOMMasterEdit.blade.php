...
<div class="col-md-2">
    <div class="mb-3">
       ...
       <select name="sales_order_no" class="form-control" id="sales_order_no" required  onChange="getSalesOrderDetails(this.value);"  >
...
<input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$BOMMasterList->total_qty}}" required readOnly> 
</div>
</div
...
<td> <select name="item_code[]"   id="item_code" style="width:270px; height:30px;" required @php if($List->item_count>0){ echo 'disabled'; } @endphp >
...
<td> <select name="unit_id[]" class=" " id="unit_id" style="width:100px; height:30px;" required disabled>
...
<td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="{{$List->wastage}}" @endif name="wastage[]" value="{{$List->wastage}}" id="wastage" style="width:80px; height:30px;" required /></td> 
<td><input type="text"  min="0" max="{{$List->bom_qty}}"    name="bom_qty[]" value="{{$List->bom_qty}}" id="bom_qty" style="width:80px; height:30px;" required readOnly/>
<input type="hidden" name="bom_qty1[]" value="{{$List->item_qty}}" id="bom_qty1" style="width:80px; height:30px;" required readOnly/>
</td> 
...
<input type="hidden" name="bom_qty1[]" value="0" id="bom_qty1" style="width:80px; height:30px;" required readOnly/>
</td> 
...
<td> <select name="color_ids[][]"   id="color_ids" style="width:300px; height:100px;" required  multiple @php if($List->item_count>0){ echo 'disabled'; } @endphp>
<option value="">--Color List--</option>
@php $color_ids = explode(',', $List->color_id);   @endphp
@foreach($ColorList as  $row)
{
...
<td> <select name="size_ids[][]"  id="size_ids" style="width:200px; height:100px;" required multiple @php if($List->item_count>0){ echo 'disabled'; } @endphp> 
<option value="">--Size List--</option>
@php $size_ids = explode(',', $List->size_array);   @endphp
@foreach($SizeDetailList as  $row)
{
...
<td><input   name="Sbutton[]"    type="button"   class="btn btn-warning pull-left" value="+" /> <input type="button" @php if($List->item_count > 0 || $List->item_count_sew>0 ){ echo 'disabled'; } @endphp class="btn btn-danger pull-left" onclick="deleteRowcone2(this);" value="X" ></td>
...
<td> <select name="color_ids[][]" class="select2" id="color_ids" style="width:300px; height:100px;" required multiple>
<option value="">--Color List--</option>
@foreach($ColorList as  $row)
{
    <option value="{{ $row->color_id }}"
...
<td><input type="button"  readOnly name="Sbutton[]" class="btn btn-warning pull-left">+</input><input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone2(this);" value="X" ></td>
</tr>
