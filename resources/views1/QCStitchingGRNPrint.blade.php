...
<div id="printInvoice">
    ...
    <div  class="col-md-4">
      ...
      <b style="display: inline-block;text-align: left;" class="mt-1">QC No:  </b> <span style="display: inline-block;text-align: right;"> {{ $QCStitchingInhouseMaster[0]->qcsti_code }} </span></br>     
      <b style="display: inline-block;text-align: left;" class="mt-1">QC Date:  </b> <span style="display: inline-block;text-align: right;"> {{ $QCStitchingInhouseMaster[0]->qcsti_date }} </span></br>
      <b style="display: inline-block;text-align: left;" class="mt-1">Sales Order no:  </b> <span style="display: inline-block;text-align: right;"> {{ $QCStitchingInhouseMaster[0]->sales_order_no }} </span></br>
   
<b style="display: inline-block;text-align: left;" class="mt-1">Work Order No:  </b> <span style="display: inline-block;text-align: right;"> {{ $QCStitchingInhouseMaster[0]->vw_code }} </span></br>  
 
</div> <div  class="col-md-3" >
   
        </div>
    <div  class="col-md-5">         
    <b style="display: inline-block;text-align: left;" class="mt-1">Vendor: </b>  <span style="display: inline-block;text-align: right;">{{  $QCStitchingInhouseMaster[0]->Ac_name }} </span></br>
       <b style="display: inline-block;text-align: left;" class="mt-1">Address:</b>  <span style="display: inline-block;text-align: left;">{{  $QCStitchingInhouseMaster[0]->address }}</span></br>
       <b style="display: inline-block;text-align: left;" class="mt-1">GST No:</b>  <span style="display: inline-block;text-align: right;">{{  $QCStitchingInhouseMaster[0]->gst_no }}</span></br>
       <b style="display: inline-block;text-align: left;" class="mt-1">PAN No:</b>  <span style="display: inline-block;text-align: right;">{{  $QCStitchingInhouseMaster[0]->pan_no }}</span></br>
    </div>
...
<!-- Passenger Details -->
<h4 class="text-center mt-2" style="color: #000;font-size:20px;font-weight:bold;">QC Stitching Details:</h4>
<div class="">
