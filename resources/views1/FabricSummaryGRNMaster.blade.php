...
<form action="{{route('FabricSummaryGRN.store')}}" method="POST" enctype="multipart/form-data">
@csrf 
<div class="row">
<div class="col-md-2">
    <div class="mb-3">
...
<select name="po_code" class="form-select select2" id="po_code" onchange="getPoForFabricTable(this.value);"   >
...
<input type="text" name="challan_no" id="challan_no" class="form-control" id="formrow-challan_no-input" required>
</div>
</div>
...
<input type="date" name="challan_date" id="challan_date" class="form-control" id="formrow-challan_date-input" value="{{date('Y-m-d')}}">
</div>
</div>
...
@endforeach
    ...
    <div class="mb-3">
        ...
        <input type="number"   step="0.01"  name="freight_paid" class="form-control" id="freight_paid" value="0" required>
    </div>
</div>
