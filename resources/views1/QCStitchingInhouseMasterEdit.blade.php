   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form action="{{ route('QCStitchingInhouse.update',$QCStitchingInhouseMasterList->qcsti_code) }}" method="POST" enctype="multipart/form-data">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                                          ...
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><input style="width:80px; float:left;"  name="s@php echo $n; @endphp[]" class="size_id" type="number" id="s@php echo $n; @endphp" value="{{$szQty}}" required />
                                                      <input style="width:80px; float:left;background-color:#FAACAA;" class="size_id2"  name="s_@php echo $n; @endphp[]"  type="number" id="s_@php echo $n; @endphp" value="{{isset($SizeQtyList2[$nz]) ? $SizeQtyList2[$nz] : 0}}" required />
                                                   </td>
...
<script>
   ...
   $( document ).ready(function() {
       lineData();
        setTimeout(function() {
                $("#line_id").find('option[value="{{$QCStitchingInhouseMasterList->line_id}}"]').attr('selected','selected').change(); 
        }, 500);
   });
