               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="bom_codes[]" class="form-select select2" id="bom_code" multiple>
                     ...
                     <table id="footable_2" class="table  table-bordered table-striped m-b-0 footable_2 stripe row-border order-column" cellspacing="0" width="100%">
                        ...
                        <tbody id="bomdis">
                           <tr>
                              ...
                              <td><input type="text"  name="sales_order_no[]" value="" id="sales_order_no" style="width:80px;" required  /> </td>
                              <td></td>
                              <td>
                                 <select name="item_codes[]" class="item select2" id="item_code" style="width:250px; height:30px;" required  onchange="getItemDetails(this);" >
               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="totFreightAmt"  class="form-control" id="totFreightAmt" value="0" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
...
<script> 
          ...
          data:{item_code:item_code,tax_type_id:tax_type_ids},
           success: function(response){
               ...
               if(tax_type_ids==1)
               {
                   ...
                   row.find('img[name^="item_image[]"]').attr('src', 'https://ken.korbofx.com/thumbnail/'+response.data[0]['item_image_path']);
   ...
   function calcQty() 
   {
       ...
       var totalQty=(parseFloat(poQty)*parseFloat(SecConQty)*parseFloat(conQty)).toFixed(4);
