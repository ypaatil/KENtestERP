...
<td><input type="number" step="0.01"  class="FABRIC"  name="total_amount[]" value="0" id="total_amounts" style="width:80px; height:30px;" required readOnly/></td> 
...
<td> <select name="unit_idsx[]" id="unit_idsx" style="width:100px; height:30px;" required readOnly >
<option value="">--Unit List--</option>
@foreach($UnitList as  $row)
{
    <option value="{{ $row->unit_id }}">{{ $row->unit_name }}</option>
...
<input type="text"     name="color_arrayss[]" value="0" id="color_arrayss" style="width:80px; height:30px;" required  readOnly/>
</td>
<td> <select name="size_idss[][]"   id="size_idss" style="width:200px; height:100px;" required multiple>
<option value="">--Size List--</option>
 
</select>
<input type="text"     name="size_arrayss[]" value="0" id="size_arrayss" style="width:80px; height:30px;" required  readOnly/>
</td>
...
//alert(item_code);
    ...
    $.ajax({
            ...
            success: function(data)
            {
                    ...
                    var bom_qty=data[0]['bom_qty'].toFixed(3);
