<div class="vertical-menu">
   ...
   <li>
    ...
    <ul class="sub-menu" aria-expanded="false">
  <!-- <li><a href="{{ route('Country.index') }}" key="t-products">Country</a></li>
    <li><a href="{{ route('State.index') }}" key="t-product-detail">State</a></li>
    <li><a href="{{ route('Form.index') }}" key="t-product-detail">Form Master</a></li>
    <li><a href="{{ route('User_Management.index') }}" key="t-orders">User Management</a></li>  -->
  @foreach($Authicateuser as $check)

  @if($check->head_id==1)

<li><a href="{{ route($check->form_name) }}" key="t-customers">{{ $check->form_label }}</a></li>
@endif
   @endforeach
  <!--   <li><a href="ecommerce-cart.html" key="t-cart">Cart</a></li>
    ...
    <ul class="sub-menu" aria-expanded="false">
    <!-- <li><a href="{{ Route('OtherPurchase.create') }}" key="t-products">Other Purchase</a></li> -->
   @foreach($Authicateuser as $check)
...
<!--    </li>-->
    ...
    <a href="javascript: void(0);" class="has-arrow waves-effect">
  &#8377;
    <span key="t-crypto">Party Details</span>
    </a>
    <ul class="sub-menu" aria-expanded="false">
 @foreach($Authicateuser as $check)
  ...
  @if($check->head_id==3)
    ...
    <li><a href="{{ route($check->form_name) }}" key="t-wallet">{{ $check->form_label }}</a></li>
    @endif
   @endforeach
    </ul>
    </li>
...
@endif
   @endforeach
    ...
    <a href="javascript: void(0);" class="has-arrow waves-effect">
    <i class="bx bx-store"></i>
    <span key="t-ecommerce">MIS Reports</span>
    </a>
    <ul class="sub-menu" aria-expanded="false">
    <!-- <li><a href="{{ Route('OtherPurchase.create') }}" key="t-products">Other Purchase</a></li> -->
   @foreach($Authicateuser as $check)
...
<!--    <a href="javascript: void(0);" class="has-arrow waves-effect">-->
<!--    <i class="bx bx-store"></i>-->
<!--    <span key="t-ecommerce">Store Reports</span>-->
<!--    </a>-->
<!--    <ul class="sub-menu" aria-expanded="false">-->
    <!-- <li><a href="{{ Route('OtherPurchase.create') }}" key="t-products">Other Purchase</a></li> -->
<!--   @foreach($Authicateuser as $check)-->
...
<!--    <a href="javascript: void(0);" class="has-arrow waves-effect">-->
<!--    <i class="bx bx-store"></i>-->
<!--    <span key="t-ecommerce">Test Models & Reports</span>-->
<!--    </a>-->
<!--    <ul class="sub-menu" aria-expanded="false">-->
    <!-- <li><a href="{{ Route('OtherPurchase.create') }}" key="t-products">Other Purchase</a></li> -->
<!--   @foreach($Authicateuser as $check)-->
