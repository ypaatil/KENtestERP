...
<form action="{{route('MaterialInward.store')}}" method="POST" enctype="multipart/form-data">
@csrf 
<div class="row">
<div class="col-md-2">
<div class="mb-3">
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="inward_date" class="form-control" id="inward_date" value="{{date('Y-m-d')}}">
    </div>
</div>
