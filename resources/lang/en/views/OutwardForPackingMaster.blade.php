...
<form action="{{route('OutwardForPacking.store')}}" method="POST" enctype="multipart/form-data">
@csrf 
<div class="row">
...
<div class="col-md-2">
    <div class="mb-3">
       ...
       <select name="vpo_code" class="form-control" id="vpo_code" required  onChange="getVendorProcessOrderDetails(this.value);">
   ...
   <div class="panel-group" id="accordion">
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Finishing GRN Against Sales Order</a>
        </h4>
      </div>
...
function getVendorProcessOrderDetails(vpo_code)
{
      ...
      $.ajax({
            ...
            $("#vendor_rate").val(data[0]['order_rate']);
             ...
             $.ajax({
            dataType: "json",
            url: "{{ route('GetFINISHINGGRNQty') }}",
            data:{'tr_code':data[0]['sales_order_no'],'vpo_code':vpo_code},
            success: function(data){
