...
<form action="{{route('GeneralSales.store')}}" method="POST">
...
@foreach($code as  $row)
<input type="text" name="bill_code" class="form-control" id="bill_code" value="{{ 'SALES'.'-'.$row->tr_no }}" readonly="readonly">
