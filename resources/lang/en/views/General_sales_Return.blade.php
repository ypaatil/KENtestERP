...
<form action="{{route('GeneralSalesReturn.store')}}" method="POST">
...
<input type="text" name="bill_code" class="form-control" id="bill_code" value="" readonly="readonly">
...
{
<option value="{{ $rowpay->pay_type  }}">{{ $rowpay->pay_name }}</option>
...
<input type="text" name="Gross_amount" class="form-control" id="Gross_amount" onChange="mycalc();"  value="0">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Add 1</label>
<input type="text" name="add1" id="add1" class="form-control" id="add1" onkeyup="mycalc();" value="0">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Add 2</label>
<input type="text" name="add2" id="add2" class="form-control" id="add2" onkeyup="mycalc();" value="0">
</div>
</div>
...
<input type="text" name="less1"  class="form-control" id="less1" onkeyup="mycalc();" value="0">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Less 2</label>
<input type="text" name="less2"  class="form-control" id="less2" onkeyup="mycalc();" value="0">
</div>
</div>
...
<input type="text" name="Gst_amount" id="Gst_amount" class="form-control" id="Gst_amount" value="0" OnChange="mycalc();">
</div>
</div>
</div>
...
<input type="text" name="Net_amount" id="Net_amount" class="form-control" id="Net_amount" value="0" OnChange="mycalc();">
</div>
</div>
