...
<!--    </div>  -->
                                ...
                                <div class="card">
                                    ...
                                    <table data-order='[[ 0, "desc" ]]' data-page-length='25' id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                          <thead>
                                            ...
                                            @foreach($PackingInhouseMasterList as $row)    
                                            <tr>
                                                <td > {{ substr($row->pki_code,4,15)  }} </td>
                                                ...
                                                <td>
                                                <a class="btn btn-outline-secondary btn-sm print" href="VPPrint/{{ $row->pki_code }}" title="print">
                                                    <i class="fas fa-print"></i>
                                                </a>
                                                </td>
                                                
                                                <td>
                                                <a class="btn btn-outline-secondary btn-sm edit" href="{{route('PackingInhouse.edit', $row->pki_code)}}" title="Edit">
        ...
        <button  class="btn   btn-sm delete"  data-placement="top" id="DeleteRecord" data-token="{{ csrf_token() }}" data-id="{{ $row->pki_code }}"  data-route="{{route('PackingInhouse.destroy', $row->pki_code )}}" title="Delete">
