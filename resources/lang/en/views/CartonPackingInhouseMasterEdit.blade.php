...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="cpki_date" class="form-control" id="cpki_date" value="{{$CartonPackingInhouseMasterList->cpki_date}}" required readOnly>
...
<td><input type="text" name="carton_no[]" value="{{$List->carton_no}}" id="id" style="width:80px;height:30px; "/></td>
<td> 
