...
<form action="{{route('TrimsInward.store')}}" method="POST">
...
<td> <select name="item_codes[]" class="select2" id="item_codes" style="width:200px;height:30px;" onchange="GetUnit(this);" >
...
<td> <select name="unit_ids[]" class=" " id="unit_ids" style="width:100px;height:30px;">
...
<td><input type="number" step="any" class="QTY"   name="item_qtys[]"   value="0" id="item_qty" style="width:80px;height:30px;" required/>
...
<td><input type="number" step="any" class="AMT" readOnly  name="amounts[]"   value="0" id="amounts" style="width:80px;height:30px;" required/>
 ...
 <td> <select name="rack_id[]" class="select2"  id="rack_id" style="width:100px;height:30px;" required>
