...
<form action="{{route('ReturnableOutward.store')}}" method="POST">
...
{
<option value="{{ $rowdepartment->dept_id  }}">{{ $rowdepartment->dept_name }}</option>
...
{
<option value="{{ $rowmachinelist->machineId  }}">{{ $rowmachinelist->machineName  }}</option>
...
<input type="text" name="gstNo" class="form-control" id="gstNo" value="" >
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
...
<input type="text" name="vehicalNo" class="form-control" id="vehicalNo">
</div>
</div>
<div class="col-md-4">  
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Term Of Payment</label>
<input type="text" name="termOfPayment" class="form-control" id="termOfPayment">
</div>
</div>
</div>
