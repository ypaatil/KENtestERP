...
<form action="{{route('InwardStore.update',$purchasefetch)}}" method="POST">
...
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Inward No</label>

<input type="text" name="pur_code" class="form-control" id="pur_code" value="{{ $purchasefetch->storeInCode }}" readonly="readonly">
...
<input type="date" name="pur_date" class="form-control" id="formrow-email-input" value="{{ $purchasefetch->storeInward_date }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Inward Type</label>
<select name="inwardTypeId" class="form-select" id="inwardTypeId" required="required" onchange="showfeilds(this.value);">
<option value="">--- Select Type ---</option>
@foreach($inwardTypelist as  $rowinwardtype)
{
<option value="{{ $rowinwardtype->inwardTypeId }}"

{{ $rowinwardtype->inwardTypeId == $purchasefetch->inwardTypeId ? 'selected="selected"' : '' }}

    >{{ $rowinwardtype->inwardType }}</option>
...
@if($purchasefetch->inwardTypeId==2)
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Invoice No</label>
<input type="text" name="pur_bill_no" class="form-control" id="pur_bill_no" value="{{ $purchasefetch->pur_bill_no }}" disabled="disabled">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Invoice Date</label>
<input type="date" name="pur_bill_date" class="form-control" id="pur_bill_date" value="{{ $purchasefetch->pur_bill_date }}" disabled="disabled">
</div>
</div>
@else
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Invoice No</label>
<input type="text" name="pur_bill_no" class="form-control" id="pur_bill_no" value="{{ $purchasefetch->pur_bill_no }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Invoice Date</label>
<input type="date" name="pur_bill_date" class="form-control" id="pur_bill_date" value="{{ $purchasefetch->pur_bill_date }}">
</div>
</div>
...
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Challan No</label>
<input type="text" name="dc_no" class="form-control" id="dc_no"  value="{{ $purchasefetch->dc_no }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Challan Date</label>
<input type="date" name="dc_date" class="form-control" id="dc_date"  value="{{ $purchasefetch->dc_date }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-inputState" class="form-label">PO No</label>
<select name="po_no" class="form-select" id="po_no" onchange="gettable(this.value);getDetails(this.value)">
<option value="">--- Select Po No---</option>
@foreach($polist as  $rowpo)
{
<option value="{{ $rowpo->pur_code  }}"

{{ $rowpo->pur_code == $purchasefetch->po_no ? 'selected="selected"' : '' }}
    >{{ $rowpo->pur_code }}</option>
...
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Challan No</label>
<input type="text" name="dc_no" class="form-control" id="dc_no" disabled="disabled" value="">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Challan Date</label>
<input type="date" name="dc_date" class="form-control" id="dc_date" disabled="disabled" value="">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-inputState" class="form-label">PO No</label>
<select name="po_no" class="form-select" id="po_no" onchange="gettable(this.value);getDetails(this.value)" disabled="disabled">
<option value="">--- Select Po No---</option>
@foreach($polist as  $rowpo)
{
<option value="{{ $rowpo->pur_code  }}">{{ $rowpo->pur_code }}</option>
...
<input type="text" name="gstNo" class="form-control" id="formrow-email-input" value="{{ $purchasefetch->gstNo }}">
</div>
</div>
...
<div class="col-md-3">
<div class="mb-3">
<label for="formrow-inputState" class="form-label">Location</label>
<select name="loc_id" class="form-select" id="loc_id">
<option value="">--- Select Location ---</option>
@foreach($locationlist as  $rowLocation)
{
<option value="{{ $rowLocation->loc_id  }}"


{{ $rowLocation->loc_id == $purchasefetch->loc_id ? 'selected="selected"' : '' }}
...
<td><input type="text" name="id" value="{{ $no }}" id="id"  style="width:50px;"/></td>
 <td>
<select name="item_codes[]" class="item" id="item_code" style="width:100px;">
<option value="">--- Select Item ---</option>
@foreach($itemlist as  $rowitem)
{
...
@endforeach
 ...
 <td><input type="text"   name="hsn_code[]"   value="{{ $row->hsn_code }}" id="hsn_code" style="width:80px;" required/></td>   
<td> <select name="unit_id[]" class="unit_id" id="unit_id" style="width:100px;">
<option value="">--- Select Unit ---</option>
@foreach($unitlist as  $rowunit)
{
...
<td><input style="width:80px;" type="text" class="Qty" name="item_qtys[]" value="{{ $row->item_qty }}"  id="item_qty">
</td>
<td><input  style="width:80px;" type="number" step="0.01" class="" name="item_rates[]" value="{{ $row->item_rate }}" id="item_rate">
</td> 
<td><input readOnly style="width:80px;"  type="number" id="pur_cgst" step="0.01"  class="" name="pur_cgsts[]" value="{{ $row->pur_cgst }}"></td>
<td><input  style="width:80px;"  type="number" step="0.01" id="camt" class="GSTAMT" name="camts[]" value="{{ $row->camt }}"></td>
<td><input readOnly style="width:80px;"  type="number" step="0.01" id="pur_sgst" class="" name="pur_sgsts[]" value="{{ $row->pur_sgst }}"></td>
<td><input style="width:80px;"  type="number" step="0.01" id="samt" class="GSTAMT" name="samts[]" value="{{ $row->samt }}"></td>
<td><input readOnly style="width:80px;"  type="number" step="0.01" id="pur_igst" class="" name="pur_igsts[]" value="{{ $row->pur_igst }}"></td>
<td><input  style="width:80px;"  type="number" step="0.01" id="iamt" class="GSTAMT" name="iamts[]" value="{{ $row->iamt }}"></td>
<td><input  style="width:80px;"  type="number" step="0.01" id="amount" class="GROSS" name="amounts[]" value="{{ $row->amount }}"></td>

<td><input type="text" name="freight_hsn[]" class="" id="freight_hsn" value="{{ $row->freight_hsn }}" style="width:80px;"></td>

<td><input type="text" name="freight_amt[]" class="FREIGHT" id="freight_amt" value="{{ $row->freight_amt }}" style="width:80px;"></td>


<td><input  style="width:80px;"  type="number" step="0.01" id="total_amount" class="TOTAMT" name="total_amounts[]" value="{{ $row->total_amount }}"></td>
...
<input type="text" name="Gross_amount" class="form-control" id="Gross_amount" onChange="mycalc();" value="{{ $purchasefetch->Gross_amount }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">GST Amount</label>
<input type="text" name="Gst_amount" class="form-control" id="Gst_amount" value="{{ $purchasefetch->Gst_amount }}">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Freight Amount</label>
<input type="text" name="totFreightAmt"  class="form-control" id="totFreightAmt" value="{{ $purchasefetch->totFreightAmt }}">
</div>
</div>
...
<input type="text" name="Net_amount" class="form-control" id="Net_amount" value="{{ $purchasefetch->Net_amount }}">
</div>
</div>
<div class="col-md-4">  
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Address</label>
<input type="text" name="address" class="form-control" id="address" value="{{ $purchasefetch->address }}">
</div>
</div>
...
<input class="form-check-input" type="hidden" name="inwardApproveFlag" value="0" id="inwardApproveFlag">
<input class="form-check-input" type="checkbox" name="inwardApproveFlag" value="1" id="inwardApproveFlag"  @if($purchasefetch->inwardApproveFlag==1) checked="Checked" @endif>
</div>
</div>
...
t3.name="hsn_code[]";
t3.value=document.getElementById("hsn_code").value;
...
t4.type="number";
//t3.className="QTY";
t4.id = "item_qtys"+index;
t4.name="item_qtys[]";
t4.value=document.getElementById("item_qty").value;
...
t5.type="number";
t5.step="0.01";
t5.id = "item_rates"+index;
t5.name= "item_rates[]";
t5.value=document.getElementById("item_rate").value;
...
t13.value=document.getElementById("freight_amt").value;
cell13.appendChild(t13);
...
$("#c_code").val(response["c_code"]);
 ...
 $('#footable_2').on('change', '.item', function() 
 {
    ...
    row.find('input[name^="pur_sgsts[]"]').val(0);
     ...
     $("table.footable_2").on("keyup", 'input[name^="item_qtys[]"],input[name^="item_rates[]"],input[name^="pur_cgsts[]"],input[name^="camts[]"],input[name^="pur_sgsts[]"],input[name^="pur_igsts[]"],input[name^="iamts[]"],input[name^="amounts[]"],input[name^="freight_amt[]"],input[name^="total_amounts[]"]', function (event) {
...
function showfeilds(inwardTypeId)
{
 ...
 if(inwardTypeId==1)
 {
$("#pur_bill_no").prop('disabled', false);
$("#pur_bill_date").prop('disabled', false);
...
$("#pur_bill_no").prop('disabled', true);
$("#pur_bill_date").prop('disabled', true);
$("#dc_no").prop('disabled', false);
$("#dc_date").prop('disabled', false);
