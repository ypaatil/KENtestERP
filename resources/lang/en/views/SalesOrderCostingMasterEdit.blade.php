...
<form action="{{ route('SalesOrderCosting.update',$SalesOrderCostingMasterList) }}" method="POST" enctype="multipart/form-data">
@method('put')
@csrf
...
<div class="col-md-2">
 ...
 <input type="hidden" name="soc_code" class="form-control" id="soc_code" value="{{$SalesOrderCostingMasterList->soc_code}}" required readOnly>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <!--<input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{ $SalesOrderCostingMasterList->sales_order_no }}" required onfocusout="getSalesOrderDetails(this.value);">-->
       <select name="sales_order_no" class="form-select" id="sales_order_no" required  onChange="getSalesOrderDetails(this.value);" disabled>
<option value="">--Sales Order No--</option>
@foreach($SalesOrderList as  $row)
{
    <option value="{{ $row->tr_code }}"
     {{ $row->tr_code == $SalesOrderCostingMasterList->sales_order_no ? 'selected="selected"' : '' }}  
    >{{ $row->tr_code }}</option>
}
@endforeach
</select>
...
@foreach($Ledger as  $row)
{
    <option value="{{ $row->ac_code }}"
     {{ $row->ac_code == $SalesOrderCostingMasterList->Ac_code ? 'selected="selected"' : '' }}  
    >{{ $row->ac_name }}</option>
}
@endforeach
</select>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="number" name="order_rate" class="form-control" id="order_rate" value="{{$SalesOrderCostingMasterList->order_rate}}" required readOnly>
    </div>
</div> 
...
<input type="number" step="0.01" name="exchange_rate" class="form-control" id="exchange_rate" value="{{ $SalesOrderCostingMasterList->exchange_rate }}" required>
...
<input type="text" name="sam" class="form-control" id="sam" value="{{ $SalesOrderCostingMasterList->sam }}" required>
...
<td> 
<input type="text"    name="description[]" value="{{$List->description}}" id="description" style="width:200px; height:30px;" required /></td> 
...
<td> 
<input type="text"    name="description[]" value="0" id="description" style="width:200px; height:30px;" required /></td> 
...
@endforeach
 ...
 <td> 
<input type="text"    name="descriptions[]" value="{{$List->description}}" id="descriptions" style="width:200px; height:30px;" required /></td> 
...
<td>
    ...
    <input type="text"    name="descriptions[]" value="0" id="descriptions" style="width:200px; height:30px;" required /></td> 
...
<td> 
    <input type="text"    name="descriptionss[]" value="0" id="descriptionss" style="width:200px; height:30px;" required /></td> 
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text" name="fabric_value" class="form-control" id="fabric_value" value="{{ $SalesOrderCostingMasterList->fabric_value }}" required  readOnly>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text" name="sewing_trims_value" class="form-control" id="sewing_trims_value" value="{{ $SalesOrderCostingMasterList->sewing_trims_value }}" required readOnly >
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text" name="packing_trims_value" class="form-control" id="packing_trims_value" value="{{ $SalesOrderCostingMasterList->packing_trims_value }}" required readOnly >
...
<table  >
  ...
  <tr>
    ...
    <label for="production_value" class="form-label">Manufacturing Cost</label></td>
       <td><input type="text" name="production_value" id="production_value" style="width:150px;" value="{{ $SalesOrderCostingMasterList->production_value }}" required  onkeyup="mycalc(); calculatepercentage();">
     </td>  <td>   <input type="text" name="production_per" id="production_per" style="width:150px;" value="{{  number_format((float)$percentOfproduction_value, 2, '.', '')  }}" required  onkeyup="mycalc(); calculatepercentage();">
       </td> 
    ...
    <td>      <label for="agent_commission_value" class="form-label">Commission Cost</label> </td>
        <td><input type="text" name="agent_commission_value"  id="agent_commission_value" style="width:150px;" value="{{ $SalesOrderCostingMasterList->agent_commision_value }}" required  onkeyup="mycalc(); calculatepercentage();">
      </td>  <td>   <input type="text" name="agent_commission_per"  id="agent_commission_per" style="width:150px;" value="{{ number_format((float)$percentOfagent_commision_value, 2, '.', '') }}" required  onkeyup="mycalc(); calculatepercentage();">
       </td>
    ...
    <td>      <label for="transport_value" class="form-label">Transport Cost</label> </td>
      <td>  <input type="text" name="transport_value" class="" id="transport_value" style="width:150px;" value="{{ $SalesOrderCostingMasterList->transaport_value }}" required  onkeyup="mycalc(); calculatepercentage();">
     </td>  <td>  <input type="text" name="transport_per" class="" id="transport_per" style="width:150px;" value="{{  number_format((float)$percentOftransaport_value, 2, '.', '') }}" required  onkeyup="mycalc(); calculatepercentage();">
       </td>
   ...
   <tr>
    <td>       <label for="dbk_value" class="form-label">DBK Value</label>  </td>
