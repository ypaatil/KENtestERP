                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tr>
                                <td><a href="http://ken.korbofx.org/PurchaseOrder/{{ $row->sr_no }}/edit" >{{ $row->pur_code }} </a></td>
                                <td>{{ $row->pur_date }}</td>
                                ...
                                <td>{{ $row->dimension }}</td>
                                <td><a href="http://ken.korbofx.org/PurchaseOrder/{{ $row->sr_no }}/edit" >{{ number_format($row->item_qty) }}</a></td>
                                <td> <span onclick="openmodal({{ $row->sr_no }},{{ $row->item_code }});" style="color:#556ee6; cursor: pointer;">{{ number_format($row->received_meter) }}</span></td>
                                 <td style="text-align:right;">{{   number_format((double)($row->to_be_received_meter/100000), 2, '.', '') }}</td>
                                ...
                                <td style="text-align:right;">{{   number_format((double)($row->fabric_stock/100000), 2, '.', '')}}</td>
