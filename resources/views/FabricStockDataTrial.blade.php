...
<div class="row">
         ...
         <div class="card-body">
            <div class="d-flex">
               <div class="flex-grow-1">
                  <p class="  fw-medium" style="color:#fff;">Total Stock Qty(In Lakh)</p>
   ...
   <div class="col-md-3">
    ...
    <div class="col-md-6">
       <div class="card mini-stats-wid" style="background-color:#152d9f;" >
          <div class="card-body">
              <form action="/FabricStockDataTrial" method="GET">
                  <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6 mt-4"> 
                            ...
                            <a href="/FabricStockDataTrial" class="btn btn-warning">Clear</a>
                      </div>
                  </div>
              </form>
          </div>
            ...
            <div class="table-responsive">
               <table id="datatable-buttons" class="table table-bordered   nowrap w-100">
                  ...
                  <tbody>
                    ...
                    $GRNData =DB::select("select meter as grnQty from inward_details where  track_code='".$row->track_code."'".$in_date);
                    ...
                    $QCData =DB::select("select meter as QCQty from fabric_checking_details where track_code='".$row->track_code."'".$chk_date);
                    ...
                    @endphp
                     ...
                     @endforeach
                     @endif
                     <input type="hidden" id="total_grn_qty" value="{{money_format('%!i',round(($total_grn_qty/100000),2))}}">
                     <input type="hidden" id="total_qc_qty" value="{{money_format('%!i',round(($total_qc_qty/100000),2))}}">
                     <input type="hidden" id="total_outward_qty" value="{{money_format('%!i',round(($total_outward_qty/100000),2))}}">
                     <input type="hidden" id="total_stock_qty" value="{{money_format('%!i',round(($total_stock_qty/100000),2))}}">
                     <input type="hidden" id="total_value" value="{{money_format('%!i',round(($total_value/100000),2))}}"> 
                  </tbody>
               </table>
            </div>
         </div>
