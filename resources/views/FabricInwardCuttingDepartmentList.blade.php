...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">Fabric Inward - Cutting Department List</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);">Transaction</a></li>
               <li class="breadcrumb-item active">Fabric Inward - Cutting Department List</li>
            </ol>
         </div>
      </div>
   </div>
...
<div class="row">
   <div class="col-md-4">
      <a href="{{ Route('FabricInwardCuttingDepartment.create') }}"><button type="buuton" class="btn btn-primary w-md">Add New Record</button></a>
   </div>
...
<script type="text/javascript"> 
 $(function () 
    {
        var url = 'FabricInwardCuttingDepartment?page=0';
        TableData(url);
    });
  
    function showAll()
    {
        var url = 'FabricInwardCuttingDepartment?page=1';
        TableData(url);
    }
  ...
  function TableData(url)
  {
       ...
       var table = $('#fabric_outward_table').DataTable({
        ...
        columns: [
          {data: 'ficd_code', name: 'ficd_code'},
          {data: 'ficd_date', name: 'ficd_date'},
