...
<form action="{{ route('BOM.update',$BOMMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData" >
@method('put')
@csrf
...
<td> <select name="class_id[]"   id="class_id" style="width:200px; height:30px;" disabled>
...
<td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="{{$List->consumption}}" @endif name="consumption[]" value="{{$List->consumption}}" id="consumption" style="width:80px; height:30px;" required /></td> 
<td> <select name="unit_id[]" class=" " id="unit_id" style="width:100px; height:30px;" disabled>
...
<td><input type="number" step="any" @if(Session::get('user_type')!=1)  min="0" max="{{$List->rate_per_unit}}" @endif name="rate_per_unit[]" value="{{$List->rate_per_unit}}" id="rate_per_unit" style="width:80px; height:30px;" required /></td> 
...
<td><input type="text"  min="0" max="{{$List->bom_qty}}"    name="bom_qty[]" value="{{$List->bom_qty}}" id="bom_qty" style="width:80px; height:30px;" readOnly/>
...
<td><input type="button" readOnly name="Fbutton[]"   class="btn btn-warning pull-left" value="+"> <input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone1(this);" value="X" @php if($List->item_count_fab >0){ echo 'disabled'; } @endphp></td>
</tr>
...
<td><input type="text"    name="description[]" value="0" id="description" style="width:200px; height:30px;" readOnly /></td> 
 
<td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="0" @endif  name="consumption[]" value="0" id="consumption" style="width:80px; height:30px;" required /></td> 
<td> <select name="unit_id[]"   id="unit_id" style="width:100px; height:30px;" disabled>
<option value="">--Unit List--</option>
@foreach($UnitList as  $row)
{
...
<td><input type="number" step="any" @if(Session::get('user_type')!=1)  min="0" max="0" @endif  name="rate_per_unit[]" value="0" id="rate_per_unit" style="width:80px; height:30px;" required /></td> 
...
<td><input type="text"  name="bom_qty[]" value="0" id="bom_qty" style="width:80px; height:30px;" readOnly />
...
<td><input type="button"   readOnly name="Fbutton[]"  class="btn btn-warning pull-left" value="+"><input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone1(this);" value="X" ></td>
</tr>
@endif
 </tbody>
...
<td> <select name="class_idsx[]" class="select2"  id="class_idsx" style="width:200px; height:30px;"  onchange="CalculateQtyRowPros123(this);"  >
<option value="">--Classification--</option>
@foreach($ClassList as  $row)
{
    <option value="{{ $row->class_id }}"
...
<td> <select name="item_codesx[]" class="item_trim_fabric select2" id="item_codesx" style="width:270px; height:30px;"   @php if($List->item_count>0){ echo 'disabled'; } @endphp>
<option value="">--Item List--</option>
...
<td> <select name="color_idsx[][]"   id="color_idsx" style="width:300px; height:140px;"    multiple>
...
<td> <select name="size_idsx[][]"   id="size_idsx" style="width:200px; height:140px;"   multiple> 
...
<td> <select name="unit_idsx[]"   id="unit_idsx" style="width:100px; height:30px;"   disabled >
<option value="">--Unit List--</option>
@foreach($UnitList as  $row)
{
    <option value="{{ $row->unit_id }}"
...
<td><input type="number" step="any"  @if(Session::get('user_type')!=1) min="0" max="{{$List->rate_per_unit}}" @endif name="rate_per_unitsx[]" value="{{$List->rate_per_unit}}" id="rate_per_unitsx" style="width:80px; height:30px;"   /></td> 
...
<td><input type="text"  @if(Session::get('user_type')!=1) min="0" max="{{$List->bom_qty}}"  @endif name="bom_qtysx[]" value="{{$List->bom_qty}}" id="bom_qtysx" style="width:80px; height:30px;"   readOnly/> 
 <input type="hidden" name="bom_qtysx1[]" value="{{$List->item_qty}}" id="bom_qtysx1" style="width:80px; height:30px;"  readOnly/></td>
...
<td><input type="button" readOnly name="Tbutton[]" class="btn btn-warning pull-left" value="+"> <input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone5(this);" value="X" @php if($List->item_count_trim_fab >0){ echo 'disabled'; } @endphp></td>
</tr>
...
<td> <select name="item_codesx[]" class="item_trim_fabric select2" id="item_codesx" style="width:270px; height:30px;"  >
<option value="">--Item List--</option>
 @foreach($ItemList4 as  $row)
{
    <option value="{{ $row->item_code }}"
...
<td> <select name="unit_idsx[]" class=" " id="unit_idsx" style="width:100px; height:30px;"   >
<option value="">--Unit List--</option>
@foreach($UnitList as  $row)
{
    <option value="{{ $row->unit_id }}">{{ $row->unit_name }}</option>
...
<td><input type="text"      name="bom_qtysx[]" value="0" id="bom_qtysx" style="width:80px; height:30px;"   readOnly /> 
 <input type="hidden" name="bom_qtysx1[]" value="0" id="bom_qtysx1" style="width:80px; height:30px;"    readOnly/></td>
...
<td><input type="button"  readOnly name="Tbutton[]" class="btn btn-warning pull-left" value="+"> <input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone5(this);" value="X" ></td>
</tr>
...
<td> <select name="class_ids[]"  class="select2" id="class_ids" style="width:200px; height:30px;" required  onchange="CalculateQtyRowPros10(this)" @php if($List->item_count>0){ echo 'disabled'; } @endphp>
<option value="">--Classification--</option>
...
<td> <select name="item_codes[]" class="select2" id="item_codes" style="width:270px; height:30px;" required @php if($List->item_count>0){ echo 'disabled'; } @endphp>
<option value="">--Item List--</option>
...
<td> <select name="color_ids[][]"   id="color_ids" style="width:300px; height:140px;"   multiple @php if($List->item_count>0){ echo ''; } @endphp>
<option value="">--Color List--</option>
@php $color_ids = explode(',', $List->color_id);   @endphp
@foreach($ColorList as  $row)
{
...
<td> <select name="size_ids[][]"  id="size_ids" style="width:200px; height:140px;" required multiple @php if($List->item_count>0){ echo 'disabled'; } @endphp> 
<option value="">--Size List--</option>
@php $size_ids = explode(',', $List->size_array);   @endphp
@foreach($SizeDetailList as  $row)
{
...
<td><input type="number" step="any"  min="0" max="{{$List->consumption}}"  name="consumptions[]"  value="{{$List->consumption}}" id="consumptions" style="width:80px; height:30px;" required @php if($List->item_count>0){ echo 'readOnly'; } @endphp /></td> 
<td> <select name="unit_ids[]" class=" " id="unit_ids" style="width:100px; height:30px;" required disabled>
<option value="">--Unit List--</option>
@foreach($UnitList as  $row)
{
    <option value="{{ $row->unit_id }}"
...
<td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="{{$List->rate_per_unit}}" @endif   name="rate_per_units[]" value="{{$List->rate_per_unit}}" id="rate_per_units" style="width:80px; height:30px;" required  @php if($List->item_count>0){ echo 'readOnly'; } @endphp/></td> 
<td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="{{$List->wastage}}" @endif name="wastages[]" value="{{$List->wastage}}" id="wastages" style="width:80px; height:30px;" required  @php if($List->item_count>0){ echo 'readOnly'; } @endphp/></td> 
<td><input type="text" @if(Session::get('user_type')!=1) min="0" max="{{$List->bom_qty}}"  @endif name="bom_qtys[]" value="{{$List->bom_qty}}" id="bom_qtys" style="width:80px; height:30px;" required readOnly/>
<input type="hidden" name="bom_qtys1[]" value="{{$List->item_qty}}" id="bom_qtys1" style="width:80px; height:30px;" required readOnly/>
</td> 
...
<td><input   name="Sbutton[]"    type="button"   class="btn btn-warning pull-left" value="+" /> <input type="button" @php if($List->item_count>0){ echo 'disabled'; } @endphp class="btn btn-danger pull-left" onclick="deleteRowcone2(this);" value="X" ></td>
...
<td> <select name="class_ids[]" class="select2"  id="class_ids" style="width:200px; height:30px;" required onchange="CalculateQtyRowPros10(this)" >
<option value="">--Classification--</option>
@foreach($ClassList2 as  $row)
{
...
<td> <select name="item_codes[]" class="item_sewing_trims class="select2"" id="item_codes" style="width:270px; height:30px;" required>
<option value="">--Item List--</option>
@foreach($ItemList2 as  $row)
{
...
<td> <select name="color_ids[][]"  id="color_ids" style="width:300px; height:100px;"  multiple>
<option value="">--Color List--</option>
@foreach($ColorList as  $row)
{
    <option value="{{ $row->color_id }}"
...
<td> <select name="size_ids[][]" class="" id="size_ids" style="width:200px; height:140px;"  multiple>  
<option value="">--Size List--</option>
 @foreach($SizeDetailList as  $row)
{
    <option value="{{ $row->size_id }}"
...
<td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="0" @endif  name="consumptions[]" value="0" id="consumptions" style="width:80px; height:30px;" required /></td> 
<td> <select name="unit_ids[]" class=" " id="unit_ids" style="width:100px; height:30px;"  disabled>
<option value="">--Unit List--</option>
@foreach($UnitList as  $row)
{
    <option value="{{ $row->unit_id }}">{{ $row->unit_name }}</option>
...
<td><input type="number" step="any" @if(Session::get('user_type')!=1)  min="0" max="0"  @endif  name="rate_per_units[]" value="0" id="rate_per_units" style="width:80px; height:30px;" required /></td> 
<td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="0"  @endif name="wastages[]" value="0" id="wastages" style="width:80px; height:30px;" required /></td> 
...
<td><input type="button"  readOnly name="Sbutton[]" class="btn btn-warning pull-left" value="+"><input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone2(this);" value="X" ></td>
</tr>
...
<td> <select name="class_idss[]"  class="select2" id="class_idss" style="width:200px; height:30px;" required onchange="CalculateQtyRowPros11(this);" @php if($List->item_count>0){ echo 'disabled'; } @endphp>
<option value="">--Classification--</option>
...
<td> <select name="item_codess[]" class="item_packing_trims id select2" id="item_codess" style="width:270px; height:30px;" required @php if($List->item_count>0){ echo 'disabled'; } @endphp>
<option value="">--Item List--</option>
...
<td> <select name="color_idss[][]"   id="color_idss" style="width:300px; height:140px;" required multiple @php if($List->item_count>0){ echo ''; } @endphp>
<option value="">--Color List--</option>
@php $color_ids = explode(',', $List->color_id);   @endphp
@foreach($ColorList as  $row)
{
...
<td> <select name="size_idss[][]"   id="size_idss" style="width:200px; height:140px;" required multiple @php if($List->item_count>0){ echo 'disabled'; } @endphp>
<option value="">--Size List--</option>
...
@endforeach
 ...
 <input type="hidden" name="size_arrayss[]" value="{{$List->size_array}}" id="size_arrayss" style="width:80px; height:30px;" required  readOnly/>
 
</td>
<td><input type="number" step="any" @if(Session::get('user_type')!=1)  min="0" max="{{$List->consumption}}" @endif name="consumptionss[]" value="{{$List->consumption}}" id="consumptionss" style="width:80px; height:30px;" required /></td> 
...
<td><input type="number" step="any"  @if(Session::get('user_type')!=1) min="0" max="{{$List->rate_per_unit}}"   @endif name="rate_per_unitss[]" value="{{$List->rate_per_unit}}" id="rate_per_unitss" style="width:80px; height:30px;" required /></td> 
<td><input type="number" step="any" @if(Session::get('user_type')!=1)  min="0" max="{{$List->wastage}}" @endif name="wastagess[]" value="{{$List->wastage}}" id="wastagess" style="width:80px; height:30px;" required /></td> 
<td><input type="text"   @if(Session::get('user_type')!=1) min="0" max="{{$List->bom_qty}}"  @endif  name="bom_qtyss[]" value="{{$List->bom_qty}}" id="bom_qtyss" style="width:80px; height:30px;" required readOnly/>
<input type="hidden" name="bom_qtyss1[]" value="{{$List->item_qty}}" id="bom_qtyss1" style="width:80px; height:30px;" required readOnly/>
</td> 
...
<td><input type="button"  readOnly name="Pbutton[]" class="btn btn-warning pull-left" value="+"><input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone3(this);" value="X"  @php if($List->item_count > 0 || $List->item_count_pack>0 ){ echo 'disabled'; } @endphp></td>
</tr>
...
<tr>
<td><input type="text" name="idss" value="1" id="id" style="width:50px;"/></td>
<td> <select name="class_idss[]"  class="select2" id="class_idss" style="width:200px; height:30px;" required onchange="CalculateQtyRowPros11(this);" >
<option value="">--Classification--</option>
@foreach($ClassList3 as  $row)
{
    <option value="{{ $row->class_id }}">{{ $row->class_name }}</option>
...
<td> <select name="item_codess[]" class="item_packing_trims select2" id="item_codess" style="width:270px; height:30px;" required>
<option value="">--Item List--</option>
@foreach($ItemList3 as  $row)
{
    <option value="{{ $row->item_code }}">({{$row->item_code}}) {{ $row->item_name }}</option>
...
<td> <select name="size_idss[][]"   id="size_idss" style="width:200px; height:140px;" required multiple>
<option value="">--Size List--</option>
 @foreach($SizeDetailList as  $row)
{
    <option value="{{ $row->size_id }}"
...
<td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="0" @endif  name="consumptionss[]" value="0" id="consumptionss" style="width:80px; height:30px;" required /></td> 
<td> <select name="unit_idss[]"   id="unit_idss" style="width:100px; height:30px;" required disabled>
<option value="">--Unit List--</option>
@foreach($UnitList as  $row)
{
...
<td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="0"  @endif name="rate_per_unitss[]" value="0" id="rate_per_unitss" style="width:80px; height:30px;" required /></td> 
<td><input type="number" step="any"  @if(Session::get('user_type')!=1) min="0" max="0" @endif  name="wastagess[]" value="0" id="wastagess" style="width:80px; height:30px;" required /></td> 
<td><input type="text"     name="bom_qtyss[]" value="0" id="bom_qtyss" style="width:80px; height:30px;" required  readOnly/>
<input type="hidden" name="bom_qtyss1[]" value="{{isset($List->item_qty) ? $List->item_qty : 0}}" id="bom_qtyss1" style="width:80px; height:30px;" required readOnly/>
</td> 
...
<td><input type="button" readOnly name="Pbutton[]" class="btn btn-warning pull-left" value="+"> <input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone3(this);" value="X" ></td>
</tr>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Step 1: Open the collapse
        $('#collapse4').collapse('show');
        
        // Step 2: Wait for it to finish opening
        $('#collapse4').on('shown.bs.collapse', function () {
            console.log('#collapse4 is now open');
        
            const fields = $('select[name="item_code[]"]');
            let index = 0;
        
            function triggerNext() {
                if (index >= fields.length) return;
        
                const currentField = fields.eq(index);
        
                // ✅ Store current value
                const originalValue = currentField.val();
        
                // ✅ Unselect temporarily and trigger change
                currentField.val('').trigger('change');
        
                // ✅ Delay, then restore value and trigger related function
                setTimeout(() => {
                    currentField
                        .val(originalValue)
                        .trigger('change')
                    ...
                    // ✅ Call your custom function AFTER value is set
                    CalculateQtyRowPros1(currentField.closest("tr"));
        
                    // ✅ Simulate Tab key press
                    const tabEvent = $.Event('keydown', { keyCode: 9, which: 9 });
                    currentField.trigger(tabEvent);
        
                    // Move to next field after a short delay
                    index++;
                    setTimeout(triggerNext, 500); // Adjust as needed
                }, 100); // Delay before re-selecting the value
            }
        
            // Start auto-processing fields
            triggerNext();
        });
        ...
        $('#collapse2').on('shown.bs.collapse', function () {
            console.log('#collapse2 is now open');
        
            const fields = $('select[name="color_ids[][]"]');
            let index = 0;
            ...
            function triggerNext() {
                ...
                // ✅ Store the currently selected values (array for multiple select)
                const originalValues = currentField.val() || [];
        
                // ✅ Unselect all
                currentField.val([]).trigger('change');
        
                // ✅ Delay, then restore selected values
                setTimeout(() => {
                    currentField
                        .val(originalValues)
                        .trigger('change')
                    ...
                    // ✅ Optional: Call your custom function here if needed
                    // Example: CalculateColorImpact(currentField.closest("tr"));
                    CalculateQtyRowPros2(currentField.closest("tr"));
                    // ✅ Simulate Tab key press
                    const tabEvent = $.Event('keydown', { keyCode: 9, which: 9 });
                    currentField.trigger(tabEvent);
                    ...
                    index++;
                    setTimeout(triggerNext, 500); // adjust as needed
                }, 100); // small delay before re-selection
            }
        ...
        $('#collapse3').on('shown.bs.collapse', function () {
            console.log('#collapse3 is now open');
        
            const fields = $('select[name="color_idss[][]"]');
            let index = 0;
            ...
            function triggerNext() {
                ...
                setTimeout(() => {
                    ...
                    // ✅ Optional: Call your custom function here if needed
                    // Example: CalculateColorImpact(currentField.closest("tr")); 
                    CalculateQtyRowPros3(currentField.closest("tr"));
                    // ✅ Simulate Tab key press
                    const tabEvent = $.Event('keydown', { keyCode: 9, which: 9 });
                    currentField.trigger(tabEvent);
...
{   
    ...
    var consumptions1=row.find('td input[name^="consumptions[]"]').val();
    console.log("consumptions2"+consumptions1);
    ...
    $.ajax({
            ...
            success: function(data)
            {
                   ...
                   // row.find('input[name^="consumptions[]"]').val(data[0]['consumption']);
                    ...
                    var  wastage=data[0]['wastage'];consumptions1
                   // var  consumption=data[0]['consumption'];
                    var  consumption=consumptions1;
...
//alert(item_code);
    ...
    var sales_order_no=$('#sales_order_no').val();
    var consumptions1=row.find('td input[name="consumption[]"]').val();
    console.log("consumptions1"+consumptions1);
    $.ajax({
            type: "GET",
            dataType:"json",
...
{   
    ...
    var consumptionss1=row.find('td input[name="consumptionss[]"]').val();
    console.log("consumptionss1"+consumptionss1);
   ...
   $.ajax({
            ...
            { 
                ...
                //    var bom_qty_final= (bom_qty + (bom_qty*(wastage/100))).toFixed(4);
                    var  wastage=data[0]['wastage'];
                   // var  consumption=data[0]['consumption'];
                    var  consumption=consumptionss1;
                    var bom_qty=parseFloat(data[0]['bom_qty']*consumption).toFixed(3);
                    var bom_qty1=(parseFloat(bom_qty) + (parseFloat(parseFloat(bom_qty)*(parseFloat(wastage)/100)))).toFixed(4); 
...
var x = rows1.find('select[name^="item_code[]"]'),
y = x.clone();
y.attr("id","item_code");
...
var cell3 = row.insertCell(1);
var t3=document.createElement("select");
var x = rows2.find('select[name^="class_ids[]"]') ,
y = x.clone();
y.attr("id","class_ids");
...
var t3=document.createElement("select");
var x = rows2.find('select[name^="item_codes[]"]'),
y = x.clone();
...
var t3=document.createElement("select");
var x = rows2.find('select[name^="color_ids[]"]'),
y = x.clone();
y.attr("id","color_ids");
...
var t3=document.createElement("select");
var x = rows2.find('select[name^="size_ids[]"]')  ,
y = x.clone();
y.attr("id","size_ids");
...
var cell3 = row.insertCell(1);
var t3=document.createElement("select");
var x =rowsx.find('select[name^="class_idss[]"]')  ,
y = x.clone();
...
var cell3 = row.insertCell(2);
var t3=document.createElement("select");
var x = rowsx.find('select[name^="item_codess[]"]') ,
y = x.clone();
