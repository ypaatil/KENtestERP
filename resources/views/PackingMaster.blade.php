...
<form action="{{route('PackingMaster.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
@csrf 
<div class="row">
...
function getFinishingInhouseDetails(vpo_code)
{
      ...
      $.ajax({
        ...
        $.ajax({
        dataType: "json",
        url: "{{ route('Stitching_GetOrderQty1') }}",
        data:{'vpo_code':vpo_code},
        success: function(data){
