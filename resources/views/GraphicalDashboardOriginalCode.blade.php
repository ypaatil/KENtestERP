 ...
 @media (max-width: 600px) 
 {
    ...
    */
    ...
    iframe {
        ...
        width: 100%; /* Adjust width to compensate for scaling */
    ...
    <div class="col-12">
        ...
        <div class="tab-container">
            <div class="tab-buttons">
                <div class="tab-button active" data-tab="tab1">MTD Booking Status</div> 
                <div class="tab-button" data-tab="tab2">Monthly Sales Summary</div>
                <div class="tab-button" data-tab="tab3">Sales(FOB + JOB WORK)</div>
                <div class="tab-button" data-tab="tab4">WIP</div>
                <div class="tab-button hide" data-tab="tab5">WIP - Buyer Brand With Vendor</div>
                <div class="tab-button" data-tab="tab6">All Production(FOB + Job Work + Stock)</div>
                <div class="tab-button" data-tab="tab12">Monthwise Production</div>
                <div class="tab-button" data-tab="tab11">Operation Status</div>
                <div class="tab-button" data-tab="tab7">Buyer Costing</div>
                <div class="tab-button" data-tab="tab8">Open Order Report</div>
                <div class="tab-button" data-tab="tab9">Inventory Report</div>
                <div class="tab-button" data-tab="tab10">Sampling Status</div>
                <div class="tab-button" data-tab="tab13">FG Stock Details</div>
                <div class="tab-button" data-tab="tab14">Buyer-wise Inventory</div>
            </div>
            <div id="tab1" class="tab-content active tab1-active"> 
                <div class="iframe-container">
                    <iframe id="powerBiIframe" src="https://app.powerbi.com/view?r=eyJrIjoiYzJkMDJlYzctM2QwZi00NzA5LTlhZmYtN2FlNTEwZGI5NzhiIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe>  
                </div>
            </div> 
            <div id="tab2" class="tab-content tab2-active">
                <div class="iframe-container">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiZjExMTVjNTMtZDA3Zi00MzQ2LThiZGYtYjg1YThkOTk2YjZlIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
            <div id="tab3" class="tab-content tab3-active">
                <div class="iframe-container">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiYzhlMWM4N2MtNWViYy00ZWI4LTg3ZjYtMTE2Yzg1YThiN2U2IiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
            <div id="tab4" class="tab-content tab4-active">
                <div class="iframe-container">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiMDNhYzVkNGYtOGY2YS00NTAzLTg4ZTItOGUyZTI0MWVlZGIyIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe> 
                </div>
            ...
            <div id="tab5" class="tab-content tab5-active">
                <div class="iframe-container">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiMjFlNzhkYTctMGNkYS00YmJkLTgyNzUtODFkNjQwMWM1MDdmIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
            <div id="tab6" class="tab-content tab6-active">
                <!--<div class="row">  -->
                ...
                <!--                                    <input type="date" class="form-control" name="fromDate" id="ProdFromDate" value="{{date('Y-m-01')}}">-->
                <!--                                 </div>-->
                <!--                               </div>-->
                <!--                               <div class="col-md-4">-->
                <!--                                 <div class="mb-3">-->
                <!--                                    <label for="ProdTDate" class="form-label">To Date</label>-->
                <!--                                    <input type="date" class="form-control" name="toDate" id="ProdTDate" value="{{date('Y-m-d')}}">-->
                <!--                                 </div>-->
                <!--                               </div> -->
                <!--                               <div class="col-sm-4">-->
                <!--                                  <label for="formrow-inputState" class="form-label"></label>-->
                ...
                <!--</div>-->
                <div class="iframe-container">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiY2ZmNTFhZDYtOTY1ZC00OGEzLTg0MjctNTM5NjZiMWE1MzViIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9"  
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
             <div id="tab7" class="tab-content tab7-active">
                <div class="iframe-container">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiMDM2NjI5ZGItNzlmMS00Nzc5LWE4ODQtNDBjNzZiZDAwMWY5IiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
            <div id="tab8" class="tab-content tab8-active">
             <div class="row">
               <div class="col-lg-12">
                 ...
                 <!--       font-size:20px;-->
                 <!--     ">-->
                 <!--       The report is currently under maintenance.-->
                 <!--     </div>-->
                 <!-- </div>-->
                  <div class="card">
            ...
            <div id="tab9" class="tab-content tab9-active">
                 <div class="col-md-12 text-center">    
             ...
             <div id="tab10" class="tab-content tab10-active">
                <div class="iframe-container">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiN2RlNzhiZDAtYjJlMC00OWMzLWI5NDgtYzRjN2Y1NzY2YjE2IiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
             <div id="tab11" class="tab-content tab11-active">
                <div class="iframe-container" style="height: 1800px!important;">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiZDZmZWFlMTktZWZmMy00MTYzLWFjZWEtYjg0ZTZmYjdmNDkwIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
             <div id="tab12" class="tab-content tab12-active">
                <div class="iframe-container" style="height: 1800px!important;">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiYzUxNDlmMTYtMjQyZi00MTUzLWIxM2YtMjA3ZjViNTc4NjAyIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
             <div id="tab13" class="tab-content tab13-active">
                <div class="iframe-container" style="height: 1800px!important;">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiNzg2NGRlM2QtMzdiYi00ZTVhLTg4M2EtZTM3NzlhMmE2OWFlIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" 
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
             <div id="tab14" class="tab-content tab14-active">
                <div class="iframe-container" style="height: 1000px!important;">
                    <iframe src="https://app.powerbi.com/view?r=eyJrIjoiMDAxYmZlM2MtODczNC00NTAzLTk3MGYtN2EyMTMzMjBlYTAxIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9"  
                        allowFullScreen="true"></iframe> 
                </div>
            </div>
        </div>
