            ...
            <main>
               ...
               <div id="printInvoice">
                  <div class="row" style="border: #000000 solid 1px;">
                     ...
                     <div  class="col-md-4">
                        <b style="display: inline-block;text-align: left;" class="mt-1">Style Description:</b>  <span style="display: inline-block;text-align: right;">{{  $SalesOrderCostingMaster[0]->style_description }}</span></br>
                        <b style="display: inline-block;text-align: left;" class="mt-1">SAM:</b>  <span style="display: inline-block;text-align: right;">{{  $SalesOrderCostingMaster[0]->sam }}</span></br>     
                        ...
                        <b style="display: inline-block;text-align: left;" class="mt-1">Order Rate:</b>    <span style="display: inline-block;text-align: right;">{{ number_format($SalesOrderCostingMaster[0]->order_rate,2) }} </span></br>
                     </div>
                     <div  class="col-md-4" >
                  ...
                  <table class="table table-bordered text-1 table-sm" style="height:10vh; ">
                     ...
                     <tfoot>
                        <tr  style="background-color:#eee; text-align:center; border: 1px solid;">
                           ...
                           <td style="text-align:right;">{{ number_format($sztotal)  }}</td>
                           @endforeach
                           <th style="text-align:right;">{{number_format($totalQty)  }}</th>
                           <th></th>
                           <th></th>
                        </tr>
                     </tfoot>
