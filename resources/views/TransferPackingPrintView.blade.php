...
<head>
    ...
    <title>Transfer Packing | Ken Global Designs Pvt. Ltd. </title>
    <!-- Web Fonts -->
        ...
        <div class="invoice">
            <main>
                <div id="printInvoice" class="outer-border">
                    ...
                    <h4 class=" fw-bold mt-6 text-center">Transfer Packing</h4>

                    <!-- Sales Info -->
                    <div class="row  border-top border-bottom  g-0">
                        <div class="col-md-6 p-2 border-end">
                            <div class="info-row">
                                <div class="label">TPKI Code</div>
                                <div class="colon">:</div>
                                <div class="value">{{ $TransferPackingInhouseMaster[0]->tpki_code }}</div>
                            </div>
                            <div class="info-row">
                                <div class="label">TPKI Date</div>
                                <div class="colon">: </div>
                                <div class="value"> {{ \Carbon\Carbon::parse($TransferPackingInhouseMaster[0]->tpki_date)->format('d-m-Y') }} </div>
                            </div>
                            <div class="info-row">
                                <div class="label">Sales Order no</div>
                                <div class="colon">:</div>
                                <div class="value"> {{ $TransferPackingInhouseMaster[0]->sales_order_no }} </div>
                            </div>
                        </div>
                        <div class="col-md-6 p-2 ">
                            <div class="info-row">
                                ...
                                <div class="colon">:</div>
                                <div class="value">{{ $TransferPackingInhouseMaster[0]->Ac_name }}</div>
                            </div>
                            <div class="info-row">
                                <div class="label">Address</div>
                                <div class="colon">:</div>
                                <div class="value">{{ $TransferPackingInhouseMaster[0]->address }} </div>
                            </div>
                            <div class="info-row">
                                <div class="label">GST NO</div>
                                <div class="colon">:</div>
                                <div class="value">{{ $TransferPackingInhouseMaster[0]->gst_no }}</div>
                            </div>
                            <div class="info-row">
                                <div class="label">PAN NO</div>
                                <div class="colon">:</div>
                                <div class="value">{{ $TransferPackingInhouseMaster[0]->pan_no }}</div>
                            </div>
                        </div>
                    </div>


                    <h4 class="text-center mt-6 fw-bold">Transfer Packing Details</h4>
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-start">{{$row->sales_order_no}}</td>
