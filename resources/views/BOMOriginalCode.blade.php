...
<div class="col-md-2">
    <div class="mb-3">
       ...
       <select name="sales_order_no" class="form-control select2" id="sales_order_no" required  onChange="popup();getSalesOrderDetails(this.value);">
...
<td> <select name="color_ids[][]"   id="color_ids" style="width:300px; height:140px;" required multiple>
<option value="">--Color List--</option>
</select>
<input type="hidden" name="color_arrays[]" value="0" id="color_arrays" style="width:80px; height:30px;" required />
</td>
<td> <select name="size_ids[][]"   id="size_ids" style="width:200px; height:140px;" required multiple> 
<option value="">--Size List--</option>
</select>
...
<td> <select name="color_idss[][]"   id="color_idss" style="width:300px; height:140px;" required multiple>
<option value="">--Color List--</option>
                                          ...
                                          <div class="table-responsive">
                                             <table id="footable_1" class="table  table-bordered table-striped m-b-0  footable_1">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                      <td><input type="text" name="id" value="@php echo $no; @endphp" id="id" style="width:50px;"/>
                                                         <input type="hidden" name="sr_no_bom[]" value="@php echo $no; @endphp" id="sr_no_bom" style="width:50px;"/>
                                                      </td>
                                                      <td>
                                                         <select name="item_code[]"   id="item_code" style="width:270px; height:30px;" required @php if($List->item_count>0){ echo 'disabled'; } @endphp >
                                                         <option value="">--Item List--</option>
                                                   ...
                                                   <tr>
                                                      <td><input type="text" name="id" value="1" id="id" style="width:50px;"/></td>
                                                      <td>
                                                         <select name="item_code[]"   id="item_code" style="width:270px; height:30px;" required>
                                                            <option value="">--Item List--</option>
                                                            @foreach($ItemList1 as  $row)
                                                            {
                                                            <option value="{{ $row->item_code }}"
                                             ...
                                             <table id="footable_5" class="table  table-bordered table-striped m-b-0  footable_5">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <select name="item_codesx[]" class="item_trim_fabric select2" id="item_codesx" style="width:270px; height:30px;"   @php if($List->item_count>0){ echo 'disabled'; } @endphp>
                                                         <option value="">--Item List--</option>
                                                         @foreach($ItemList4 as  $row)
                                                         {
                                                         <option value="{{ $row->item_code }}"
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <select name="item_codesx[]" class="item_trim_fabric select2" id="item_codesx" style="width:270px; height:30px;"  >
                                                            <option value="">--Item List--</option>
                                                            @foreach($ItemList4 as  $row)
                                                            {
                                                            <option value="{{ $row->item_code }}"
                                                      ...
                                                      <td>
                                                         <select name="unit_idsx[]" class=" " id="unit_idsx" style="width:100px; height:30px;"   >
                                                            <option value="">--Unit List--</option>
                                                            @foreach($UnitList as  $row)
                                                            {
                                                            <option value="{{ $row->unit_id }}">{{ $row->unit_name }}</option>
                                             ...
                                             <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <select name="item_codes[]" class="select2" id="item_codes" style="width:270px; height:30px;" required @php if($List->item_count>0){ echo 'disabled'; } @endphp>
                                                         <option value="">--Item List--</option>
                                                         @foreach($ItemList2 as  $row)
                                                         {
                                                         <option value="{{ $row->item_code }}"
                                                      ...
                                                      <td>
                                                         <select name="unit_ids[]" class=" " id="unit_ids" style="width:100px; height:30px;" required disabled>
                                                            <option value="">--Unit List--</option>
                                                            @foreach($UnitList as  $row)
                                                            {
                                                            <option value="{{ $row->unit_id }}"
                                                      ...
                                                      <td><input type="number" step="any" name="wastages[]" value="{{$List->wastage}}" id="wastages" style="width:80px; height:30px;" required  @php if($List->item_count>0){ echo 'readOnly'; } @endphp/></td>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <select name="item_codes[]" class="item_sewing_trims class="select2"" id="item_codes" style="width:270px; height:30px;" required>
                                                         <option value="">--Item List--</option>
                                                         @foreach($ItemList2 as  $row)
                                                         {
                                                         <option value="{{ $row->item_code }}">({{$row->item_code}}) {{ $row->item_name }}</option>
                                          ...
                                          <div class="table-responsive">
                                             <table id="footable_4" class="table  table-bordered table-striped m-b-0  footable_4">
                                                ...
                                                <tbody>
                                                   ...
                                                   @endphp
                                                   <tr>
                                                      <td><input type="text" name="idss" value="{{ $no }}" id="id" style="width:50px;"/>
                                                      ...
                                                      <td>
                                                         <select name="item_codess[]" class="item_packing_trims id select2" id="item_codess" style="width:270px; height:30px;" required @php if($List->item_count>0){ echo 'disabled'; } @endphp>
                                                         <option value="">--Item List--</option>
                                                         @foreach($ItemList3 as  $row)
                                                         {
                                                         <option value="{{ $row->item_code }}"
                                                      ...
                                                      <td>
                                                         <input type="text"    name="descriptionss[]" value="{{$List->description}}" id="descriptionss" style="width:200px; height:30px;" readOnly required />
                                                      </td>
                                                      <td>
                                                      ...
                                                      <td>
                                                         <select name="unit_idss[]"  id="unit_idss" style="width:100px; height:30px;" required disabled>
                                                            <option value="">--Unit List--</option>
                                                            @foreach($UnitList as  $row)
                                                            {
                                                            <option value="{{ $row->unit_id }}"
                                                      ...
                                                      <td><input type="number" step="any"  min="0" max="{{$maxPackingValue}}" name="wastagess[]" value="{{$List->wastage}}" id="wastagess" style="width:80px; height:30px;" required /></td>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <select name="item_codess[]" class="item_packing_trims select2" id="item_codess" style="width:270px; height:30px;" required>
                                                            <option value="">--Item List--</option>
                                                            @foreach($ItemList3 as  $row)
                                                            {
                                                            <option value="{{ $row->item_code }}">({{$row->item_code}}) {{ $row->item_name }}</option>
...
<script>
   ...
   $(document).ready(function() {
      ...
      // Step 1: Open the collapse
        ...
        //             const restoredValues = currentField.val() || [];
        //             if (JSON.stringify(originalValues) !== JSON.stringify(restoredValues)) {
        //                 // Row highlight in RED
        //                 currentField.closest("tr").css("background-color", "red");
        //             } else {
        //                 // Reset background if same
        //                 currentField.closest("tr").css("background-color", "");
        //             }
        
        //             // ✅ Keep your calculation untouched
        //             CalculateQtyRowProsVerify2(currentField.closest("tr"));
    ...
    // function CalculateQtyRowProsVerify2(row) 
    // {   
    //     var item_code = +row.find('select[name^="item_codes[]"]').val();
    //     var color_id = row.find('select[name^="color_ids[][]"]').val().join(",");
    //     var size_id  = row.find('select[name^="size_ids[][]"]').val().join(","); 
    ...
    //         },
    //         success: function(data) { 
    //             // Set BOM expected qty
    //             row.find('input[name^="bom_qtys_expect[]"]').val(data[0]['bom_qty']); 
                
    //             // Get values
    //             var bom_qty1 = row.find('input[name^="bom_qtys_expect[]"]').val(); 
    //             var bom_qty2 = row.find('input[name^="bom_qtys1[]"]').val(); 
            
    //             // Convert to numbers for comparison
    //             bom_qty1 = parseFloat(bom_qty1) || 0;
    //             bom_qty2 = parseFloat(bom_qty2) || 0;
            
    //             if (bom_qty1 !== bom_qty2) {
    //                 row.css('background', 'red');  
    //             } else {
    //                 row.css('background', ''); // reset background if they match
    //             }
    //         }
