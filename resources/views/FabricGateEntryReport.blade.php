      ...
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         ...
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               ...
               <li class="breadcrumb-item active">Fabric Gate Entry Report</li>
            </ol>
         </div>
      </div>
   </div>
            ...
            <table id="dt" class="table table-bordered dt-responsive nowrap w-100 ">
               <thead>
                  <tr style="text-align:center;">
                     <th nowrap>FGE Code<span class="filter-icon">🔽</span><div class="filter-menu fge-code"></div></th>
                     ...
                     <th nowrap>Location/Warehouse<span class="filter-icon">🔽</span><div class="filter-menu location-warehouse"></div></th>
                     ...
                     <th nowrap>No.of Roll<span class="filter-icon hide">🔽</span><div class="filter-menu no-of-roll"></div></th>
                     <th nowrap>Challan Qty<span class="filter-icon hide">🔽</span><div class="filter-menu challan-qty"></div></th>
                     <th nowrap>Rate<span class="filter-icon hide">🔽</span><div class="filter-menu rate"></div></th>
                     <th nowrap>Amount<span class="filter-icon hide">🔽</span><div class="filter-menu amount"></div></th>
   ...
   function FilterReport()
   {
        ...
        var table = $('#dt').DataTable({
         ...
         initComplete: function () {
               buildAllMenusFabricGateEntryReport();
            },
         ...
         columns: [
           ...
           {data: 'total_roll', name: 'total_roll', className: 'text-right' , render: data => formatIndianNumber(data)   },
           {data: 'challan_qty', name: 'challan_qty', className: 'text-right'  , render: data => formatIndianNumber(data)},
           {data: 'rate', name: 'rate', className: 'text-right'  , render: data => formatIndianNumber(data) },
           {data: 'amount', name: 'amount', className: 'text-right'  , render: data => formatIndianNumber(data)  },
         ...
         if (menu.hasClass('fge-code')) applySimpleFilter(0, menu);
         ...
         else if (menu.hasClass('location-warehouse')) applySimpleFilter(10, menu);
         ...
         else if (menu.hasClass('no-of-roll')) applySimpleFilter(17, menu);
