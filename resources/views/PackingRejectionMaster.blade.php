...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Packing Rejection Master</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            <form action="{{route('PackingRejection.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="qcp_date" class="form-label">Entry Date</label>
                        <input type="date" name="qcp_date" class="form-control" id="qcp_date" value="{{date('Y-m-d')}}" required  >
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="vpo_code" class="form-control select2" id="vpo_code" required  onChange="getPackingOrderDetails(this.value);">
                  ...
                  <div class="panel panel-default">
                     <div class="panel-heading">
                        <h4 class="panel-title">
                           <a data-toggle="collapse" data-parent="#accordion1" href="#collapse2">Packing Entry</a>
                        </h4>
                     </div>
