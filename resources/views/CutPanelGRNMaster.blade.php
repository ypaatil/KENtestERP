...
<form action="{{route('CutPanelGRN.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
@csrf 
<div class="row">
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="cpg_date" class="form-control" id="cpg_date" value="{{date('Y-m-d')}}" required  >
...
<input type="text" name="vendor_rate" class="form-control" id="vendor_rate" value="" readOnly>
</div>
</div>
...
@foreach($cuttingList as  $cutting)
    <option value="{{ $cutting->cu_code }}">{{ $cutting->cu_code }}</option>
@endforeach
</select>
</div>
</div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Cut Panel GRN  Entry</a>
        </h4>
      </div>
...
<input type="number" step="any" name="cons" class="form-control" id="cons" value="0.00" onkeyup="CalFabricUsed();">
</div>
</div>
...
<input type="number" step="any" name="fabric_used" class="form-control" id="fabric_used" value="0" readOnly>
</div>
</div> 
