...
<form action="{{route('BundleBarcode.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
@csrf 
<div class="row">
...
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-inputState" class="form-label">Task Id</label>
<select name="task_id" class="form-select select2" id="task_id"  onchange="getCheckMasterData(this.value)">
...
<input type="text" name="vpo_code" class="form-control" id="vpo_code" value="">
...
<input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="">
...
<button type="submit" class="btn btn-primary w-md" onclick="setFinalSizeArray(); EnableFields();" id="Submit">Submit</button>
