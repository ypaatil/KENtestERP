...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            <form action="{{route('CutPanelIssue.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="vpo_date" class="form-label">Entry Date</label>
                        <input type="date" name="cpi_date" class="form-control" id="cpi_date" value="{{date('Y-m-d')}}" required  >
                  ...
                  <!--<input type="hidden" name="vendor_rate" class="form-control" id="vendor_rate" value="" required readOnly>-->
                  <!--</div>-->
                  <!--</div>-->
                  <div class="col-md-4">
                     <div class="mb-3">
                  ...
                  <div class="panel panel-default">
                     <div class="panel-heading">
                        <h4 class="panel-title">
                           <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Cut Panel GRN Against Sales Order</a>
                        </h4>
                     </div>
   ...
   <input type="hidden" name="vendor_amount" class="form-control" id="vendor_amount" value="0">
   <!--<div class="col-md-2">-->
   <!--<div class="mb-3">-->
...
<script>
   ...
   var no=1;
    ...
    var size_array = sizes.split(',');
      ...
      $("#footable_2 tr td input[class='size_id']").each(function() 
      {
        ...
        var workOrderQty = parseFloat($(this).attr('workOrderQty')) || 0;
        ...
        if (total > maxNumber || total > workOrderQty) 
        { 
            let exceededValue = total > maxNumber ? maxNumber : workOrderQty;
          
            console.log(exceededValue);
            Swal.fire({
                title: 'Warning!',
                text: `The number ${total} exceeds the maximum allowed value of ${exceededValue}.`,
                icon: 'warning',
            ...
            $(this).val(0);
            $(this).closest('tr').find('td input[name="size_qty_total[]"]').val(total-number);
            mycalc();
        } 
   ...
   function getVendorWorkOrderDetails(vw_code)
   {
      ...
      $.ajax({
         ...
         $.ajax({
        dataType: "json",
        url: "{{ route('GetCUTGRNQty') }}",
        data:{'tr_code':data[0]['sales_order_no'],'vw_code':vw_code},
        success: function(data){
