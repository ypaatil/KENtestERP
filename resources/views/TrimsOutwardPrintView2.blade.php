                        ...
                        <div class="col-md-6 p-3 border-end">
                            <div class="">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="colon">:</div>
                                    <div class="value"> {{ isset($TrimsOutwardMaster[0]->trimOutCode) ? $TrimsOutwardMaster[0]->trimOutCode :"" }}</div>

                                </div>
                                <div class="info-row">
                                    <div class="label">Delivery Challan Date</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ isset($TrimsOutwardMaster[0]->tout_date) ? $TrimsOutwardMaster[0]->tout_date :"" }} </div>
                                </div>
                                <div class="info-row">
                                    <div class="label">Sales Order no</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ isset($SalesOrder[0]->sales_order_no) ? $SalesOrder[0]->sales_order_no :"" }} </div>
                                </div>
                                <div class="info-row">
