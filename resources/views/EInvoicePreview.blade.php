...
<html lang="en">
   ...
   <body class="bg-gray-100">
      <div class="a4 text-gray-900" style="width: 250mm;">
         <p class="font-bold text-center text-2xl" style="margin-top: -32px;">Preview - TAX INVOICE</p>
         ...
         <div class="row" style="margin-bottom: 10px;">
            ...
            <div class="col-md-9" style="padding-top: 100px;">
               <div class="col-md-12"><label>IRN :&nbsp;&nbsp;</label><b>-</b></div>
               <div class="col-md-12"><label>Ack No. :&nbsp;&nbsp;</label><b>-</b></div>
               <div class="col-md-12"><label>Ack Date :&nbsp;&nbsp;</label><b>-</b></div>
            </div>
            <!--<div class="col-md-3">-->
         ...
         <table class="text-xs mb-15 border " style="width: -webkit-fill-available;">
            <tr>
               <td class="align-top border  px-2 py-1 w-[300px]">
               ...
               <td class="align-top border  px-2 py-1 w-1/3" style="width: 209px;">
                  <div class="col-md-12">
                     <div class="row">
                        <div class="col-md-5">
         ...
         <!-- Item Details Table -->
         <table class="w-full text-xs border  mb-0">
            ...
            <tbody>
               ...
               <tr class="align-top text-center">
                      ...
                      <td class="border border-black text-center" style="width: 6.1%;">{{$unitname}}</td>
               ...
               <tr class="font-bold">
                  <td></td>
                  <td colspan="" class="text-right border-black border  pr-2">Total</td>
                  <td></td>
         ...
         @php
            ...
            @endphp
         <!-- Amount in Words -->
         <div class="border  border-t-0 px-2 py-1 font-semibold">
         ...
         <!-- GST Summary Table -->
         <table class="text-xs border  mb-0" style="width: -webkit-fill-available;">
            <thead class="bg-gray-100 text-center font-bold">
               <tr>
         ...
         <div class="declare" style="border: 1px solid;padding: 5px;">
            <div class="row">
               <p><strong>Tax Amount (in words):</strong> INR {{ convertToIndianCurrency($total_tax_amt1) }}</p>
      ...
      <div class="a4 text-gray-900" style="width: 250mm;">
         ...
         <div class="row">
            <div class="col-md-4">
               <label>e-Way Bill No. :&nbsp;&nbsp;</label><b>-</b><br/>
            ...
            <div class="col-md-4">
               <label>Generated Date:&nbsp;&nbsp;</label><b>-</b><br/>
               <label>Valid Upto:&nbsp;&nbsp;</label><b>-</b> <br/>
            </div>
         </div>
         <br/> 
         <hr/>
