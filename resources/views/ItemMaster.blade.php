...
<select name="cat_id" class="form-select select2" id="cat_id" onchange="getClassList(this.value);" required>
...
<select name="material_type_id" class="form-select select2" id="material_type_id" required>
...
<select name="quality_code" class="form-select select2" id="quality_code" required>
...
<div class="col-md-4">
<div class="mb-3">
<label for="item_description" class="form-label">Description/Count Construction</label>
<input type="text" name="item_description" class="form-control" id="item_description" value="{{ $items->item_description }}"  oninput="restrictQuotes(this)" required>
</div>
</div>
</div>
...
<input type="text" name="color_name" class="form-control" id="color_name" value="{{ $items->color_name }}" required>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
...
<input type="text" name="moq" class="form-control" id="moq" value="{{ $items->moq }}" required>
</div>
</div>
...
<input type="text" name="item_rate" class="form-control" id="formrow-email-input" value="{{ $items->item_rate }}" required>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Item MRP</label> 
<input type="text" name="item_mrp" class="form-control" id="formrow-email-input" value="{{ $items->item_mrp }}" required>
</div>
</div>
...
<input type="text" name="cgst_per" class="form-control" id="cgst_per" value="{{ $items->cgst_per }}" onkeyup="change(this.value);" required>
</div>
</div>
...
<input type="text" name="sgst_per" class="form-control" id="sgst_per" value="{{ $items->sgst_per }}" required>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="igst_per" class="form-label">IGST %</label>
<input type="text" name="igst_per" class="form-control" id="igst_per" value="{{ $items->igst_per }}" required>
</div>
</div>
...
<input type="text" name="hsn_code" class="form-control" id="hsn_code" value="{{ $items->hsn_code }}" required>
</div>
</div>
...
<input type="text" name="pur_rate" class="form-control" id=">" value="{{ $items->pur_rate }}" required >
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Sale Rate</label>
<input type="text" name="sale_rate" class="form-control" id="formrow-email-input" value="{{ $items->sale_rate }}" required >
</div>
</div>
...
<input type="text" name="item_description" class="form-control" id="formrow-email-input"  oninput="restrictQuotes(this)" required>
</div>
</div>
</div>
...
<input type="text" name="color_name" class="form-control" id="formrow-email-input" value=""  oninput="restrictQuotes(this)" required>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Width/Dimentions</label>
<input type="text" name="dimension" class="form-control" id="formrow-email-input" value="" required>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
...
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Item Rate</label>
<input type="text" name="item_rate" class="form-control" id="formrow-email-input" required>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Item MRP</label>
<input type="text" name="item_mrp" class="form-control" id="formrow-email-input" required>
</div>
</div>
...
<div class="mb-3">
<label for="cgst_per" class="form-label">CGST %</label>
<input type="text" name="cgst_per" class="form-control" id="cgst_per" onkeyup="change(this.value)" required>
</div>
</div>
...
<div class="mb-3">
<label for="sgst_per" class="form-label">SGST %</label>
<input type="text" name="sgst_per" class="form-control" id="sgst_per" required>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="igst_per" class="form-label">IGST %</label>
<input type="text" name="igst_per" class="form-control" id="igst_per" required>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
...
<div class="mb-3">
<label for="pur_rate" class="form-label">Purchase Rate</label>
<input type="text" name="pur_rate" class="form-control" id="pur_rate" required>
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="sale_rate" class="form-label">Sale Rate</label>
<input type="text" name="sale_rate" class="form-control" id="sale_rate" required>
</div>
</div>
