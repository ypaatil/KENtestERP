   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            <form action="{{route('VendorWorkOrder.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="soc_date" class="form-label">Entry Date</label>
                        <input type="date" name="vw_date" class="form-control" id="vw_date" value="{{date('Y-m-d')}}" required readOnly>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="sales_order_no" class="form-control select2" id="sales_order_no" required  onChange="checkCostingStatus(this.value); ">
               ...
               <div class="row">
                  <div class="col-sm-2">
                     ...
                     <div class="mb-3">
                        <input type="number" required step="0.01" name="vendorRate" class="form-control" id="vendorRate"  value="0"  />
                     </div>
                  </div>
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-2">
                     ...
                     <div class="mb-3">
                        <input type="number" step="any" name="cons_per_piece" class="form-control" id="cons_per_piece"  value=""  />
                     </div>
                  </div>
                  <div class="col-sm-6">
...
<script>
  ...
  $(document).on("change", 'input[class^="size_id"],input[name^="vendorRate"],input[class^="WASTAGE"],input[class^="WASTAGE1"],input[class^="WASTAGE2"],input[class^="WASTAGE3"]', function (event) 
  {
      ...
      if ((value !== '') && (value.indexOf('.') === -1)) {
        ...
        var sum = 0;
        $.each(allTotalArray, function(index, value) {
  ...
  function MainBtn()
  {
    ...
    //   });
      ...
      $.ajax({
      dataType: "json",
      url: "{{ route('GetWorkOrderSewingCreateConsumption') }}",
