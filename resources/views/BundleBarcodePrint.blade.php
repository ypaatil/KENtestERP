   ...
   <body id='printMe'>
      ...
      <div class="row" style="padding-left: 10%;margin-top: 5%;">
         ...
         <div class="column" style="border-style: solid;  border-width: 1px; height:200px; width:270px; ">
            <h3>LNo: {{ $List->size_serial_no }}</h3>
            <span style="padding:10px;;" class="col-md-6 dot"></span>
