   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form action="{{ route('TransferPackingInhouse.update',$TransferPackingInhouseMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="main_sales_order_no" class="form-control select2" id="main_sales_order_no" onChange="getPackingInhouseDetails(this.value);"  disabled>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$TransferPackingInhouseMasterList->style_no}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$TransferPackingInhouseMasterList->style_description}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="order_rate" class="form-label">Order Rate</label>
                        <input type="text" name="order_rate" class="form-control" id="order_rate" value="{{$TransferPackingInhouseMasterList->order_rate}}" readOnly>
                     </div>
                  </div>
               </div>
                                          ...
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody id="CartonData">
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <select name="sales_order_nos[]"   id="sales_order_nos" style="width:150px; height:30px;" disabled  onchange="checkDifferentSizeGroup(this);">
                                                   ...
                                                   @php  
                                                        $packingData = DB::SELECT("SELECT ((SELECT SUM(size_qty_total) FROM packing_inhouse_detail 
                                                                        WHERE sales_order_no = '".$TransferPackingInhouseMasterList->sales_order_no."' AND color_id = ".$List->color_id.") 
                                                                        - (SELECT SUM(size_qty_total) FROM transfer_packing_inhouse_detail WHERE sales_order_no = '".$TransferPackingInhouseMasterList->sales_order_no."' AND color_id = ".$List->color_id.")) as size_qty_total");
                                                        
                                                        $packing_qty = isset($packingData[0]->size_qty_total) ? $packingData[0]->size_qty_total : 0;

                                                   @endphp
                                                   <td ><input style="width:80px; float:left;" min="{{ max($szQty - $packing_qty, 0) }}"  max="{{$szQty}}"  onchange="validateSize(this);" name="s@php echo $n; @endphp[]" class="size_id" type="number" id="s@php echo $n; @endphp" value="{{$szQty}}" required />  </td>
                                                   @php $n=$n+1;  @endphp
                                                   @endforeach
