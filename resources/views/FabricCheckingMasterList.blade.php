...
<div class="row">
   ...
   <div class="col-lg-4 text-center">
      <h4><b>Note : </b> Showing last 3 month records. If you want to all click on <a href="FabricCheckingShowAll">Show All Data</a> button</h4>
   </div>
   <div class="col-lg-4 text-right">
      <a href="FabricCheckingShowAll"><button type="button" class="btn btn-warning w-md float-right">Show All Data</button></a> &nbsp; &nbsp; &nbsp;
      <a href="FabricCheckingShowAll"><button type="button" class="btn btn-danger w-md float-right">Back</button></a> &nbsp; &nbsp; &nbsp;
   </div>
</div>
@endif
         ...
         <div class="card-body">
            <table  data-order='[[ 0, "desc" ]]' data-page-length='25' id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
               ...
               <tbody>
                  ...
                  @php
                    $grnSummaryData = DB::SELECT("SELECT count(chk_code) as count FROM fabric_summary_grn_master WHERE chk_code='".$row->chk_code."'");
                  ...
                  <tr>
                     ...
                     <td class="text-center">{{ $grn_status }}</td>
