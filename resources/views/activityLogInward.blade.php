...
<table class="table table-bordered" id="activityLogTableDetailFI">
   ...
   @include('partials.change_rows_inward_new')
...
<table class="table table-bordered" id="activityLogTableDetailFO">
   ...
   <div class="table-responsive">         
<table class="table table-bordered" id="activityLogTableDetailTI">

   @include('partials.change_row_trim_inward')
</table>
</div>
   ...
   <div class="table-responsive">         
<table class="table table-bordered" id="activityLogTableDetailTO">
...
$(document).on('click', '#activityLogTableDetailFO .pagination a', function(e) {
    e.preventDefault();
    console.log('Pagination clicked'); // ✅ Add this
    var pageUrl = $(this).attr('href');
    ...
    $.ajax({
        ...
        type: 'GET',
        success: function(data) {
            $('#activityLogTableDetailFO').html(data);
        },
        error: function() {
            alert('Failed to load activity log data.');
        }
...
$(document).on('click', '#activityLogTableDetailTI .pagination a', function(e) {
    e.preventDefault();
    console.log('Pagination clicked'); // ✅ Add this
    var pageUrl = $(this).attr('href');
    ...
    $.ajax({
        ...
        type: 'GET',
        success: function(data) {
            $('#activityLogTableDetailTI').html(data);
        },
        error: function() {
            alert('Failed to load activity log data.');
        }
...
$(document).on('click', '#activityLogTableDetailTO .pagination a', function(e) {
    e.preventDefault();
    console.log('Pagination clicked'); // ✅ Add this
    var pageUrl = $(this).attr('href');
    ...
    $.ajax({
        ...
        type: 'GET',
        success: function(data) {
            $('#activityLogTableDetailTO').html(data);
        },
        error: function() {
            alert('Failed to load activity log data.');
        }
