...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">FG Transfer To Location Master Edit</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            @if(isset($FGTransferToLocationMasterList))
            <form action="{{ route('FGTransferToLocation.update',$FGTransferToLocationMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="date" name="fgt_date" class="form-control" id="fgt_date" value="{{$FGTransferToLocationMasterList->fgt_date}}" required>
                        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $FGTransferToLocationMasterList->c_code }}">
                        <input type="hidden" name="endflag" class="form-control" id="endflag" value="{{ $FGTransferToLocationMasterList->endflag }}">
                        <input type="hidden" name="fgt_code" class="form-control" id="fgt_code" value="{{$FGTransferToLocationMasterList->fgt_code}}" readOnly>
                  ...
                  <div class="col-md-1 hide">
                     <div class="mb-3">
                        ...
                        <select name="firm_id" class="form-control" id="firm_id">
                           ...
                           {{ $row->firm_id == $FGTransferToLocationMasterList->firm_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-3">
                     <div class="mb-3">
                        ...
                        <select name="Ac_code" class="form-control" id="Ac_code" required  disabled>
                           ...
                           {{ $row->ac_code == $FGTransferToLocationMasterList->Ac_code ? 'selected="selected"' : '' }} 
                           >{{ $row->ac_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-1">
                     <div class="mt-5"> 
                        <input type="checkbox" name="isRTV" id="isRTV" style="font-size:15px;" {{ $FGTransferToLocationMasterList->isRTV == 1 ? 'checked="checked"' : '' }}  />
                  ...
                  <div class="col-md-4">
                     <div class="mb-5">
                        ...
                        <select name="sales_order_no[]" class="form-control select2" id="sales_order_no" required onChange="checkDifferentSizeGroup(this);"  multiple style="width:100%;height:50%;">
                           ...
                           @php $sales_orders = explode(',', $FGTransferToLocationMasterList->sales_order_no);   @endphp
                  ...
                  <input type="hidden" name="mainstyle_id" class="form-control" id="mainstyle_id" value="{{$FGTransferToLocationMasterList->mainstyle_id}}">
                  <input type="hidden" name="substyle_id" class="form-control" id="substyle_id" value="{{$FGTransferToLocationMasterList->substyle_id}}"> 
                  <div class="col-md-2 hide">
                     <div class="mb-3">
                        ...
                        <select name="fg_id" class="form-control" id="fg_id">
                           ...
                           {{ $row->fg_id == $FGTransferToLocationMasterList->fg_id ? 'selected="selected"' : '' }} 
                           >{{ $row->fg_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2 hide">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$FGTransferToLocationMasterList->style_no}}">
                     </div>
                  </div>
                  <div class="col-md-4 hide">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$FGTransferToLocationMasterList->style_description}}">
                     </div>
                  </div>
                  <div class="col-md-2 hide">
                     <div class="mb-3">
                        <label for="order_rate" class="form-label">Order Rate</label>
                        <input type="text" name="order_rate" class="form-control" id="order_rate" value="{{$FGTransferToLocationMasterList->order_rate}}">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="mb-3">
                        ...
                        <select name="buyer_location_id" class="form-control" id="buyer_location_id" required   >
                           ...
                           {{ $row->sr_no == $FGTransferToLocationMasterList->buyer_location_id ? 'selected="selected"' : '' }} 
               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$FGTransferToLocationMasterList->total_qty}}" readOnly>
                     </div>
                  </div> 
                   <input type="hidden" name="order_amount" class="form-control" id="order_amount" value="{{$FGTransferToLocationMasterList->order_amount}}" > 
                  <div class="col-sm-8">
                     <label for="formrow-inputState" class="form-label">Narration</label>
                     <div class="mb-3">
                        <input type="text" name="narration" class="form-control" id="narration"  value="{{$FGTransferToLocationMasterList->narration}}" />
                     </div>
                  </div>
               </div>
               <div class="col-sm-6">
