					...
					<div class="app-sidebar3">
						...
						<div class="Annoucement_card">
							<div class="card-header p-0 border-bottom-0">
								<h3 class="card-title text-white font-weight-normal">Recent Report</h3>
								<div class="card-options float-right">
									...
									<ul class="dropdown-menu dropdown-menu-right" role="menu">
										<li><a href="#"><i class="feather feather-eye mr-2"></i>View</a>
										</li>
										<li><a href="#"><i class="feather feather-plus-circle mr-2"></i>Add</a>
										</li>
										<li><a href="#"><i class="feather feather-trash-2 mr-2"></i>Remove</a>
										</li>
										<li><a href="#"><i class="feather feather-download-cloud mr-2"></i>Download</a>
										</li>
										<li><a href="#"><i class="feather feather-settings mr-2"></i>More</a>
										</li>
									</ul>
								</div>
							</div>
							<div class="mt-3">
								<div>
									<div class="chart-wrapper overflow-hidden project-chart">
										<canvas id="sidemenuproject" class="overflow-hidden"></canvas>
									</div>
								</div>
								<div class="text-center text-white">
									<h3 class="mb-0 mt-1 mb-0 fs-20">67% <span class="fs-14 font-weight-normal">Projetcs Complete</span></h3>
								</div>
							</div>
						</div>
					</div>
