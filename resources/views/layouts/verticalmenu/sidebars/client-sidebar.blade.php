				...
				<aside class="app-sidebar">
					...
					<div class="app-sidebar3">
						...
						<div class="Annoucement_card">
							<div class="d-flex">
								<div>
									<h4 class="text-white font-weight-normal mb-0">This month</h4>
									<span class="text-white-50">Expenses</span>
								</div>
								<div class="ml-auto">
									...
									<ul class="dropdown-menu dropdown-menu-right border-0" role="menu">
							...
							<div class="text-center">
								<h4 class="text-white text-center">$25,453</h4>
							</div>
						</div>
					</div>
				</aside>
