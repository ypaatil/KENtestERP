...
<div id="printInvoice">
    ...
    <div  class="col-md-4">
      ...
      <b style="display: inline-block;text-align: left;" class="mt-1">GRN No:  </b> <span style="display: inline-block;text-align: right;"> {{ $PackingInhouseMaster[0]->pki_code }} </span></br>     
      <b style="display: inline-block;text-align: left;" class="mt-1">GRN Date:  </b> <span style="display: inline-block;text-align: right;"> {{ $PackingInhouseMaster[0]->pki_date }} </span></br>
      <b style="display: inline-block;text-align: left;" class="mt-1">Sales Order no:  </b> <span style="display: inline-block;text-align: right;"> {{ $PackingInhouseMaster[0]->sales_order_no }} </span></br>
   <b style="display: inline-block;text-align: left;" class="mt-1"> </b> <span style="display: inline-block;text-align: right;"> @if($PackingInhouseMaster[0]->is_opening==1) <b> Opening Stock: </b>Yes @endif </span></br>
@if($PackingInhouseMaster[0]->is_opening!=1)
<b style="display: inline-block;text-align: left;" class="mt-1">Process Order No:  </b> <span style="display: inline-block;text-align: right;"> {{ $PackingInhouseMaster[0]->vpo_code }} </span></br>  
@endif
</div> <div  class="col-md-3" >
   
        </div>
    <div  class="col-md-5">         
    <b style="display: inline-block;text-align: left;" class="mt-1">Vendor: </b>  <span style="display: inline-block;text-align: right;">{{  $PackingInhouseMaster[0]->Ac_name }} </span></br>
       <b style="display: inline-block;text-align: left;" class="mt-1">Address:</b>  <span style="display: inline-block;text-align: left;">{{  $PackingInhouseMaster[0]->address }}</span></br>
       <b style="display: inline-block;text-align: left;" class="mt-1">GST No:</b>  <span style="display: inline-block;text-align: right;">{{  $PackingInhouseMaster[0]->gst_no }}</span></br>
       <b style="display: inline-block;text-align: left;" class="mt-1">PAN No:</b>  <span style="display: inline-block;text-align: right;">{{  $PackingInhouseMaster[0]->pan_no }}</span></br>
    </div>
        ...
        @php   $no=1; $totalAmt=0; $totalQty=0;@endphp
         ...
         @if(isset($row->s20))  <td>{{$row->s20}}</td> @endif
          <td>{{$row->size_qty_total}}</td> 
           <td>@if($PackingInhouseMaster[0]->is_opening!=1) {{$PackingInhouseMaster[0]->rate }} @else {{$PackingInhouseMaster[0]->vendor_rate }} @endif</td>
          <td>@if($PackingInhouseMaster[0]->is_opening!=1) {{$row->size_qty_total * $PackingInhouseMaster[0]->rate }} @else {{$row->size_qty_total * $PackingInhouseMaster[0]->vendor_rate }} @endif</td>
          </tr>
