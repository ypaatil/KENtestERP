    ...
    <div class="tab-sidebar-wrapper">
        ...
        <div class="tab-sidebar" id="tabScroll">
            ...
            <div class="tab-button active" data-tab="tab1">
                <i class="fa-solid fa-stopwatch"></i> Produced Min
            </div>
        
            <!-- ⚙️ Operation Status -->
            <div class="tab-button" data-tab="tab2">
                <i class="fa-solid fa-gears"></i> Operation Status
            </div>
        </div>
    ...
    <div class="tab-content-area">
        <div id="tab1" class="tab-content active">
            <div class="iframe-container">
                    <iframe id="powerBiIframe" src="https://app.powerbi.com/view?r=eyJrIjoiYWI1YjBiOGEtZWZmMi00YzdmLTk1MGMtMDZlMTc5OTNjNzQ3IiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" allowFullScreen="true"></iframe>  
            </div>
        </div>
        <div id="tab2" class="tab-content">
            <div class="iframe-container">
                 <iframe id="powerBiIframe" src="https://app.powerbi.com/view?r=eyJrIjoiZDZmZWFlMTktZWZmMy00MTYzLWFjZWEtYjg0ZTZmYjdmNDkwIiwidCI6ImVmMGI1ODNjLTViNzMtNDUwMy1iZjVjLTI5MTY2Y2FiOTA1YyJ9" allowFullScreen="true"></iframe>
            </div>
        </div> 
    </div>
</div>
