   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            <form action="{{route('monthly_budget.store')}}" method="POST"  enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                     ...
                     <div class="mb-3">
                        ...
                        <select name="monthId" class="form-control select2" id="monthId" required>
                            ...
                            @foreach($monthlyList as $rowMonth)
                                <option value="{{$rowMonth->monthId}}">{{$rowMonth->MonthName}}</option>
                            @endforeach
                        </select> 
                     </div>
                  </div>
                     ...
                     <div class="table-responsive">
                        <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                           ...
                           <tbody>
                              ...
                              <select name="Ac_code_sale[]" class="form-control" id="Ac_code" required  style="width:250px;" onChange="previousData1(this,this.value);">
                           ...
                           @endforeach
                                 ...
                                 <td><input type="number" step="any" step="any" name="lpc_sale[]" value="0" id="lpc_sale" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="fob_sale[]" value="0" id="fob_sale" readOnly style="width:80px;height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="rs_cr_sale[]" onkeyup="calculateFOB(this,this.value);" value="0" id="rs_cr_sale" style="width:80px;height:30px;"  /></td>
                                  <td><input type="number" step="any" step="any" name="l_min_sale[]" value="0" id="l_min_sale" style="width:80px;height:30px;"  /></td>
                                  <td><input type="number" step="any" step="any" class="FABRIC"   name="cmohp_sale[]" value="0" id="cmohp_sale" style="width:80px;height:30px;"  /></td>
                                 <td><input type="text" step="any" step="any" name="remark_sale[]" value="" id="remark_sale"  /></td>
                        ...
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_lpc_sale"  readOnly id="totalLPC"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_fob_sale"  readOnly id="totalFOB"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_rs_cr_sale"  readOnly id="totalRSCR"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_lmin_sale"  readOnly id="totalLMIN"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_cmohp"  readOnly id="totalCMOHP"></td>
                        <td></td>
                        </tr>
                        </tfoot>
                        </table>
                     ...
                     <div class="table-responsive">
                        <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                              ...
                                              <select name="Ac_code_production" class="form-control select2" id="Ac_code"  style="width:250px;" onChange="previousData2(this,this.value);">
                           <option value="">--Select Buyer--</option>
                           @foreach($Ledger as  $row)
                           {
                           <option value="{{ $row->ac_code }}">{{ $row->ac_name }}</option>
                           ...
                           @endforeach
                                 ...
                                 <td><input type="number" step="any" step="any" name="lpc_production[]" value="0" id="lpc_production" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="fob_production[]" readOnly value="0" id="fob_production" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="rs_cr_production[]" onkeyup="calculateFOBProduction(this,this.value);" value="0" id="wastages" style="width:80px; height:30px;"  /></td>
                                  <td><input type="number" step="any" step="any" name="l_min_production[]" value="0" id="wastages" style="width:80px; height:30px;"  /></td> 
                                 <td><input type="number" step="any" step="any"  class="SEWING"  name="cmohp_production[]" value="0" id="total_amounts" style="width:80px; height:30px;" required /></td>
                               
                                 <td><input type="text" step="any" step="any" name="remark_production[]" value="" id="remark_production"  /></td>
                        ...
                        <tr>
                        <td colspan="2"><strong>Total:</strong></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_lpc_production"  readOnly id="totalLPCPRODUCTION"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_fob_production"  readOnly id="totalFOBPRODUCTION"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_rs_cr_production"  readOnly id="totalRSCRPRODUCTION"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_l_min_production"  readOnly id="totalLMINPRODUCTION"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_cmohp_production"   readOnly id="totalCMOHPPRODUCTION"></td>
                        <td></td>
                        </tr>
                        </tfoot>
                        </table>
                     ...
                     <div class="table-responsive">
                        <table id="footable_4" class="table  table-bordered table-striped m-b-0  footable_4">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                   ...
                                   <select name="Ac_code_purchase_fabric" class="form-control select2" id="Ac_code"  style="width:250px;" onChange="previousData3(this,this.value);">
                           <option value="">--Select Buyer--</option>
                           @foreach($Ledger as  $row)
                           {
                           <option value="{{ $row->ac_code }}">{{ $row->ac_name }}</option>
                           ...
                           @endforeach
                                 ...
                                 <td><input type="number" step="any" step="any" name="l_mtr_purchase_fabric[]" value="0" id="consumptionss" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="rate_purchase_fabric[]" readOnly value="0" id="rate_per_unitss" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="rs_cr_purchase_fabric[]" onkeyup="calculateRatePurchaseFabric(this,this.value);" value="0" id="wastagess" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" class=""  name="days_purchase_fabric[]" value="0" id="total_amountss" style="width:80px; height:30px;"   /></td>
                                 <td><input type="text" step="any" step="any" class=""  name="remark_purchase_fabric[]" value="0" id="remark_purchase_fabric"    /></td>
                              ...
                              <tr>
                        <td colspan="2"><strong>Total:</strong></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_l_mtr_purchase_fabric"  readOnly id="totalLMTRPFABRIC"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_rate_purchase_fabric"   readOnly id="totalRATEPFABRIC"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_rs_cr_purchase_fabric"  readOnly id="totalRSCRPFABRIC"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_days_purchase_fabric"  readOnly id="totalDAYSPFABRIC"></td>
                        <td></td>
                        </tr>
                          </tfoot>
                        </table>
                     ...
                     <div class="table-responsive">
                        <table id="footable_5" class="table  table-bordered table-striped m-b-0  footable_5">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                   ...
                                   <select name="Ac_code_purchase_trims" class="form-control select2" id="Ac_code" required  style="width:250px;" onChange="previousData4(this,this.value);">
                           <option value="">--Select Buyer--</option>
                           @foreach($Ledger as  $row)
                           {
                           <option value="{{ $row->ac_code }}">{{ $row->ac_name }}</option>
                           ...
                           @endforeach
                                 ...
                                 <td><input type="number" step="any" step="any" name="rs_cr_purchase_trims[]" value="0" id="rs_cr_purchase_trims" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="days_purchase_trims[]" value="0" id="days_purchase_trims" style="width:80px; height:30px;"  /></td>
                                 <td><input type="text" step="any" step="any" name="remark_purchase_trims[]" value="0" id="remark_purchase_trims"   /></td>
                              ...
                              <tr>
                        <td colspan="2"><strong>Total:</strong></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_rs_cr_purchase_trims"  readOnly id="totalRSPTRIMS"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_days_purchase_trims"  readOnly id="totalDAYSPTRIMS"></td>
                        <td></td>
                        </tr>
                          </tfoot>
                        </table>
                     ...
                     <div class="table-responsive">
                        <table id="footable_6" class="table  table-bordered table-striped m-b-0  footable_6">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                   ...
                                   <select name="Ac_code_purchase_job_work" class="form-control select2" id="Ac_code"  style="width:250px;" onChange="previousData5(this,this.value);">
                           <option value="">--Select Buyer--</option>
                           @foreach($Ledger as  $row)
                           {
                           <option value="{{ $row->ac_code }}">{{ $row->ac_name }}</option>
                           ...
                           @endforeach
                                 ...
                                 <td><input type="number" step="any" step="any" name="l_pc_purchase_job_work[]" value="0" id="consumptionss" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="rate_purchase_job_work[]" readOnly value="0" id="rate_per_unitss" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="rs_cr_job_work[]" value="0" onkeyup="calculateRatePurchaseJobWork(this,this.value);" id="wastagess" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" class=""  name="l_min_job_work[]" value="0" id="total_amountss" style="width:80px; height:30px;"   /></td>
                                  <td><input type="text" step="any" step="any" class=""  name="remark_job_work[]" value="0" id="remark_job_work"    /></td>
                             ...
                             <tfoot>
                              <tr>
                        <td colspan="2"><strong>Total:</strong></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_l_pc_purchase_job_work"  readOnly id="totalLPCPURCHASEJOBWORK"></td>
                        <td ><input type="number" value="0" style="width:80px; height:30px;" name="total_rate_purchase_job_work"  readOnly id="totalRATEPURCHASEJOBWORK"></td>
                          <td ><input type="number" value="0" style="width:80px; height:30px;" name="total_rs_cr_job_work"  readOnly id="totalRSCRJOBWORK"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_l_min_job_work"  readOnly id="totalLIMINJOBWORK"></td>
                        <td></td>
                        </tr>
                          </tfoot>
                        </table>
                     ...
                     <div class="table-responsive">
                        <table id="footable_7" class="table  table-bordered table-striped m-b-0  footable_6">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                   ...
                                   <select name="Ac_code_collection" class="form-control select2" id="Ac_code"  style="width:250px;" onChange="previousData6(this,this.value);">
                           <option value="">--Select Buyer--</option>
                           @foreach($Ledger as  $row)
                           {
                           <option value="{{ $row->ac_code }}">{{ $row->ac_name }}</option>
                           ...
                           @endforeach
                                 ...
                                 <td><input type="number" step="any" step="any" name="total_os[]" value="0" id="consumptionss" style="width:80px; height:30px;"  /></td>
                                 <td><input type="number" step="any" step="any" name="rs_cr_collection[]" value="0" id="rs_cr_collection" style="width:80px; height:30px;"  /></td>
                                 <td><input type="text" step="any" step="any" name="remark_collection[]" value="0" id="wastagess"   /></td>
                             ...
                             <tfoot>
                              <tr>
                        <td colspan="2"><strong>Total:</strong></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="grand_total_os"  readOnly id="totalOS"></td>
                        <td><input type="number" value="0" style="width:80px; height:30px;" name="total_rs_cr_collection"  readOnly id="totalRSCRCOLLECTION"></td>
                        <td></td>
                        </tr>
                          </tfoot>
