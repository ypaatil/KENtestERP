...
<div class="row">
   <div class="col-md-12">
      <a href="{{ Route('FGLocationTransferInward.create') }}"><button type="button" class="btn btn-primary w-md">Add New Record</button></a>
   </div>
</div>
@endif
...
<script type="text/javascript"> 
    ...
    $(function () 
    {
       ...
       var table = $('#Transfer_Packing_Inhouse_table').DataTable({
        processing: true,
        serverSide: false,
        ajax: "{{ route('FGLocationTransferInward.index') }}",
        ...
        columns: [
          {data: 'srno', name: 'srno'},
          {data: 'fglti_code', name: 'fglti_code'},
