...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Packing</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            @if(isset($PackingMasterList))
            <form action="{{ route('PackingMaster.update',$PackingMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="date" name="pki_date" class="form-control" id="pki_date" value="{{$PackingMasterList->pki_date}}" required  >
                        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $PackingMasterList->c_code }}">
                        <input type="hidden" name="pki_code" class="form-control" id="pki_code" value="{{$PackingMasterList->pki_code}}" readOnly>
                       ...
                       <select name="packing_type_id" class="form-control select2" id="packing_type_id" onchange="SetPackingType(this);" disabled>
                            <option value="">--Select--</option> 
                             ...
                             @foreach($packingTypeData as $packingTypes)
                                <option value="{{$packingTypes->packing_type_id}}" {{ $packingTypes->packing_type_id == $PackingMasterList->packing_type_id ? 'selected="selected"' : '' }} >{{$packingTypes->packing_type_name}}</option>  
                             @endforeach 
                        </select>
                    </div>
                  </div> 
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="vpo_code" class="form-control select2" id="vpo_code"  onChange="getFinishingInhouseDetails(this.value);" disabled>
                           ...
                           {{ $row->vpo_code == $PackingMasterList->vpo_code ? 'selected="selected"' : '' }} 
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$PackingMasterList->sales_order_no}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="Ac_code" class="form-control select2" id="Ac_code" disabled   >
                           ...
                           {{ $row->ac_code == $PackingMasterList->Ac_code ? 'selected="selected"' : '' }} 
                           >{{ $row->ac_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="vendor_rate" class="form-control" id="vendor_rate" value="{{$PackingMasterList->vendor_rate}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="mainstyle_id" class="form-control" id="mainstyle_id"  onchange="getSubStyle(this.value)" disabled>
                           ...
                           {{ $row->mainstyle_id == $PackingMasterList->mainstyle_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="substyle_id" class="form-control" id="substyle_id" onchange="getStyle(this.value)" disabled>
                           ...
                           {{ $row->substyle_id == $PackingMasterList->substyle_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="fg_id" class="form-control" id="fg_id" disabled>
                           ...
                           {{ $row->fg_id == $PackingMasterList->fg_id ? 'selected="selected"' : '' }} 
                           >{{ $row->fg_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$PackingMasterList->style_no}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$PackingMasterList->style_description}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="vendorId" class="form-control select2" id="vendorId" disabled >
                           ...
                           {{  $rowvendor->ac_code == $PackingMasterList->vendorId ? 'selected="selected"' : '' }}
                 ...
                 @if(Session::get('user_type')== 1) 
                  <div class="col-md-2">
                     <div class="form-check form-check-primary mb-3">
                        ...
                        @if($PackingMasterList->is_opening==1)checked @endif    >
                  ...
                  <div class="col-md-3">
                     ...
                     <select name="location_id" class="form-control select2  " id="location_id" required>
                        ...
                        {{ $row->loc_id == $PackingMasterList->location_id ? 'selected="selected"' : '' }}    
                        >{{ $row->location }}</option>
                        }
                        @endforeach
                     </select>
                                    ...
                                    <div class="table-wrap">
                                       <div class="table-responsive">
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                @if(count($PackingMasterDetailList)>0)
                                                @php $no=1;$n=1; @endphp
                                                @foreach($PackingMasterDetailList as $List) 
                                                <tr>
                                                   ...
                                                   @php  
                                                        $cartonData = DB::SELECT("SELECT ((SELECT SUM(size_qty_total) FROM packing_detail WHERE sales_order_no = '".$PackingMasterList->sales_order_no."' AND color_id = ".$List->color_id.") - (SELECT SUM(size_qty_total) FROM carton_packing_inhouse_size_detail WHERE sales_order_no = '".$PackingMasterList->sales_order_no."' AND color_id = ".$List->color_id.")) as size_qty_total");
               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$PackingMasterList->total_qty}}"  readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="rate" class="form-label">Rate</label>
                        <input type="number" step="any" name="rate" class="form-control" id="rate" value="{{$PackingMasterList->rate}}" required onchange="mycalc();">
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="vendor_amount" class="form-label">Total Amount</label>
                        <input type="text" name="vendor_amount" class="form-control" id="vendor_amount" value="{{$PackingMasterList->vendor_amount}}" readOnly>
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <label for="formrow-inputState" class="form-label">Narration</label>
                     <div class="mb-3">
                        <input type="text" name="narration" class="form-control" id="narration"  value="{{$PackingMasterList->narration}}" />
                     </div>
                  </div>
               </div>
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                     ...
                     <a href="{{ Route('PackingMaster.index') }}" class="btn btn-warning w-md">Cancel</a>
                  </div>
               </div>
         </div>
         </form>
