                     ...
                     <table id="footable_2" class="table  table-bordered table-striped m-b-0 footable_2">
                        <thead>
                           <tr>
                              ...
                              <th class="text-center">Delete <button type="button" name="allocate[]"  onclick="stockAllocate();" id="mainAllocation" isClick="0" class="btn btn-success pull-left">Allocate</button> </th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr item_code="" isClick = "0" qty="" bom_code="" cat_id="" class_id="">
                              ...
                              <td class="text-center"><button type="button" onclick=" mycalc(); " class="btn btn-warning pull-left Abutton">+</button></td>
                              <td class="text-center"><input type="button" class="btn btn-danger pull-left" onclick="deleteRow(this);" value="X" ></td>
                           </tr>
                        </tbody>
                        <tfoot>
                           <tr>
...
<script>
    ...
    function GetOrderNo(ele)
    {
       if($(ele).is(":checked"))
       {
           ...
           $("#po_code").val("").trigger("change").attr('disabled', true);
       }
       else
       {
           $("#po_code").attr('onchange', 'getPODetails();FetchPoData();GetPurchaseBillDetails();'); 
