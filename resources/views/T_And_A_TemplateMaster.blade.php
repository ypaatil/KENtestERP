    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('T_And_A_TemplateMaster.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
                    @csrf 
                    <div class="row">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" name="days[]" id="days" style="width:80px;"/></td>
                                             <td> <select name="dact_ids[]" class="item" id="dact_id" style="width:200px; height:30px;" required>
                                                <option value="">--Activity Name--</option>
                                                @foreach($ActList as  $row)
                                                {
                                                    <option value="{{ $row->act_id }}">{{ $row->act_name }}</option>
