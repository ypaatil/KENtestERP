                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tr>
                                <td style="text-align:center; white-space:nowrap"><a target="_blank" href="http://kenerp.com/PurchaseOrder/{{ $row->sr_no }}/edit" >{{ $row->pur_code }} </a></td>
                                ...
                                <td style="text-align:center; white-space:nowrap"><a target="_blank" href="http://kenerp.com/PurchaseOrder/{{ $row->sr_no }}/edit" >{{ number_format($row->item_qty) }}</a></td>
