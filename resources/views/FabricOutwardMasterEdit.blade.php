   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form action="{{ route('FabricOutward.update',$FabricOutwardMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="out_type_id" class="form-control select2" id="out_type_id" disabled >
                           <option value="">--Type--</option>
                           @foreach($OutTypeList as  $rowot)
                           {
                           <option value="{{ $rowot->out_type_id }}"
                           {{ $rowot->out_type_id == $FabricOutwardMasterList->out_type_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="job_code" class="form-label">Cutting PO No</label>
                        <select name="vpo_code" class="form-select select2" id="vpo_code"  onchange="getBalanceCutingdata(this.value);" disabled>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$FabricOutwardMasterList->style_no}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$FabricOutwardMasterList->style_description}}" readOnly>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="track_code" class="form-control" id="track_code" value="" onfocusout="getFabricDetails(this.value);" readonly >
                     </div>
                  </div>
                     ...
                     <div class="table-responsive">
                        <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                           ...
                           <tbody id="FabricData">
                              ...
                              @php
                              $checkingData = DB::SELECT("SELECT width FROM fabric_checking_details WHERE track_code ='".$List->track_code."'");
                              $check_width = isset($checkingData[0]->width) ? $checkingData[0]->width : 0;
                              @endphp
                              <tr>
                                 <td><input type="text" name="id[]" value="@php echo $no; @endphp" id="id" style="width:50px;"/></td>
                                 <td><input type="text" name="track_codes[]"  value="{{ $List->track_code }}" id="track_codes" style="width:80px;" readOnly />
                                    <input type="hidden" name="item_rate[]"  value="{{ $List->item_rate }}" id="item_rate" style="width:80px;" readOnly />
                                 </td>
                                 <td> 
                                    <input type="text"   name="roll_no[]"  value="{{ $List->roll_no }}" id="widths" style="width:80px;"  readOnly/>
                                 </td>
                                 <td>
                                    <select name="item_code[]"  id="item_code" style="width:100px;"  disabled>
                                 ...
                                 <td>
                                    <select name="part_ids[]"  id="part_ids" style="width:100px;"  disabled>
                                 ...
                                 <td>
                                    <select name="shade_ids[]"  id="shade_ids" style="width:100px;"  disabled>
                                 ...
                                 <td> 
                                    <input type="text"   name="widths[]" onkeyup="mycalc();" value="{{ $check_width }}" id="widths" style="width:80px;" readOnly  />
                                 </td>
                                 <td><input type="hidden" class="TAGAQTY" onkeyup="mycalc();" value="{{ $List->taga_qty }}" id="taga_qty1" style="width:50px;"  />
                                    <input type="text" class="METER" name="meters[]" onkeyup="mycalc();" value="{{ $List->meter }}" max="{{ $List->meter }}" min="0" id="meters" style="width:80px;" required  />
                                 </td>
               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="number" step="any"  name="total_meter" class="form-control" id="total_meter" value="{{ $FabricOutwardMasterList->total_meter }}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
...
<script>
   ...
   $(document).on("change", 'input[name^="meters[]"]', function (event) 
   {
       ...
       {
           console.log(Math.min(value, maxLength));
