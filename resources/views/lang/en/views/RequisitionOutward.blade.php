...
<h4 class="mb-sm-0 font-size-18">Outward</h4>
...
<div class="card">
<div class="card-body">
<h4 class="card-title mb-4">Outward</h4>
@if ($errors->any())
...
<form action="{{route('RequisitionOutward.store')}}" method="POST">
...
<input type="text" name="outwardNo" class="form-control" id="requisitionNo" value="" readonly="readonly">
...
<input type="date" name="requisitionDate" class="form-control" id="formrow-email-input">
</div>
</div>
...
<input type="text" name="requisitionno" class="form-control" id="requisitionno" value="" onchange="gettable(this.value);getDetails(this.value);">
</div>
</div>
...
<input type="text" name="issueTo" class="form-control" id="issueTo">
</div>
</div>
<div class="col-md-4">  
<div class="mb-3">
...
{
<option value="{{ $rowreasonlist->reasonId  }}">{{ $rowreasonlist->reason }}</option>
