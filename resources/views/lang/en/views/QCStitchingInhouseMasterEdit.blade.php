...
<form action="{{ route('QCStitchingInhouse.update',$QCStitchingInhouseMasterList) }}" method="POST" enctype="multipart/form-data">
@method('put')
@csrf
...
<div class="col-md-2">
    <div class="mb-3">
       ...
       <select name="vw_code" class="form-control" id="vw_code" required  onChange="getStitchingInhouseDetails(this.value);" disabled>
...
<input style="width:80px; float:left;background-color:#FAACAA;" max="{{$SizeQtyList2[$nz]}}" min="0" name="s_@php echo $n; @endphp[]" class="size_id" type="number" id="s_@php echo $n; @endphp" value="{{$SizeQtyList2[$nz]}}" required />
</td>
...
<input type="hidden" name="size_qty_total2[]" class="size_qty_total2" value="{{$QCStitchingInhouseRejectDetailList[$nox]->size_qty_total}}" id="size_qty_total2" style="width:80px; height:30px; float:left;"  />
