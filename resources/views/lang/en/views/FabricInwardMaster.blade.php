...
<form action="{{route('FabricInward.store')}}" method="POST" enctype="multipart/form-data">
@csrf 
<div class="row">
<div class="col-md-2">
    <div class="mb-3">
...
<select name="po_code" class="form-select select2" id="po_code" onchange="getDetails(this.value);"   >
...
<td> <select name="item_code[]"   id="item_code" class="select2" style="width:200px;height:30px;" required>
...
<td> <select name="part_id[]"  id="part_id" class="select2" style="width:200px;height:30px;" required>
...
<td><input type="hidden" class="TAGAQTY" onkeyup="mycalc();" value="1" id="taga_qty1" style="width:50px;height:30px;"/><input type="number" step="0.01" class="METER" name="meter[]" onkeyup="mycalc();" value="0" id="meter1" style="width:80px;height:30px;" required/></td>
<td><input type="number" step="0.01"  name="gram_per_meter[]" value="0" id="gram_per_meter" style="width:80px;height:30px;" required/></td>
<td><input type="number" step="0.01" class="KG" name="kg[]" onkeyup="mycalc();" value="0" id="kg" style="width:80px;height:30px;" required/></td>
...
<td>
    <input type="button"  style="width:40px;" onclick="insertcone(); " name="print" value="+" class="btn btn-warning pull-left AButton"> <input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone(this);" value="X" ></td>
</tr>
...
<div class="row">
 ...
 <div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="number" step="0.01"  name="total_kg" class="form-control" id="total_kg" value="0">
    </div>
</div>
...
document.getElementById("total_amount").value = sum1.toFixed(2);
  ...
  $("table.footable_2").on('keyup', 'input[name^="gram_per_meter"]', function (event)   
    ...
    row.find('input[name^="kg[]"]').val(parseFloat(meter*gram_per_meter));
