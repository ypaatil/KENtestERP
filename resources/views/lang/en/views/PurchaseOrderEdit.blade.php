...
<div class="card">
<div class="card-body">
<form action="{{route('PurchaseOrder.update',$purchasefetch)}}" method="POST">
...
<select name="bom_type" class="form-select" id="bom_type" onchange="getBomDetail(this.value);">
<option value="0">Type List</option>    

@if($purchasefetch->bom_type==1)
<option value="1"  selected>Fabric</option>
<option value="2">Sewing Trims</option>
<option value="3">Packing Trims</option>
@elseif($purchasefetch->bom_type==2)
<option value="2" selected>Sewing Trims</option>
<option value="1">Fabric</option>
<option value="3">Packing Trims</option>
@elseif($purchasefetch->bom_type==3)
<option value="2">Sewing Trims</option>
<option value="1">Fabric</option>
<option value="3" selected>Packing Trims</option>
@else
<option value="1">Fabric</option>
<option value="2">Sewing Trims</option>
<option value="3">Packing Trims</option>
...
<td> <select name="item_codes[]" class="item" id="item_code" style="width:100px;" disabled>
...
<td>
     <img  src=""  id="item_image" name="item_image[]" class="imgs">
    <input type="hidden"   name="hsn_code[]"   value="0" id="hsn_code" style="width:80px;" required/></td>
...
<td><input type="text" name="id" value="{{ $no }}" id="id"  style="width:50px;"/></td>
 <td>
<select name="item_codes[]" class="item" id="item_code" style="width:100px;" disabled>
<option value="">--- Select Item ---</option>
@foreach($itemlist as  $rowitem)
{
...
<td>
    ...
    <img  src="/thumbnail/{{ $row->item_image_path }}"  id="item_image" name="item_image[]" class="imgs"></td>
...
<td><input style="width:80px;" type="text" class="Qty" name="item_qtys[]" min="{{ $row->item_qty }}" max="{{ $row->item_qty }}" value="{{ $row->item_qty }}" readOnly  id="item_qty">
</td>
...
<td><input readOnly style="width:80px;" readOnly type="number" id="pur_cgst" step="0.01"  class="" name="pur_cgsts[]" value="{{ $row->pur_cgst }}"></td>
<td><input  style="width:80px;"  type="number" readOnly step="0.01" id="camt" class="GSTAMT" name="camts[]" value="{{ $row->camt }}"></td>
<td><input readOnly style="width:80px;" readOnly type="number" step="0.01" id="pur_sgst" class="" name="pur_sgsts[]" value="{{ $row->pur_sgst }}"></td>
<td><input style="width:80px;"  type="number" readOnly step="0.01" id="samt" class="GSTAMT" name="samts[]" value="{{ $row->samt }}"></td>
<td><input readOnly style="width:80px;" readOnly type="number" step="0.01" id="pur_igst" class="" name="pur_igsts[]" value="{{ $row->pur_igst }}"></td>
...
<td><input type="text" name="freight_hsn[]" readOnly class="" id="freight_hsn" value="{{ $row->freight_hsn }}" style="width:80px;"></td>
<td><input type="text" name="freight_amt[]" readOnly class="FREIGHT" id="freight_amt" value="{{ $row->freight_amt }}" style="width:80px;"></td>
