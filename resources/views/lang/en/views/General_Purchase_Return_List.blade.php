...
<div class="row">
<div class="col-md-6">
<a href="{{ Route('GeneralPurchaseReturn.create') }}"><button type="button" class="btn btn-primary w-md float-right">Add New Record</button></a>
</div>
</div>
@endif
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    @if($chekform->edit_access==1)
                                <td>
                                <a class="btn btn-outline-secondary btn-sm edit" href="{{route('GeneralPurchaseReturn.edit',$row->sr_no)}}" title="Edit">
...
@if($chekform->delete_access==1)
                                <td>
                                <form action="{{route('GeneralPurchaseReturn.destroy', $row->pur_code )}}" method="POST">
