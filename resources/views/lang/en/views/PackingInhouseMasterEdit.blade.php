...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="pki_date" class="form-control" id="pki_date" value="{{$PackingInhouseMasterList->pki_date}}" required readOnly>
...
<div class="col-md-2">
    <div class="mb-3">
       ...
       <select name="vpo_code" class="form-control" id="vpo_code" required  onChange="getFinishingInhouseDetails(this.value);" disabled>
