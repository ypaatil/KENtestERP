                                          ...
                                          <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->updated_at }}</td>
                                                 ...
                                                 <td>
                                                <a class="btn btn-outline-secondary btn-sm edit" href="{{route('FabricOutward.edit', $row->fout_code)}}" title="Edit">
        ...
        <td>
                                <a class="btn btn-outline-secondary btn-sm edit" href="" title="Edit">
                                   ...
                                   @endif
                                                ...
                                                <td>
                                                  <button  class="btn   btn-sm delete"  data-placement="top" id="DeleteRecord" data-token="{{ csrf_token() }}" data-id="{{ $row->fout_code }}"  data-route="{{route('FabricOutward.destroy', $row->fout_code )}}" title="Delete">
