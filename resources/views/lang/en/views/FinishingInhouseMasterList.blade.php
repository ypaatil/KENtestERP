...
<div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0 font-size-18">Finishing Inhouse List</h4>

        <div class="page-title-right">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="javascript: void(0);">Transaction</a></li>
                <li class="breadcrumb-item active">Finishing Inhouse List</li>
            </ol>
        </div>
...
<!--    </div>  -->
                        ...
                        <div class="row">
                        <div class="col-md-12">
                        <a href="{{ Route('FinishingInhouse.create') }}"><button type="button" class="btn btn-primary w-md">Add New Record</button></a>
                                ...
                                <div class="card">
                                    ...
                                    <table data-order='[[ 0, "desc" ]]' data-page-length='25' id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                          <thead>
                                            ...
                                            @foreach($FinishingInhouseMasterList as $row)    
                                            <tr>
                                                <td > {{ substr($row->fns_code,5,15)  }} </td>
                                                ...
                                                <td>
                                                <a class="btn btn-outline-secondary btn-sm print" href="VPPrint/{{ $row->fns_code }}" title="print">
                                                    <i class="fas fa-print"></i>
                                                </a>
                                                </td>
                                                
                                                <td>
                                                <a class="btn btn-outline-secondary btn-sm edit" href="{{route('FinishingInhouse.edit', $row->fns_code)}}" title="Edit">
        ...
        <button  class="btn   btn-sm delete"  data-placement="top" id="DeleteRecord" data-token="{{ csrf_token() }}" data-id="{{ $row->fns_code }}"  data-route="{{route('FinishingInhouse.destroy', $row->fns_code )}}" title="Delete">
