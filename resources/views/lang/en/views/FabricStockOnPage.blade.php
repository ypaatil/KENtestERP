                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tr>
                                <td><a href="http://kenerp.org/PurchaseOrder/{{ $row->sr_no }}/edit" >{{ $row->pur_code }} </a></td>
                                <td>{{ $row->pur_date }}</td>
                                ...
                                <td>{{ $row->dimension }}</td>
                                <td><a href="http://kenerp.org/PurchaseOrder/{{ $row->sr_no }}/edit" >{{ number_format($row->item_qty) }}</a></td>
