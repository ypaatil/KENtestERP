...
<h4 class="mb-sm-0 font-size-18">Returnable Outward</h4>

<div class="page-title-right">
<ol class="breadcrumb m-0">
<li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
<li class="breadcrumb-item active">Returnable Outward</li>
</ol>
</div>
...
<div class="card">
<div class="card-body">
<h4 class="card-title mb-4">Returnable Outward</h4>
@if ($errors->any())
...
<form action="{{route('ReturnableOutward.update',$returnableoutwardfetch)}}" method="POST">
...
{{ $row->firm_id == $returnableoutwardfetch->firm_id ? 'selected="selected"' : '' }}
...
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Outward No</label>
<input type="text" name="RetOutwardcode" class="form-control" id="RetOutwardcode" value="{{ $returnableoutwardfetch->RetOutwardcode }}" readonly="readonly">
<input type="hidden" name="c_code" id="c_code" value="{{ $returnableoutwardfetch->c_code }}" />
...
<input type="date" name="RetOutwardDate" class="form-control" id="formrow-email-input" value="{{ $returnableoutwardfetch->RetOutwardDate }}">
</div>
</div>
...
{{ $rowdepartment->dept_id == $returnableoutwardfetch->dept_id ? 'selected="selected"' : '' }}
...
@foreach($machinelist as  $rowmachinelist)
{
<option value="{{ $rowmachinelist->machineId  }}"

{{ $rowmachinelist->machineId == $returnableoutwardfetch->machineId ? 'selected="selected"' : '' }}

    >{{ $rowmachinelist->machineName  }}</option>
...
<div class="col-md-4">
<div class="mb-3">
<label for="formrow-inputState" class="form-label">Consignee</label>
...
{{ $rowledger->ac_code == $returnableoutwardfetch->machineId ? 'selected="selected"' : '' }}
...
<input type="text" name="gstNo" class="form-control" id="gstNo" value="{{ $returnableoutwardfetch->gstNo }}" >
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
...
{{ $rowgst->tax_type_id == $returnableoutwardfetch->tax_type_id ? 'selected="selected"' : '' }}
...
@php  if($detailoutward->isEmpty()) { @endphp
...
<td><input type="date"   name="return_date[]"  class="Date" value=""  id="return_date" style="width:120px;" required/></td>
...
<td><input type="date"   name="return_date[]"  class="Date" value="{{ $row->return_date }}"  id="return_date" style="width:120px;" required/></td>
...
<input type="number" value="{{ count($detailoutward) }}" name="cnt" id="cnt" readonly="" hidden="true"  />
<br/>
...
<input type="text" name="Gross_amount" class="form-control" id="Gross_amount" value="{{ $returnableoutwardfetch->Gross_amount }}" onChange="mycalc();">
</div>
</div>
<div class="col-md-2">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">GST Amount</label>
<input type="text" name="Gst_amount" class="form-control" id="Gst_amount" value="{{ $returnableoutwardfetch->Gst_amount }}">
</div>
</div>
...
<input type="text" name="Net_amount" value="{{ $returnableoutwardfetch->Net_amount }}" class="form-control" id="Net_amount">
</div>
</div>
...
<input type="text" name="remark" class="form-control" id="remark" value="{{ $returnableoutwardfetch->remark }}">
</div>
</div>
...
<input type="text" name="address" class="form-control" id="address" value="{{ $returnableoutwardfetch->address }}">
</div>
</div>
...
<div class="col-md-4">  
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Shipped through</label>
<select name="loc_id" class="form-select" id="loc_id">
<option value="">--- Select Shipped through---</option>
@foreach($locationlist as  $rowlocation)
{
<option value="{{ $rowlocation->loc_id  }}"

{{ $rowlocation->loc_id == $returnableoutwardfetch->loc_id ? 'selected="selected"' : '' }}
...
<div class="col-md-4">  
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Vehical No</label>
<input type="text" name="vehicalNo" class="form-control" id="vehicalNo" value="{{ $returnableoutwardfetch->vehicalNo }}">
</div>
</div>
<div class="col-md-4">  
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Term Of Payment</label>
<input type="text" name="termOfPayment" class="form-control" id="termOfPayment" value="{{ $returnableoutwardfetch->termOfPayment }}">
</div>
</div>
</div>
...
var t12=document.createElement("input");
t12.style="display: table-cell; width:120px;";
t12.type="date";
t12.step="0.01";
t12.className="";
t12.id = "return_date"+index;
t12.name= "return_date[]";
t12.value=document.getElementById("return_date").value;
cell12.appendChild(t12);
