...
<div class="col-md-3">
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Account Name</label>
<input type="text" name="ac_name" class="form-control" id="ac_name" value="{{ $Ledger->ac_name }}" required>
...
<input type="text" name="address" class="form-control" id="address" value="{{ $Ledger->address }}">
...
<div class="col-md-2">
<div class="mb-3">
<label for="taluka_id" class="form-label">Country</label>
...
<input type="text" name="phone" class="form-control" id="formrow-phone-input" value="{{ $Ledger->phone }}">
...
<input type="text" name="email" class="form-control" id="formrow-email-input" value="{{ $Ledger->email }}">
...
<input type="text" name="pan_no" class="form-control" id="formrow-pan_no-input" maxlength="10" value="{{ $Ledger->pan_no }}">
</div>
</div>
...
<input type="text" name="gst_no" class="form-control" id="formrow-gst_no-input" maxlength="15" value="{{ $Ledger->gst_no }}">
</div>
</div>
...
<input type="text" name="adhar_no" class="form-control" id="formrow-adhar_no-input" value="{{ $Ledger->adhar_no }}">
</div>
</div>

<div class="col-md-2">
<div class="mb-3">
<label for="formrow-inputState" class="form-label">Business Type</label>
...
<div class="form-group">
<input type="number" step="0.01" name="tds_per" value="{{ $Ledger->tds_per }}" class="form-control" placeholder="Enter TDS % Here..." />
</div>
</div>
...
@foreach($LedgerDetailList as $List) 
    ...
    <td>
        ...
        <td> 
            <input type="text"   name="company_address[]"  class="form-control" id="company_address[]" value="{{ $List->company_address }}">
        </td>
        <td> 
            <input type="text"   name="consignee_address[]"  class="form-control" id="consignee_address[]" value="{{ $List->consignee_address }}">
        </td>
        <td><button type="button" onclick="insertcone(); " class="btn btn-warning pull-left">+</button> </td>
...
<tr>
    <td>
        ...
        <td> 
            <input type="text"   name="consignee_address[]"  class="form-control" id="consignee_address[]" value="">
        </td>
...
<div class="mb-3">
<label for="formrow-email-input" class="form-label">Account Name</label>
<input type="text" name="ac_name" class="form-control" id="ac_name" value="">
<input type="hidden" name="userId" value="{{ Session::get('userId') }}" class="form-control" id="formrow-email-input">
</div>
</div>
...
<div class="col-md-1">
<div class="mb-3">
<label for="formrow-inputState" class="form-label">Business</label>
<select name="bt_id" class="form-select" id="bt_id">
<option value="">Business</option>
@foreach($BusinessType as  $row)
{
...
<label for="formrow-inputState" class="form-label">TDS%</label>
<div class="form-group">
<input type="number" step="0.01" name="tds_per" value="0" class="form-control" placeholder="Enter TDS % Here..." />
</div>
</div>
<div class="col-sm-2">
<label for="formrow-inputState" class="form-label">Note</label>
...
<tbody>
    ...
    <td>
        ...
        <td> 
            <input type="text"   name="gst_nos[]"  class="form-control" id="gst_nos[]" value="">
        </td>
        <td> 
            <input type="text"   name="company_address[]"  class="form-control" id="company_address[]" value="">
        </td>
        <td> 
            <input type="text"   name="consignee_address[]"  class="form-control" id="consignee_address[]" value="">
        </td>
...
t5.className="form-control";
t5.type="text";
t5.id = "company_address"+indexcone;
t5.name="company_address[]";
cell5.appendChild(t5);

var cell5 = row.insertCell(4);
var t5=document.createElement("input");
t5.className="form-control";
t5.id = "consignee_address"+indexcone;
t5.name="consignee_address[]";
cell5.appendChild(t5);
