                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    @if($chekform->edit_access==1)
                                                ...
                                                <td>
                                                <a class="btn btn-outline-secondary btn-sm edit" href="{{route('Color.edit', $row->color_id)}}" title="Edit">
                                             ...
                                             @if($chekform->delete_access==1)    
                                                <td>
                    <button  class="btn btn-outline-secondary btn-sm delete"  data-placement="top" id="DeleteRecord" data-token="{{ csrf_token() }}" data-id="{{ $row->color_id }}"  data-route="{{route('Color.destroy', $row->color_id )}}" title="Delete">
