...
<!--    </div>  -->
                                ...
                                <div class="card">
                                    ...
                                    <table data-order='[[ 0, "desc" ]]' data-page-length='25' id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                          <thead>
                                            ...
                                            @foreach($StitchingInhouseMasterList as $row)    
                                            <tr>
                                                <td > {{ substr($row->sti_code,4,15)  }} </td>
                                                ...
                                                <td>
                                                <a class="btn btn-outline-secondary btn-sm print" href="VPPrint/{{ $row->sti_code }}" title="print">
                                                    <i class="fas fa-print"></i>
                                                </a>
                                                </td>
                                                
                                                <td>
                                                <a class="btn btn-outline-secondary btn-sm edit" href="{{route('StitchingInhouse.edit', $row->sti_code)}}" title="Edit">
        ...
        <button  class="btn   btn-sm delete"  data-placement="top" id="DeleteRecord" data-token="{{ csrf_token() }}" data-id="{{ $row->sti_code }}"  data-route="{{route('StitchingInhouse.destroy', $row->sti_code )}}" title="Delete">
