...
<div class="card">
<div class="card-body">
<h4 class="card-title mb-4">Job Card</h4>
@if ($errors->any())
...
<form action="{{route('BuyerJobCard.store')}}" method="POST" enctype="multipart/form-data">
@csrf 
<div class="row">
...
@foreach($counter_number as  $row)
     <input type="hidden" name="po_code" class="form-control" id="po_code" value="{{ 'JB'.'-'.$row->tr_no }}">
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="po_date" class="form-control" id="po_date" value="{{date('Y-m-d')}}" required>
    </div>
</div>
...
<input type="file" name="style_pic_path" class="form-control" id="style_pic_path" value="0">
...
<input type="file" name="doc_path1" class="form-control" id="doc_path1" value="0">
...
<input type="file" name="doc_path2" class="form-control" id="doc_path2" value="0" >
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="number"   name="prod_qty" class="form-control" id="prod_qty" value="0" onkeyup="mycalc();" required>
    </div>
</div>
<div class="col-md-2">
    <div class="mb-3">
        <label for="rate_per_piece" class="form-label">Rate / Piece</label>
        <input type="number" step="0.01"  name="rate_per_piece" class="form-control" id="rate_per_piece" required value="0" onkeyup="calculateamount();">
    </div>
</div>
...
<input type="number" step="0.01" name="total_amount" id="total_amount" value="0" class="form-control"  required />
</div>
</div>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text"   name="ppk_ratio" placeholder="e.g. 1,2,3,4"  class="form-control" id="ppk_ratio" value="" required>
    </div>
</div>

<div class="col-md-2">
    <div class="mb-3">
        <label for="color_id" class="form-label">Choose Multi-Color</label>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text"   name="piece_avg" placeholder="e.g. 1.5,1.2,1.9,0.6"  class="form-control" id="piece_avg" value="" required>
    </div>
</div>
...
@foreach($SampleList as  $row)
    ...
    <tr>
        ...
        <th> 
            <input type="date"   name="sample_comp_date[]"  class="form-control" id="sample_comp_date[]" value="{{date('Y-m-d')}}">
        </th>
        <th> 
            <input type="date"   name="sample_tentative_date[]"  class="form-control" id="sample_tentative_date[]" value="{{date('Y-m-d')}}">
        </th>
    </tr>
...
<div class="col-xl-5 col-sm-5">
        ...
        <textarea type="text" name="comment_guidance" class="form-control" id="editor1" required>
        </textarea>
    </div> 
