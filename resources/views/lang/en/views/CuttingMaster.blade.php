...
<form action="{{route('FabricCutting.store')}}" method="POST" enctype="multipart/form-data">
@csrf 
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="cu_date" class="form-control" id="cu_date" value="{{date('Y-m-d')}}">
...
<select name="table_task_code" class="form-select" id="table_task_code" required onchange="getCheckMasterData(this.value);">
...
<select name="item_code" class="form-select" id="item_code" required disabled>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text" name="width" class="form-control" id="width" value="" required readOnly>
    </div>
</div>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text" name="meter" class="form-control" id="meter" value="" required readOnly> 
    </div>
</div>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text" name="layers" class="form-control" id="layers" value="" onchange="delete_Row(); deleteEndDataRow();getCheckingFabricdata(2); " readOnly required>
    </div>
</div>
