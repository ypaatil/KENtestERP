...
<li class="breadcrumb-item active">Dr Note List</li>
</ol>
</div>
...
<div class="row">
<div class="col-md-6">
<a href="{{ Route('DrNote.create') }}"><button type="button" class="btn btn-primary w-md float-right">Add New Record</button></a>
</div>
</div>
@endif
...
<td>
<a class="btn btn-outline-secondary btn-sm edit" href="{{route('DrNote.edit',$row->sr_no)}}" title="Edit">
...
<td>
<form action="{{route('DrNote.destroy', $row->DrNote_Code )}}" method="POST">
