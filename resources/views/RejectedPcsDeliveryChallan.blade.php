...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            <form action="{{route('RejectedPcsDeliveryChallan.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="sales_order_no[]" class="form-control select2" id="sales_order_no1"   onChange="getPackingInhouseDetails();" multiple>
   ...
   <input type="text" name="total_qty" class="form-control" id="total_qty" value="" required>
   </div>
   </div>
   <div class="col-sm-8">
...
//   });
   ...
   function addNewRow()
   {
        var sales_order_no=$('#sales_order_no1').val().join(",");
