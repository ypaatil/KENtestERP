                         ...
                         <tbody id="assignTbl">
                             ...
                             @foreach($DetailDeviation as $row)
                              <tr>
                               ...
                               <td><input type="text" name="efficiency[]" value="{{$row->efficiency}}" class="form-control"/></td> 
                              </tr> 
                            @endforeach
                         </tbody>
                     </table>
                     ...
                     <table id="m/c_assign" class="table table-bordered text-1 table-sm" style="height:10vh; ">
                         ...
                         <tbody id="assignTbl">
                              <tr>
                               ...
                               <td><input type="text" name="efficiency[]" value="" class="form-control"/></td> 
                            </tr> 
                         </tbody>
                     </table>
               </div>
...
<script>   
    ...
    { 
        ...
        for(var i=fromDate;i<=toDate; i++)
        {
            ...
            html += '<tr><td class="text-center">'+srno+'</td><td><input type="date" name="monthDate[]" value="'+fullDate+'" class="form-control"/></td><td><input type="text" name="noOfMC[]" value="" class="form-control"/></td><td><input type="text" name="efficiency[]" value="" class="form-control"/></td> </tr>'
