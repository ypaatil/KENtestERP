...
<div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0 font-size-18">Sales Order Costing & BOM Status Dashboard</h4>

        <div class="page-title-right">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="javascript: void(0);">Transaction</a></li>
                <li class="breadcrumb-item active">Sales Order Costing & BOM Status Dashboard</li>
            </ol>
        </div>
                                    ...
                                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                          <thead>
                                            <tr style="text-align:center; white-space:nowrap">
                                                ...
                                                <th>Fabric BOM Status</th>
                                                <th>Trims BOM Status</th>
                                                <th>Bulk Merchant</th>
                                            ...
                                            <tr>
                                                ...
                                                <td> @if($row->Costing_Count > 0) <span class="badge badge-pill badge-soft-success font-size-11" >{{' Completed'}} </span> @else <span class="badge badge-pill badge-soft-danger font-size-11">{{'Not Done'}} </span> @endif </td> 
                                                <td> @if($row->Fabric_BOM_Count > 0) <span class="badge badge-pill badge-soft-success font-size-11" >{{' Completed'}} </span> @else <span class="badge badge-pill badge-soft-danger font-size-11">{{'Not Done'}} </span> @endif </td> 
												<td> @if($row->Trims_BOM_Count > 0) <span class="badge badge-pill badge-soft-success font-size-11" >{{' Completed'}} </span> @else <span class="badge badge-pill badge-soft-danger font-size-11">{{'Not Done'}} </span> @endif </td> 
