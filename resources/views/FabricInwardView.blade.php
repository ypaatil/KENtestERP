        ...
        <div class="invoice">
            <main>
                <div id="printInvoice" class="outer-border">
                    ...
                    <h3 class=" fw-bold  text-center"> Goods Receipt Note-Fabric </h3>
                        ...
                        <div class="col-md-6 p-3 border-end">
                            <div class="">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="colon">:</div>
                                    <div class="value">{{ $FabricInwardMaster[0]->in_code }}</div>

                                </div>
                                <div class="info-row">
                                    <div class="label">GRN/Inward Date </div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ \Carbon\Carbon::parse ( $FabricInwardMaster[0]->in_date)->format('d-m-Y') }} </div>
                                </div>
                                <div class="info-row">
                                    <div class="label">PO Number</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ $FabricInwardMaster[0]->po_code }} </div>
                                </div>
                                <div class="info-row">
                                    <div class="label">Invoice No</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ $FabricInwardMaster[0]->invoice_no }} </div>
                                </div>
                                <div class="info-row">
                                    <div class="label">Invoice Date</div>
                                    <div class="colon">:</div>
                                    <div class="value"> {{\Carbon\Carbon::parse ($FabricInwardMaster[0]->invoice_date)->format('d-m-Y') }} </div>
                                </div>
                    ...
                    <div class="row g-0  border-bottom ">
                        ...
                        <div class="col-md-6 p-2 border-end">
                            <div class="">
                                ...
                                <p><b>{{ $FabricInwardMaster[0]->supplier_name }}</b><br>{{ $FabricInwardMaster[0]->bill_to_addr1 }}</p>
                                <div class="info-row">
                                    <div class="label">GST NO</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ $FabricInwardMaster[0]->gst_no }} </div>
                                </div>
                                <div class="info-row">
                                    <div class="label">STATE</div>
                                    <div class="colon">:</div>
                        ...
                        <div class="col-md-6 p-2">
                            <div class="">
                                <p><b>Shipped To :</b></p>
                                <p><b>{{ $FabricInwardMaster[0]->trade_name }}</b><br>{{ $FabricInwardMaster[0]->po_addr1 }}</p>
                    ...
                    <table class="table table-bordered table-sm second">
                        <thead>
                            <tr>
                                ...
                                <th>UOM</th>
                                <th>Rate</th>
                                <th>Amt.<br>(Before Tax)</th>
                                <th>CGST</th>
                                <th>SGST </th>
                                <th>IGST</th>
                                <th>Amt.<br>(After Tax)</th>

                            </tr>
                        </thead>
                        <tbody>
                            @php
                            $FabricInwardDetailstables = App\Models\FabricInwardDetailModel::select(
                            'inward_details.item_rate',
                            'unit_name',
                            'inward_details.is_opening',
                            ...
                            'item_master.cgst_per',
                            'item_master.sgst_per',
                            'item_master.igst_per',
                            'item_master.hsn_code',
                            DB::raw('sum(inward_details.meter) as meter')
                            )
                            ->join('item_master','item_master.item_code','=','inward_details.item_code')
                            ...
                            $GSTType = DB::table('purchase_order')
                            ->select('tax_type_id')
                            ->where('pur_code', $FabricInwardMaster[0]->po_code)
                            ->first();
                    ...
                    <table class="table table-bordered border  border-dark  ms-auto  summary-table" style="width: 500px;">
                        ...
                        <tr>
                            ...
                            <td class="text-end">{{ money_format('%!i', $SGSTTotal) }}</td>
                        </tr>
                        <tr>
                            <th class="text-start">CGST</th>
                            <td class="text-end">{{ money_format('%!i', $CGSTTotal) }}</td>
                        </tr>
                        <tr>
                            <th class="text-start">IGST</th>
                            <td class="text-end">{{ money_format('%!i', $IGSTTotal) }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-end">{{ money_format('%!i', $roundedTotal) }}</td>
                        </tr>
                    </table>
                    <!-- Footer -->
                    <footer>
