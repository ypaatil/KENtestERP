...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Outward For Packing </h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            @if(isset($OutwardForPackingMasterList))
            <form action="{{ route('OutwardForPacking.update',$OutwardForPackingMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="date" name="ofp_date" class="form-control" id="ofp_date" value="{{$OutwardForPackingMasterList->ofp_date}}"  >
                        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $OutwardForPackingMasterList->c_code }}">
                        <input type="hidden" name="ofp_code" class="form-control" id="ofp_code" value="{{$OutwardForPackingMasterList->ofp_code}}" readOnly>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$OutwardForPackingMasterList->sales_order_no}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="Ac_code" class="form-control select2" id="Ac_code"  disabled>
                           ...
                           {{ $row->ac_code == $OutwardForPackingMasterList->Ac_code ? 'selected="selected"' : '' }} 
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="mainstyle_id" class="form-control" id="mainstyle_id"  onchange="getSubStyle(this.value)"  disabled>
                           ...
                           {{ $row->mainstyle_id == $OutwardForPackingMasterList->mainstyle_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="substyle_id" class="form-control" id="substyle_id" onchange="getStyle(this.value)"  disabled>
                           ...
                           {{ $row->substyle_id == $OutwardForPackingMasterList->substyle_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="fg_id" class="form-control" id="fg_id"  disabled>
                           ...
                           {{ $row->fg_id == $OutwardForPackingMasterList->fg_id ? 'selected="selected"' : '' }} 
                           >{{ $row->fg_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$OutwardForPackingMasterList->style_no}}"  readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$OutwardForPackingMasterList->style_description}}"  readOnly>
                     </div>
                  </div>
                  <div class="col-md-3">
                     <div class="mb-3">
                        ...
                        <select name="vendorId" class="form-control" id="vendorId" disabled >
                           ...
                           {{  $rowvendor->ac_code == $OutwardForPackingMasterList->vendorId ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            @foreach($ToSent as  $sent) 
                                <option value="{{ $sent->loc_id }}"  {{  $sent->loc_id == $OutwardForPackingMasterList->sent_to ? 'selected="selected"' : '' }}>{{ $sent->location }}</option> 
                            @endforeach
                            </select>
                        </div>
                  </div> 
                     ...
                     <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title">
                                 <a data-toggle="collapse" data-parent="#accordion" href="#collapsex">Inward For Packing Order Qty</a>
                              </h4>
                           </div>
                                    ...
                                    <div class="table-wrap">
                                       <div class="table-responsive">
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                @php   $no=1;  @endphp
                                                @foreach ($inwardForPackingList as $row) 
                                                <tr>
                                                   <td>{{$no}}</td>
                        ...
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title">
                                 <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Outward For Packing</a>
                              </h4>
                           </div>
                                    ...
                                    <div class="table-wrap">
                                       <div class="table-responsive">
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                @if(count($OutwardForPackingDetailList)>0)
                                                @php $no=1;$n1=0; @endphp
                                                @foreach($OutwardForPackingDetailList as $List) 
                                                <tr>
                                                   ...
                                                   @php
                                                        ...
                                                        $nos = $n++;
                                                        $sz = 's'.$nos;
                                                        $min = isset($inwardForPackingList[$n1]->$sz) ? $inwardForPackingList[$n1]->$sz : 0;
                                                   @endphp
                                                    <td>
                                                        <input style="width:80px; float:left;" name="s@php echo $n; @endphp[]" min="{{$min}}" max="{{$szQty}}" onchange="validateSize(this);" class="size_id" type="number" id="s@php echo $n; @endphp" value="{{$szQty}}" required />
                                                    </td>
                                                   @endforeach
                                                   <td><input type="number" step="any" name="size_qty_total[]" class="size_qty_total"  min="{{min($szQty, $List->size_qty_total)}}" max="{{$List->size_qty_total}}"  value="{{$List->size_qty_total}}" id="size_qty_total" style="width:80px; height:30px; float:left;" readonly  />
               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$OutwardForPackingMasterList->total_qty}}" readOnly>
                     </div>
                  </div>
                  <div class="col-sm-8">
                     <label for="formrow-inputState" class="form-label">Narration</label>
                     <div class="mb-3">
                        <input type="text" name="narration" class="form-control" id="narration"  value="{{$OutwardForPackingMasterList->narration}}" />
                     </div>
                  </div>
               </div>
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                     ...
                     <a href="{{ Route('OutwardForPacking.index') }}" class="btn btn-warning w-md">Cancel</a>
                  </div>
               </div>
         </div>
         </form>
