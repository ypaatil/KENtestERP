...
<form action="{{route('PackingVendor.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
@csrf 
<div class="row">
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="date" name="vpki_date" class="form-control" id="vpki_date" value="{{date('Y-m-d')}}" required  >
...
<div class="col-md-2">
    <div class="mb-3">
       ...
       <select name="sales_order_no" class="form-control  " id="sales_order_no" required  onChange="getSalesOrderTableOpening(this.value);">
