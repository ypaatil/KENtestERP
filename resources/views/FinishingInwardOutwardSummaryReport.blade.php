...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">Finishing Inward Outward Summary Report</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);">MIS Reports</a></li>
               <li class="breadcrumb-item active">Finishing Inward Outward Summary Report</li>
            </ol>
         </div>
      </div>
   </div>
...
<div class="col-md-12">
   <div class="card mini-stats-wid">
      <div class="card-body">
          <form action="/FinishingInwardOutwardSummaryReport" method="GET">
              <div class="row">  
                   <div class="col-md-3">
                     <div class="mb-3">
                  ...
                  <div class="col-md-4 mt-4"> 
                        ...
                        <a href="/FinishingInwardOutwardSummaryReport" class="btn btn-warning">Clear</a> 
                  </div>
              ...
              <table id="dt" class="table table-bordered">
                    <thead>
                        <tr style="text-align:center"> 
                            <th rowspan="2" style="vertical-align: middle;">DC No.</th>
                            <th nowrap colspan="2">Outward</th>
                            <th nowrap colspan="2">Inward</th>
                            <th nowrap rowspan="2" style="vertical-align: middle;">Balance Qty</th> 
                        </tr> 
                        <tr style="text-align:center">  
                            <th nowrap>Date</th>
                            <th nowrap>Qty</th> 
                    ...
                    @foreach($inwardData as $index => $row)
                        ...
                        <tr style="text-align:center" class="{{$row->ofp_code}} out_qty_{{$inout}}">
