...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="number" name="order_rate" class="form-control" id="order_rate" value="{{$BuyerPurchaseOrderMasterList->order_rate}}" required>
    </div>
</div>
...
<td> <select name="item_code[]" class="Item select2"  id="item_code" style="width:250px; height:30px;"" required>
...
<td> <select name="color_id[]" class="color select2"  id="color_id" style="width:250px; height:30px;"" required>
...
<td><input type="text"   name="size_id[]" "size select2" value="{{ $size_id }}" id="size_id" style="width:80px;" required /></td>
@endforeach
  <td class="track">
        <input type="text" name="size_qty_total[]" class="QTY" value="{{$List->size_qty_total}}" id="size_qty_total" style="width:80px;"  />
        <input type="hidden" name="size_qty_array[]"  value="{{$List->size_qty_array}}" id="size_qty_array" style="width:80px;"  />
 ...
 <td><input type="number" step="0.01" name="shipment_allowance[]"  value="{{$List->shipment_allowance}}" id="shipment_allowance" style="width:80px;" required /></td>
 <td><input type="number" step="0.01" name="garment_rejection_allowance[]"   value="{{$List->garment_rejection_allowance}}" id="garment_rejection_allowance" style="width:80px;" required /></td>
<td><input type="button" style="width:40px;" id="Abutton"  name="button[]"onclick="addrow();" value="+" class="btn btn-warning pull-left">  <input type="button" class="btn btn-danger pull-left" onclick="deleteRowcone(this);" value="X" ></td>
</tr>
