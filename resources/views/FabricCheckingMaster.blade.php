   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            <form action="{{route('FabricChecking.store')}}" method="POST" enctype="multipart/form-data" id="frmData"> 
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                  ...
                  <div class="col-md-3">
                     <div class="mb-3">
                        ...
                        <select name="in_code" class="form-select select2" id="in_code" required onchange="getDetails(this.value);getMasterdata(this.value);">
                           ...
                           {
                           <option value="{{ $row_grn->in_code }}">{{ $row_grn->in_code }}</option>
                           }
                           @endforeach
                        </select>
                     </div>
                     ...
                     <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 <select name="item_code[]"  id="item_code" style="width:100px;" required>
                              ...
                              <td>
                                 <select name="part_id[]"  id="part_id" style="width:100px;" required>
                              ...
                              <td>
                                 <select name="shade_id[]"  id="shade_id" style="width:100px;" required>
                              ...
                              <td>
                                 <select name="fcs_id[]"  id="fcs_id" style="width:100px;" required>
                              ...
                              <td>
                                 <select name="defect_id[]"  id="defect_id" style="width:100px;" required>
                                    <option value="">--Fabric Defect--</option>
                              ...
                              <td><input type="text" name="reject_short_meter[]"  value="0" id="reject_short_meter" style="width:80px;"  /></td>
                              <td><input type="text" name="short_meter[]"  value="0" id="reject_short_meter" style="width:80px;" /></td>
                              <td><input type="number" name="shrinkage[]"  value="0" id="shrinkage" style="width:80px;" /></td>
                              <td><input type="text" name="track_code[]"  value="" id="track_code" style="width:80px;" readOnly /></td>
                              <td>
                                 <select name="rack_id[]"  id="rack_id" style="width:100px;" required>
                                    <option value="">--Fabric Status--</option>
...
<script>
    ...
    function SetShrinkage()
    {
        ...
        $('input[name="shrinkage[]"]').val(shrinkage);
    }
