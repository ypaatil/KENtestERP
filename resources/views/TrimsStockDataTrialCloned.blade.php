...
<div class="col-md-6">
   <div class="card mini-stats-wid" style="background-color:#152d9f;" >
      <div class="card-body">
          <form action="/TrimsStockDataTrialCloned" method="GET">
              <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6 mt-4"> 
                        ...
                        <a href="/TrimsStockDataTrialCloned" class="btn btn-warning">Clear</a>
                  </div>
              </div>
          </form>
      </div>
...
<script>
    ...
    function filters(value,row)
    {
        ...
        LoadTrimsStockDataTrialCloned(value);
    }
    ...
    function LoadTrimsStockDataTrialCloned(job_status_id)
    {       
        ...
        $.ajax({
            ...
            {                 
                ...
                const exportTitle = 'Trims Stock Report - (' + formattedDate + ')';
