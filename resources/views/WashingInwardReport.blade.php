...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">Washing Inward Report</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);">Transaction</a></li>
               <li class="breadcrumb-item active">Washing Inward Report</li>
            </ol>
         </div>
      </div>
   </div>
...
<div class="row">
    <div class="col-md-12">
       <div class="card mini-stats-wid">
          <div class="card-body">
              <form action="/WashingInwardReport" method="GET">
                  <div class="row"> 
                      <div class="col-md-3">
                         <div class="mb-3">
                      ...
                      <div class="col-md-3"> 
                         <div class="mt-4">
                            ...
                            <a href="/WashingInwardReport" class="btn btn-warning">Clear</a>
                         </div>
                      </div>
                  </div>
              </form>
                     ...
                     <table id="dt" class="table table-bordered   nowrap w-100">
                         ...
                         <tbody>
                            ...
                            @endphp
                                <tr>
                                   <td>{{$srno++}}</td>
                                   <td>{{date("d-m-Y",strtotime($row->wash_date))}}</td>
