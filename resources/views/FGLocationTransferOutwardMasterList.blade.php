...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">FG Location Transfer Outward List</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);">Transaction</a></li>
               <li class="breadcrumb-item active">FG Location Transfer Outward List</li>
            </ol>
         </div>
      </div>
   </div>
...
<div class="row">
   <div class="col-md-12">
      <a href="{{ Route('FGLocationTransferOutward.create') }}"><button type="button" class="btn btn-primary w-md">Add New Record</button></a>
   </div>
</div>
@endif
   ...
   $(document).on('click','.DeleteRecord',function(e) 
   {
    ...
    $(function () 
    {
       ...
       var table = $('#Transfer_Packing_Inhouse_table').DataTable({
        processing: true,
        serverSide: false,
        ajax: "{{ route('FGLocationTransferOutward.index') }}",
