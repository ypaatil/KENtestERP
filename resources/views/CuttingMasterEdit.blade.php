   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form action="{{ route('FabricCutting.update',$CuttingMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf 
               ...
               <div class="row"> 
                  <div class="col-md-2"> 
                        <input type="hidden" name="cu_date"  class="form-control" id="cu_date" value="{{ $CuttingMasterList->cu_date }}"> 
                     ...
                     <div class="mb-3">
                        ...
                        <select name="table_id" class="form-select" id="table_id" required onchange="getTaskData(this.value);" disabled>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="table_task_code" class="form-select select2" id="table_task_code" required onchange="getCheckMasterData(this.value);" disabled>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="formrow-inputState" class="form-label">CPO Code</label> 
                        <input type="text" name="vpo_code" class="form-control" id="vpo_code" value="{{ $CuttingMasterList->vpo_code }}" readonly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                          ...
                          //DB::enableQueryLog();
                                $List = DB::select("SELECT sales_order_no from vendor_purchase_order_master  where vendor_purchase_order_master.vpo_code='".$CuttingMasterList->vpo_code."'");
                                //dd(DB::getQueryLog());
                               
                          @endphp
                                                
                        <label for="formrow-inputState" class="form-label">Sales Order No</label> 
                        <input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$List[0]->sales_order_no}}" readonly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                     ...
                     <div class="mb-3">
                        <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                           <tbody>
                                ...
                                <tr>
                                     <td><b>Layer</b></td>
                                     <td><input type="date" name="layer_date" value="{{ $CuttingMasterList->layer_date }}" class="form-control" id="layer_date"/></td> 
                                     <td><input type="time" name="layer_start_time" value="{{ $CuttingMasterList->layer_start_time }}" class="form-control"  id="layer_start_time"/></td> 
                                     <td><input type="time" name="layer_end_time" value="{{ $CuttingMasterList->layer_end_time }}" class="form-control"  id="layer_end_time"/></td> 
                                </tr>
                                <tr>
                                     <td><b>Cutting</b></td>
                                     <td><input type="date" name="cutting_date" value="{{ $CuttingMasterList->cutting_date }}" class="form-control"  id="cutting_date"/></td> 
                                     <td><input type="time" name="cutting_start_time" value="{{ $CuttingMasterList->cutting_start_time }}" class="form-control"  id="layer_start_time"/></td> 
                                     <td><input type="time" name="cutting_end_time" value="{{ $CuttingMasterList->cutting_end_time }}" class="form-control"  id="layer_end_time"/></td> 
                                </tr>
                           </tbody>
                        </table>
                     </div>
                  ...
                  <div class="table-wrap">
                     <div class="table-responsive">
                        <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                           ...
                           <tbody id="endData">
                              @if(!empty($CuttingBalanceDetailList))
                              @php $no=1;  @endphp
                              ...
                              <tr class="thisRow">
                                 ...
                                 <td>
                                    <select name="item_codes[]"  id="item_codes@php echo $no; @endphp" style="width:200px;height:30px;" required disabled>
                                 ...
                                 <td>
                                    <select name="shade_ids[]"  id="shade_ids@php echo $no; @endphp" style="width:100px;height:30px;" required disabled>
                                 ...
                                 <td><input type="text" name="actual_balances[]" onkeyup="mycalc();" class="aBalance" id="actual_balances@php echo $no; @endphp" onchange="calculateShortMeter(this);" value="{{ $List->actual_balance }}" style="width:80px;height:30px;"/> </td>
                  ...
                  <div class="table-wrap">
                     <div class="table-responsive">
                        <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                           ...
                           <tbody id="ratioData">
                              @if(!empty($CuttingDetailList)) 
                              @php $no=1;  @endphp
                              @foreach($CuttingDetailList as $List) 
                              @php
                                      $ItemList = DB::SELECT("SELECT * FROM item_master WHERE item_code=".$List->item_code);
                              @endphp
                              <tr class="thisRow">
                                 ...
                                 <td>
                                    <select name="item_code[]"  id="item_code@php echo $no; @endphp" style="width:200px;height:30px;"  required  disabled>
                                       <option value="">--Item List--</option> 
                                       @foreach($ItemList as  $rowitem)
                                       { 
                                       <option value="{{ $rowitem->item_code }}"
                                 ...
                                 <td>
                                    <input type="hidden" name="width[]" id="width@php echo $no; @endphp" value="{{ $List->width }}" style="width:80px;height:30px;"/> 
                                    <input type="hidden" name="meter[]" id="meter@php echo $no; @endphp" value="{{ $List->meter }}" style="width:80px;height:30px;"/> 
                                    <input type="hidden" name="shade_id[]" id="shade_id@php echo $no; @endphp" value="{{ $List->shade_id }}" style="width:80px;height:30px;"/> 
                                    <select name="size_id[]"  id="sz_code@php echo $no; @endphp" style="width:100px;" required disabled>
                                 ...
                                 <td>
                                    <input type="text" name="ratio[]" id="ratio@php echo $no; @endphp" value="{{ $List->ratio }}" style="width:80px;height:30px;" readOnly required/> 
                                 </td>
                                 <td>
                                    <input type="text" name="layers[]" id="layers@php echo $no; @endphp" value="{{ $List->layers }}" style="width:80px;height:30px;" readOnly required/> 
                                 </td>
               ...
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="total_actual_balance" class="form-control" id="total_actual_balance" value="{{ $CuttingMasterList->total_actual_balance }}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
