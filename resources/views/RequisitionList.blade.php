...
<div class="col-md-4">
<a href="{{ Route('requisitionApproval') }}"><button type="buuton" class="btn btn-success w-md">Requisition Approval</button></a>
</div>
</div>
@endif
...
<td>
<a class="btn btn-outline-secondary btn-sm edit" href="{{route('Requisition.edit', $row->requisitionNo)}}" title="Edit">
...
<td>
<button  class="btn btn-outline-secondary btn-sm delete"  data-placement="top" id="DeleteRecord" data-token="{{ csrf_token() }}" data-id="{{ $row->requisitionNo }}"  data-route="{{route('Requisition.destroy', $row->requisitionNo )}}" title="Delete">
