            ...
            <main>
                <div id="printInvoice" class="outer-border">
                    ...
                    <div class="row  border-top border-bottom  g-0">
                        <div class="col-md-6 p-2 border-end">
                            ...
                            <div class="info-row">
                                ...
                                <div class="colon">: </div>
                                <div class="value"> {{ $StitchingInhouseMaster[0]->sti_date }}</div>
                            </div>
                            <div class="info-row">
                        ...
                        <div class="col-md-6 p-2 border-end">
                            <div class="info-row">
                                ...
                                <div class="colon">:</div>
                                <div class="value">{{ $StitchingInhouseMaster[0]->Ac_name }} </div>
                            </div>
                            <div class="info-row">
                    ...
                    <table class="table table-bordered table-sm">
                        ...
                        <tfoot>
                            <tr>
                                <td class="text-end fw-bold" colspan="{{count($SizeDetailList) + 2}}">Total :</td>
