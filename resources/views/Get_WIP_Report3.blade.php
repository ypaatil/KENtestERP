...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Get WIP Report - 1</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            <form action="{{route('rptWIPReportss3')}}" method="GET" enctype="multipart/form-data">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="job_status_id" class="form-label">PO Status</label>
                        <select name="job_status_id[]" class="form-control"  multiple>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tr_date" id="tr_date" value="">
                     </div>
                  </div>
               </div>
               <div class="col-sm-2">
