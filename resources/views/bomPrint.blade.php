...
<td>{{ $rowDataList->color_name }}</td>  
          ...
          @if(isset($rowDataList->s2)) <td style="text-align:right">{{$rowDataList->s2}}</td>@endif
          @if(isset($rowDataList->s3)) <td style="text-align:right">{{$rowDataList->s3}}</td>@endif
          @if(isset($rowDataList->s4)) <td style="text-align:right">{{$rowDataList->s4}}</td>@endif
          @if(isset($rowDataList->s5)) <td style="text-align:right">{{$rowDataList->s5}}</td>@endif
          @if(isset($rowDataList->s6)) <td style="text-align:right">{{$rowDataList->s6}}</td>@endif
          @if(isset($rowDataList->s7)) <td style="text-align:right">{{$rowDataList->s7}}</td>@endif
          @if(isset($rowDataList->s8)) <td style="text-align:right">{{$rowDataList->s8}}</td>@endif
          @if(isset($rowDataList->s9)) <td style="text-align:right">{{$rowDataList->s9}}</td>@endif
          @if(isset($rowDataList->s10)) <td style="text-align:right">{{$rowDataList->s10}}</td>@endif
          @if(isset($rowDataList->s11)) <td style="text-align:right">{{$rowDataList->s11}}</td>@endif
          @if(isset($rowDataList->s12)) <td style="text-align:right">{{$rowDataList->s12}}</td>@endif
          @if(isset($rowDataList->s13)) <td style="text-align:right">{{$rowDataList->s13}}</td>@endif
          @if(isset($rowDataList->s14)) <td style="text-align:right">{{$rowDataList->s14}}</td>@endif
          @if(isset($rowDataList->s15)) <td style="text-align:right">{{$rowDataList->s15}}</td>@endif
          @if(isset($rowDataList->s16)) <td style="text-align:right">{{$rowDataList->s16}}</td>@endif
          @if(isset($rowDataList->s17)) <td style="text-align:right">{{$rowDataList->s17}}</td>@endif
          @if(isset($rowDataList->s18)) <td style="text-align:right">{{$rowDataList->s18}}</td>@endif
          @if(isset($rowDataList->s19)) <td style="text-align:right">{{$rowDataList->s19}}</td>@endif
          @if(isset($rowDataList->s20))  <td style="text-align:right">{{$rowDataList->s20}}</td> @endif
          <td style="text-align:right">{{number_format($rowDataList->size_qty_total)}}</td> 
</tr>
@php
...
<th style="text-align:right;">{{ number_format($sztotal) }}</th>

@endforeach
<th style="text-align:right">{{ number_format($BuyerPurchaseOrderMasterList->total_qty) }}</th>
...
function html_table_to_excel(type)
 {
    ...
    XLSX.writeFile(file, 'BOM('+todaysDate+').' + type);
 }
