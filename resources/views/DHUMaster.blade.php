   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            @if(isset($dhuList))
                 <form action="{{ route('DHU.update',$dhuList) }}" method="POST" id="frmData">
                       @method('put')
                       @csrf 
                       <div class="row">
                          <div class="col-md-3">
        ...
        @else
        <form action="{{route('DHU.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                  <div class="col-md-3">
                     <div class="mb-3">
               ...
               <div class="col-sm-6">
                   <label for="formrow-inputState" class="form-label"></label>
                   <div class="form-group">
                   <button type="submit" class="btn btn-primary w-md" onclick="EnabledFeild()" id="Submit">Submit</button>
                   <a href="{{ Route('DHU.index') }}" class="btn btn-warning w-md">Cancel</a>
                   </div>
               </div>
            </div>
