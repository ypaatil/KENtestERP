                ...
                <div id="printInvoice" class="outer-border">
                        ...
                        <div class="col-md-6 p-2 border-end">
                            <div class="">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="colon">:</div>
                                    <div class="value">
                                        {{ \Carbon\Carbon::parse($BOMList[0]->vw_date)->format('d-m-Y') }}</div>
                    ...
                    <table class="table table-bordered text-1 table-sm second">
                        ...
                        <tbody>
                            ...
                            ->join('item_master', 'item_master.item_code', '=',
                            'vendor_work_order_sewing_trims_details.item_code')
                            ->join('classification_master', 'classification_master.class_id', '=',
                            'vendor_work_order_sewing_trims_details.class_id')
                            ->join('unit_master', 'unit_master.unit_id', '=',
                            'vendor_work_order_sewing_trims_details.unit_id')
                            ->join('bom_sewing_trims_details', function($join) {
                            $join->on('bom_sewing_trims_details.item_code', '=',
                            'vendor_work_order_sewing_trims_details.item_code')
                            ->on('bom_sewing_trims_details.sales_order_no', '=',
                            'vendor_work_order_sewing_trims_details.sales_order_no');
                            })
                            ...
                            $SizeDetailList =
                            App\Models\SizeDetailModel::whereIn('size_id',$size_ids)->get('size_name');
                            $sizes='';
                            foreach($SizeDetailList as $sz)
                            {
                            ...
                            ->where('item_code', $rowDetailtrims->item_code)->where('sales_order_no',
                            $BOMList[0]->sales_order_no)->get();
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    {{ indian_number_format_for_value($rowDetailtrims->totalbom_qty,2)  }}</td>
                                <td class="text-start">
                                    {{ isset($ColorListpacking[0]->remark) ? $ColorListpacking[0]->remark : ''}}</td>
                            </tr>
                            @php
                            $no=$no+1;
                            @endphp
                    ...
                    <div class="row">
                        <div class="col-md-16">
                            <h4 class="mt-2" style="font-size:15px;">Comments :
                                {{isset($BOMList[0]->narration) ? $BOMList[0]->narration : ""}}</h4>
                        </div>
                    </div>
