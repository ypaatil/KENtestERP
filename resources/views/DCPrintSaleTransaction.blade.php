      ...
      <div class="container-fluid invoice-container">
         ...
         <div class="invoice">
            ...
            <main>
               ...
               <center>
                  <h3 class="mb-0"><b>Gate Pass/ Delivery Note</b></h3>
               </center>
               <!-- Item Details -->
               <h4 class="text-4"></h4>
               <div class=""></div>
               ...
               <div id="printInvoice"> 
                  <div class="row" style="border: 1px solid;">
                     <div  class="col-md-4"  style="border: 1px solid;" >
                        <p><b>Challan No: </b>{{$BuyerDetail->sale_code}}</p>
                        <b>Date: </b> {{$BuyerDetail->sale_date}}</br>
                     </div>
                     <div  class="col-md-4"  style="border: 1px solid;">
                     ...
                     <div  class="col-md-4" style="border: 1px solid;"  >
                         <b>To:</b> {{$BuyerDetail->sent_through}}</br></br> 
                        <b>Address:</b>{{$BuyerDetail->sent_address}}</br> 
                     </div>
                  </div>
               </div>
               <!-- Passenger Details -->
