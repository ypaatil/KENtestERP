...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Retrun Packing Inhouse</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            <form action="{{route('ReturnPackingInhouseMaster.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="rpki_date" class="form-label">Entry Date</label>
                        <input type="date" name="rpki_date" class="form-control" id="rpki_date" value="{{date('Y-m-d')}}" required  >
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="sale_code" class="form-control select2" id="sale_code" onchange="GetTaxType(this.value);GetInvoiceWiseSalesOrderList();" >
                           ...
                           {
                           <option value="{{ $row->sale_code }}">{{ $row->sale_code }}</option>
                           }
                           @endforeach
                        </select>
                     </div>
                  ...
                  <input type="hidden" name="tax_type_id" class="form-control" id="tax_type_id" value="0">
                  <input type="hidden" name="vendor_rate" class="form-control" id="vendor_rate" value="0">
                  <div class="col-md-4">
                     <div class="mb-3">
                  ...
                  <input type="hidden" id="is_opening" name="is_opening"  value="0" > 
               </div>
   ...
   <input type="hidden" name="rate" class="form-control" id="rate" value="0">
   <div class="col-md-2">
   <div class="mb-3">
...
<script>
   ...
   {
      var cur_val = $(row).val();
      var total_val = $(row).parent().find('span').text();
   ...
   function getSalesOrderTableOpening(sales_order_no)
   {
         ...
         $.ajax({
           ...
           data:{'tr_code':sales_order_no,'sale_code':sale_code},
           success: function(data){
