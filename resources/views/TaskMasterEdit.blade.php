...
<form action="{{ route('Task.update',$TaskMasterList) }}" method="POST" enctype="multipart/form-data"  id="frmData">
@method('put')
...
<div class="col-md-2">
    <div class="mb-3">
        <label for="job_code" class="form-label">Vendor PO @php echo $TaskMasterList->vpo_code; @endphp</label>
...
<div class="col-md-2">
 ...
 <div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text" name="width" class="form-control" id="width" value="{{ $TaskMasterList->width }}" required>
    </div>
</div>
