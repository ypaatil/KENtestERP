            ...
            <main>
               ...
               <div id="printInvoice">
                  ...
                  <div class="col-md-12" style="border: #000000 solid 1px;">
                     <div class="row">
                         <div  class="col-md-7">
                            <b style="display: inline-block;text-align: left;" class="mt-1">Delivery No:  </b> <span style="display: inline-block;text-align: right;"> {{$vpoCodes1}} </span></br>     
                            <b style="display: inline-block;text-align: left;" class="mt-1">Delivery Date:  </b> <span style="display: inline-block;text-align: right;"> {{ date("d-m-Y", strtotime($VendorPurchaseOrderMaster[0]->vpo_date)) }} </span></br>
                            <b style="display: inline-block;text-align: left;" class="mt-1">From:</b>  <span style="display: inline-block;text-align: left;">{{$from_name}}</span></br>
                            <b style="display: inline-block;text-align: left;" class="mt-1">From Address:</b>  <span style="display: inline-block;text-align: left;"> {{$from_address}}</span></br>
                         </div>
                         <div  class="col-md-5">         
                            <b style="display: inline-block;text-align: left;" class="mt-1">To:</b>  <span style="display: inline-block;text-align: left;">  {{$VendorPurchaseOrderMaster[0]->Ac_name}}</span></br>
                            <b style="display: inline-block;text-align: left;" class="mt-1">To Address:</b>  <span style="display: inline-block;text-align: left;">  {{$VendorPurchaseOrderMaster[0]->address}}</span></br>
                         </div>
                      </div>
                  </div>
               </div>
               ...
               <div class="">
                  <table class="table table-bordered text-1 table-sm data-table" style="height:10vh; ">
                     <thead>
                        <tr>
                           <td colspan="{{count($SizeDetailList) + 3}}"><b>D. No. : </b> {{$vpoCodes[$key]}},     <b>Sales Order No : </b> {{$VendorPurchaseOrderMaster[0]->sales_order_no}},     <b>Style : </b> {{$VendorPurchaseOrderMaster[0]->mainstyle_name}}</td> 
                   ...
                   <div class="col-md-12">
                      <span style="font-size: 18px !important;"><b>Remark : </b>{{$VendorPurchaseOrderMaster[0]->narration}}</span>
                  </div> 
                  <hr/>  
                    @php
                        }
