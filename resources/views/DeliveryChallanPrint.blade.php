            ...
            <main>
               ...
               <div id="printInvoice">
                  ...
                  <div class="col-md-6" style="border: #000000 solid 1px; padding: 16px;">
                       ...
                       <b style="display: inline-block;text-align: left;" class="mt-1">GSTIN NO:</b>    <span style="display: inline-block;text-align: right;">{{$FirmDetail->gst_no}} </span><br/><br/>
                       <b style="display: inline-block;text-align: left;" class="mt-1">Sales Order No:</b>    <span style="display: inline-block;text-align: right;">{{$DeliveryChallanMasterData->sales_order_no}} </span><br/>
                  </div>
                  <div class="col-md-6" style="border: #000000 solid 1px;">
                        <p>
                            <b style="display: inline-block;text-align: left;" class="mt-1">From:  </b> <span style="display: inline-block;text-align: right;"> {{$DeliveryChallanMasterData->vendorName}}  </span>   <br/>
                            <b style="display: inline-block;text-align: left;" class="mt-1">Address:  </b> <span style="display: inline-block;text-align: right;"> {{$DeliveryChallanMasterData->vendorAddress}}  </span>   <br/>
                            ...
                            @php 
                            if($DeliveryChallanMasterData->return_date != "0000-00-00" && $DeliveryChallanMasterData->dc_case_id == 1)
                            {
                            @endphp
