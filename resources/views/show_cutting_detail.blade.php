         ...
         <div class="invoice" id="invoice" >
            ...
            <main>
               ...
               <div id="printInvoice"  style="margin-right:10px;">
                 <h4 class="text-center mt-2" style="color: #000;font-size:20px;font-weight:bold;">CUTTING DETAIL REPORT</h4>  
               <!-- Passenger Details -->
                ...
                <table class="table table-bordered text-1 table-sm" style="height:10vh;">
                  <thead>
                     <tr>
                        ...
                        <th nowrap class="text-center">Color</th>
                  ...
                  <tbody>
                        ...
                        <tr>
                            ...
                            <td nowrap class="text-center">{{$emp->color_name}}</td>
                            <td nowrap>{{$emp->bundleNo}}</td> 
                            <td nowrap class="text-right">{{ number_format($emp->cut_panel_issue_qty, 0, '.', ',')}}</td> 
                        
                        </tr>
                        @php
                            $total_qty1 += $emp->cut_panel_issue_qty;
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.1/jquery.min.js" ></script>
   ...
   <script>  
     ...
     function html_table_to_excel(type)
     {
        ...
        XLSX.writeFile(file, 'Cutting Detail Report.' + type);
      }
