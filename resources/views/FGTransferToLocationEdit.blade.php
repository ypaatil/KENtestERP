...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">FG Transfer To Location Edit</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            @if(isset($FGTransferToLocationList))
            <form action="{{ route('FGTransferToLocation.update',$FGTransferToLocationList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="fgt_date" class="form-label">Entry Date</label>
                        <input type="date" name="fgt_date" class="form-control" id="fgt_date" value="{{$FGTransferToLocationList->fgt_date}}" required>
                        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $FGTransferToLocationList->c_code }}">
                        <input type="hidden" name="endflag" class="form-control" id="endflag" value="{{ $FGTransferToLocationList->endflag }}">
                        <input type="hidden" name="fgt_code" class="form-control" id="fgt_code" value="{{$FGTransferToLocationList->fgt_code}}" readOnly>
                  ...
                  <div class="col-md-1 hide">
                     <div class="mb-3">
                        ...
                        <select name="firm_id" class="form-control" id="firm_id">
                           ...
                           {{ $row->firm_id == $FGTransferToLocationList->firm_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-3">
                     <div class="mb-3">
                        ...
                        <select name="Ac_code" class="form-control" id="Ac_code" required  disabled>
                           ...
                           {{ $row->ac_code == $FGTransferToLocationList->Ac_code ? 'selected="selected"' : '' }} 
                           >{{ $row->ac_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-3">
                     ...
                     <select name="from_loc_id" class="form-select select2" id="from_loc_id" required>
                        ...
                        <option value="{{ $row->loc_id }}" {{ $row->loc_id == $FGTransferToLocationList->from_loc_id ? 'selected="selected"' : '' }} >{{ $row->location }}</option>
                        @endforeach
                     </select>
                  </div>
                  <div class="col-md-3">
                     ...
                     <select name="to_loc_id" class="form-select select2" id="to_loc_id" required>
                        <option value="">--Location--</option>
                        @foreach($LocationList as  $row)
                        <option value="{{ $row->loc_id }}" {{ $row->loc_id == $FGTransferToLocationList->to_loc_id ? 'selected="selected"' : '' }} >{{ $row->location }}</option>
                        @endforeach
                     </select>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="driver_name" class="form-control" id="driver_name" value="{{$FGTransferToLocationList->driver_name}}" >
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="vehical_no" class="form-label">Vehicle No</label>
                        <input type="text" name="vehical_no" class="form-control" id="vehical_no" value="{{$FGTransferToLocationList->vehical_no}}" >
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="mb-5">
                        <label for="po_date" class="form-label">Sales Order No</label>
                        <select name="sales_order_no[]" class="form-control select2" id="sales_order_no" required onChange="getPackingInhouseDetails();"  multiple style="width:100%;height:50%;">
                           <option value="">--Sales Order No--</option>
                           @php $sales_orders = explode(',', $FGTransferToLocationList->sales_order_no);   @endphp
                  ...
                  <input type="hidden" name="mainstyle_id" class="form-control" id="mainstyle_id" value="{{$FGTransferToLocationList->mainstyle_id}}">
                  <input type="hidden" name="substyle_id" class="form-control" id="substyle_id" value="{{$FGTransferToLocationList->substyle_id}}"> 
                  <div class="col-md-2 hide">
                     <div class="mb-3">
                        ...
                        <select name="fg_id" class="form-control" id="fg_id">
                           ...
                           {{ $row->fg_id == $FGTransferToLocationList->fg_id ? 'selected="selected"' : '' }} 
                           >{{ $row->fg_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2 hide">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$FGTransferToLocationList->style_no}}">
                     </div>
                  </div>
                  <div class="col-md-4 hide">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$FGTransferToLocationList->style_description}}">
                     </div>
                  </div>
                  <div class="col-md-2 hide">
                     <div class="mb-3">
                        <label for="order_rate" class="form-label">Order Rate</label>
                        <input type="text" name="order_rate" class="form-control" id="order_rate" value="{{$FGTransferToLocationList->order_rate}}">
                     </div>
                  </div>
               </div>
               <div class="row"  >
                        ...
                        <div class="panel panel-default">
                           ...
                           <div id="collapse1" class="panel-collapse collapse in" style="width:100%;">
                              <div class="panel-body">
                                 <div class="row">
                                    <input type="number" value="{{count($FGTransferToLocationDetailList)}}" name="cntrr1" id="cntrr1" readonly="" hidden="true"/>
                                    <div class="table-wrap">
                                       <div class="table-responsive">
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody id="CartonData">
                                                @if(count($FGTransferToLocationDetailList)>0)
                                                @php $no=1;$n=1; @endphp
                                                @foreach($FGTransferToLocationDetailList as $List) 
                                                <tr>
                                                   <td>{{$no}}</td>
               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$FGTransferToLocationList->total_qty}}" required readOnly>
                     </div>
                  </div>
                  <input type="hidden" name="order_amount" class="form-control" id="order_amount" value="{{$FGTransferToLocationList->order_amount}}" > 
                  <div class="col-sm-8">
                     <label for="formrow-inputState" class="form-label">Narration</label>
                     <div class="mb-3">
                        <input type="text" name="narration" class="form-control" id="narration"  value="{{$FGTransferToLocationList->narration}}" />
                     </div>
                  </div>
               </div>
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                     ...
                     <a href="{{ Route('FGTransferToLocation.index') }}" class="btn btn-warning w-md">Cancel</a>
                  </div>
               </div>
         </div>
         </form>
