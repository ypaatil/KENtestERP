...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18" style="color:#fff;">Inventory Moving/Non-Moving Report</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);" style="color:#fff;">MIS Reports</a></li>
               <li class="breadcrumb-item active" style="color:#fff;">Inventory Moving/Non-Moving Report</li>
            </ol>
         </div>
      </div>
   </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="col-md-12 mb-5"> 
                ...
                <form action="{{ route('InventoryReportMovingNonMoving') }}" method="GET" enctype="multipart/form-data" id="frmData">
                    <div class="row">
                          <div class="col-md-3">
                             <div class="mb-3">
                                <label for="fin_year_id" class="form-label">Financial Year</label>
                                <select name="fin_year_id" class="form-select select2" id="fin_year_id" >
                                   <option>--Select--</option>
                                   @foreach($Financial_Year1 as  $row) 
                                        <option value="{{ $row->fin_year_id }}" {{ $row->fin_year_id == $fin_year_id ? 'selected="selected"' : '' }}>{{ $row->fin_year_name }}</option> 
                                   @endforeach
                                </select>
                             </div>
                          </div>
                         <div class="col-md-2 mt-4">
                              ...
                              <a href="{{ Route('InventoryReportMovingNonMoving') }}" class="btn btn-warning w-md">Cancel</a>
                         </div>
                         <div class="col-md-2 mt-4 text-center">
                            <a  href="javascript:void(0);" id="generatePDF" class="button_niks btn  btn-info"> PDF</a>
...
<script>
   ...
   function calculateGrandTotal() 
   {
        ...
        $("#tablefoot").html(GrandTotalHtml+NonMovingTotalHtml+PerNonMovingTotalHtml);
    } 
