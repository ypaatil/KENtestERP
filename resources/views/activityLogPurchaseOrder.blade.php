...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">Purchase Order Activity Log</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);">MIS Reports</a></li>
               <li class="breadcrumb-item active">Purchase Order Activity Log</li>
            </ol>
         </div>
      </div>
   </div>
...
<div class="row">
  ...
  <div class="search-bar">
    ...
    <div class="accordion-item animated slideInRight">
          <label class="accordion-header">Purchase  Order<span></span></label>
          <div class="accordion-body">

     <div class="table-responsive">         
<table class="table table-bordered" id="activityLogSO">

   @include('partials.change_purchase_order')
...
$(document).on('click', '#activityLogSO .pagination a', function(e) {
    e.preventDefault();
