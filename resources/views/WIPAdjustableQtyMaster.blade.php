   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            <form action="{{route('WIPAdjustableQty.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="WIPAQ_date" class="form-label">Entry Date</label>
                        <input type="date" name="WIPAQ_date" class="form-control" id="WIPAQ_date" value="{{date('Y-m-d')}}" required  >
