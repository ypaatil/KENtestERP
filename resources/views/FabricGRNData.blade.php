         ...
         let skipFooterForNextDraw = false;
          var table = $('#dt').DataTable({
            ...
            columns: [
                  ...
                  {data: 'item_code', name: 'item_code', className: 'textallalignright'},
                  ...
                  {data: 'dimension', name: 'dimension' , className: 'textallalignright'},
                  {data: 'quality_name', name: 'quality_name'},
                  {data: 'color_name', name: 'color_name' , className: 'textallalignright'},
