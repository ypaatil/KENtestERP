...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">Order Progress Packing Detail Dashboard</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);">Transaction</a></li>
               <li class="breadcrumb-item active">Order Progress Packing Detail Dashboard</li>
            </ol>
         </div>
      </div>
   </div>
...
<div class="row">
   <div class="col-12">
       <div class="card-body">
              <form action="/OrderProgressPackingDetailDashboard" method="GET">
                  <div class="row">  
                       <div class="col-md-3">
                         <div class="mb-3">
                       ...
                       <div class="col-md-3 mt-4"> 
                            ...
                            <a href="/OrderProgressPackingDetailDashboard" class="btn btn-warning">Clear</a>
                       </div>
                  </div>
              </form>
          </div>
               ...
               <table id="dt" class="table table-bordered">
                  <thead>
                     <tr style="text-align:center">
                        ...
                        <th rowspan="2">Packing Order No</th>
         ...
         var currentURL = window.location.href; 
          ...
          var table = $('#dt').DataTable({
            ...
            columns: [
                    ...
                    {data: 'total_packing_qty', name: 'total_packing_qty', className: 'text-right nowrap'},
                    {data: 'bal_total_packing_qty', name: 'bal_total_packing_qty', className: 'text-right nowrap'}
                ]
