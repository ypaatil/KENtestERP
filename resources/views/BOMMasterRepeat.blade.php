...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">BOM Repeat</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            <form action="{{route('BOMRepeatStore')}}" method="POST" enctype="multipart/form-data" id="frmData" >
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <!--<input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value=""  onfocusout="getSalesOrderDetails(this.value);">-->
                        <select name="sales_order_no" class="form-control select2" id="sales_order_no" onChange="getSalesOrderDetails(this.value);">
                  ...
                  <div class="col-md-2 hide">
                     <div class="mb-3">
                        ...
                        <input type="number" step="any" name="order_rate" class="form-control" id="order_rate" value="{{$BOMMasterList->order_rate}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <div class="panel-group" id="accordion"> 
                                             ...
                                             <table id="footable_1" class="table  table-bordered  m-b-0  footable_1">
                                                ...
                                                <tbody id="fabricBody">
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td><input type="number" step="any"  max="{{$List->bom_qty}}"  name="bom_qty[]" value="{{$List->bom_qty}}" id="bom_qty" style="width:80px; height:30px;" readOnly/>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0" max="0" @endif name="wastage[]" value="0" id="wastage" style="width:80px; height:30px;"  /></td>
                                                      <td>
                                                          <input type="number" step="any"  name="bom_qty[]" value="0" id="bom_qty" style="width:80px; height:30px;" readOnly />
                           ...
                           <div class="panel panel-default">
                              ...
                              <div id="collapse5" class="panel-collapse collapse">
                                 <div class="panel-body">
                                    <div class="row">
                                       <input type="number" value="1" name="cntrr5" id="cntrr5" hidden="true"  />
                                       <div class="table-wrap">
                                          <div class="table-responsive">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         ...
                                                         <input type="hidden" name="color_arraysx[]" value="{{$List->color_id}}" id="color_arraysx" style="width:80px; height:30px;" />
                                                      </td>
                                                      <td>
                                                      ...
                                                      <td><input type="number" step="any"  name="wastagesx[]" value="{{$List->wastage}}" id="wastagesx" style="width:80px; height:30px;" /></td>
                                                      <td><input type="number" step="any" name="bom_qtysx[]" value="{{$List->bom_qty}}" id="bom_qtysx" style="width:80px; height:30px;" readOnly/> 
                           ...
                           <div class="panel panel-default">
                              ...
                              <div id="collapse2" class="panel-collapse collapse">
                                 <div class="panel-body">
                                    <div class="row">
                                       <input type="number" value="{{count($SewingTrimsList) }}" name="cntrr2" id="cntrr2" hidden="true"  />
                                       <div class="table-wrap">
                                          <div class="table-responsive">
                                             <table id="footable_3" class="table  table-bordered  m-b-0  footable_3">
                                                ...
                                                <tbody id="sewingBody">
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <select name="item_codes[]" onchange="checkDuplicateItemGeneric(this, 'footable_3', 'item_codes[]')" class="select2" id="item_codes" style="width:270px; height:30px;" >
                                                         <option value="">--Item List--</option>
                                                      ...
                                                      <td>
                                                         ...
                                                         <input type="hidden"  name="size_arrays[]" value="{{$List->size_array}}" id="size_arrays" style="width:80px; height:30px;"/>
                                                      </td>
                                                      <td><input type="number" step="any"  min="0" name="consumptions[]"  value="{{$List->consumption}}" id="consumptions" style="width:80px; height:30px;" /></td>
                                                      <td>
                                                      ...
                                                      <td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0"   @endif   name="rate_per_units[]" value="{{$List->rate_per_unit}}" id="rate_per_units" style="width:80px; height:30px;"/></td>
                                                      <td><input type="number" step="any"  name="wastages[]" value="{{$List->wastage}}" id="wastages" style="width:80px; height:30px;" /></td>
                                                      <td><input type="number" step="any"  @if(Session::get('user_type')!=1) min="0"   @endif name="bom_qtys[]" value="{{$List->bom_qty}}" id="bom_qtys" style="width:80px; height:30px;" readOnly/>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <select name="item_codes[]" class="item_sewing_trims select2"  onchange="checkDuplicateItemGeneric(this, 'footable_3', 'item_codes[]')" id="item_codes" style="width:270px; height:30px;" >
                                                         <option value="">--Item List--</option>
                                                         @foreach($ItemList2 as  $row)
                                                         {
                                                      ...
                                                      <td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0"   @endif  name="consumptions[]" value="0" id="consumptions" style="width:80px; height:30px;" /></td>
                                                      <td>
                                                         <select name="unit_ids[]" class=" " id="unit_ids" style="width:100px; height:30px;"  disabled>
                                                            <option value="">--Unit List--</option>
                                                            @foreach($UnitList as  $row)
                                                      ...
                                                      <td><input type="number" step="any" @if(Session::get('user_type')!=1)  min="0"   @endif  name="rate_per_units[]" value="0" id="rate_per_units" style="width:80px; height:30px;" /></td>
                                                      <td><input type="number" step="any" name="wastages[]" value="0" id="wastages" style="width:80px; height:30px;"  /></td>
                                             ...
                                             <table id="footable_4" class="table  table-bordered  m-b-0  footable_4">
                                                ...
                                                <tbody id="packingBody">
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <select name="item_codess[]" onchange="checkDuplicateItemGeneric(this, 'footable_4', 'item_codess[]')" class="item_packing_trims id select2" id="item_codess" style="width:270px; height:30px;">
                                                         <option value="">--Item List--</option>
                                                      ...
                                                      <td>
                                                         ...
                                                         <input type="hidden" name="color_arrayss[]" value="{{$List->color_id}}" id="color_arrayss" style="width:80px; height:30px;"  />
                                                      </td>
                                                      <td>
                                                         ...
                                                         <input type="hidden" name="size_arrayss[]" value="{{$List->size_array}}" id="size_arrayss" style="width:80px; height:30px;"/>
                                                      </td>
                                                      <td><input type="number" step="any" @if(Session::get('user_type')!=1)  min="0"  @endif name="consumptionss[]" value="{{$List->consumption}}" id="consumptionss" style="width:80px; height:30px;" /></td>
                                                      <td>
                                                      ...
                                                      <td><input type="number" step="any"  @if(Session::get('user_type')!=1) min="0" @endif name="rate_per_unitss[]" value="{{$List->rate_per_unit}}" id="rate_per_unitss" style="width:80px; height:30px;" /></td>
                                                      <td><input type="number" step="any" name="wastagess[]" value="{{$List->wastage}}" id="wastagess" style="width:80px; height:30px;"  /></td>
                                                      <td><input type="number" step="any"  @if(Session::get('user_type')!=1) min="0"  @endif  name="bom_qtyss[]" value="{{$List->bom_qty}}" id="bom_qtyss" style="width:80px; height:30px;" readOnly/>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <select name="item_codess[]" class="item_packing_trims select2" onchange="checkDuplicateItemGeneric(this, 'footable_4', 'item_codess[]')" id="item_codess" style="width:270px; height:30px;" >
                                                            <option value="">--Item List--</option>
                                                            @foreach($ItemList3 as  $row)
                                                            {
                                                            <option value="{{ $row->item_code }}">({{$row->item_code}}) {{ $row->item_name }}</option>
                                                      ...
                                                      <td>
                                                         ...
                                                         <input type="hidden" name="color_arrayss[]" value="0" id="color_arrayss" style="width:80px; height:30px;"  />
                                                      </td>
                                                      <td>
                                                         <select name="size_idss[][]"   id="size_idss" style="width:200px; height:140px;" multiple>
                                                            <option value="">--Size List--</option>
                                                         ...
                                                         <input type="hidden" name="size_arrayss[]" value="0" id="size_arrayss" style="width:80px; height:30px;"  />
                                                      </td>
                                                      <td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0"  @endif  name="consumptionss[]" value="0" id="consumptionss" style="width:80px; height:30px;" /></td>
                                                      <td>
                                                         <select name="unit_idss[]"   id="unit_idss" style="width:100px; height:30px;"  disabled>
                                                            <option value="">--Unit List--</option>
                                                            @foreach($UnitList as  $row)
                                                      ...
                                                      <td><input type="number" step="any" @if(Session::get('user_type')!=1) min="0"  @endif name="rate_per_unitss[]" value="0" id="rate_per_unitss" style="width:80px; height:30px;"/></td>
                                                      <td><input type="number" step="any"  name="wastagess[]" value="0" id="wastagess" style="width:80px; height:30px;"  /></td>
                  ...
                  <div class="row">
                     <div class="col-md-2">
                        <div class="mb-3">
                           ...
                           <input type="text" name="fabric_value" class="form-control" id="fabric_value" value="{{ $BOMMasterList->fabric_value }}"   readOnly>
                        </div>
                     </div>
                     <div class="col-md-2">
                        <div class="mb-3">
                           <label for="po_date" class="form-label">Sewing Trims Cost</label>
                           <input type="text" name="sewing_trims_value" class="form-control" id="sewing_trims_value" value="{{ $BOMMasterList->sewing_trims_value }}"  readOnly >
                        </div>
                     </div>
                     <div class="col-md-2">
                        <div class="mb-3">
                           <label for="po_date" class="form-label">Packing Trims Cost</label>
                           <input type="text" name="packing_trims_value" class="form-control" id="packing_trims_value" value="{{ $BOMMasterList->packing_trims_value }}"  readOnly >
                        </div>
                     </div>
                     <div class="col-md-2">
                        <div class="mb-3">
                           <label for="po_date" class="form-label">Total Cost</label>
                           <input type="text" name="total_cost_value" class="form-control" id="total_cost_value" value="{{ $BOMMasterList->total_cost_value }}"  readOnly>
                        </div>
                     </div>
                     @php  
...
//   }); 
   ...
   {   
    ...
    $(document).on("click", 'input[name^="Fbutton[]"]', function (event) {
        ...
        $clonedRow.find('select').attr("disabled", false);
        $clonedRow.find('input').attr("readonly", false);
        $clonedRow.find('textarea').attr("readonly", false);
        $clonedRow.find('select[name="item_code[]"]').attr("onchange", "CheckDuplicateItemForFabric(this);");
