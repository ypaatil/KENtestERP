...
@section('content')   
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <table data-order='[[ 0, "desc" ]]' data-page-length='25' id="datatable-buttons" class="example table table-bordered dt-responsive nowrap w-100">
                                          <thead>
                                            ...
                                            @php  
                                                $List = DB::select("SELECT sales_order_no from vendor_purchase_order_master  where vendor_purchase_order_master.vpo_code='".$row->vpo_code."'");
                                            @endphp
                                ...
                                @endif
                                       <td>
                                                <a class="btn btn-outline-warning btn-sm print" href="FabricCuttingPrint/{{$row->cu_code}}" title="Print">
