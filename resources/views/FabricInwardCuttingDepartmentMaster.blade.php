...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">Fabric Inward-Cutting Department</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);">Transaction</a></li>
               <li class="breadcrumb-item active">Fabric Inward - Cutting Department</li>
            </ol>
         </div>
      </div>
   </div>
...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Fabric Inward - Cutting Department</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            <form action="{{route('FabricInwardCuttingDepartment.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="ficd_date" class="form-label">Date</label>
                        <input type="date" name="ficd_date" class="form-control" id="ficd_date" value="{{date('Y-m-d')}}" required>
                        @foreach($counter_number as  $row)
                        <input type="hidden" name="ficd_code" class="form-control" id="ficd_code" value="{{ 'FICD'.$row->tr_no }}"> 
                        @endforeach
                     ...
                     <div class="mb-3">
                        ...
                        <select name="dc_no" class="form-select select2" id="dc_no" onchange="GetFabricOutwardData();">
                           ...
                           @foreach($foutList as $row)
                                <option value="{{$row->fout_code}}">{{$row->fout_code}}</option>
                           @endforeach
                        </select>
                     </div>
                  </div>
