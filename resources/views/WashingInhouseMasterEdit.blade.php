...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Washing Inhouse</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            @if(isset($WashingInhouseMasterList))
            <form action="{{ route('WashingInhouse.update',$WashingInhouseMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="wash_date" class="form-label">Entry Date</label>
                        <input type="date" name="wash_date" class="form-control" id="wash_date" value="{{$WashingInhouseMasterList->wash_date}}" required  >
                        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $WashingInhouseMasterList->c_code }}">
                        <input type="hidden" name="wash_code" class="form-control" id="wash_code" value="{{$WashingInhouseMasterList->wash_code}}" required readOnly>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="process_id" class="form-control" id="process_id" required> 
                           ...
                           {{ $row->process_id == $WashingInhouseMasterList->process_id ? 'selected="selected"' : '' }} 
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="vpo_code" class="form-control select2" id="vpo_code" required  onChange="getVendorProcessOrderDetails(this.value);" disabled>
                           ...
                           {{ $row->vpo_code == $WashingInhouseMasterList->vpo_code ? 'selected="selected"' : '' }} 
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$WashingInhouseMasterList->sales_order_no}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="Ac_code" class="form-control select2" id="Ac_code" required  disabled>
                           ...
                           {{ $row->ac_code == $WashingInhouseMasterList->Ac_code ? 'selected="selected"' : '' }} 
                           >{{ $row->ac_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="mainstyle_id" class="form-control" id="mainstyle_id"  onchange="getSubStyle(this.value)" required disabled>
                           ...
                           {{ $row->mainstyle_id == $WashingInhouseMasterList->mainstyle_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="substyle_id" class="form-control" id="substyle_id" onchange="getStyle(this.value)" required disabled>
                           ...
                           {{ $row->substyle_id == $WashingInhouseMasterList->substyle_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$WashingInhouseMasterList->style_no}}" required readOnly>
                     </div>
                  </div> 
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="vendorId" class="form-control" id="vendorId" disabled >
                           ...
                           {{  $rowvendor->ac_code == $WashingInhouseMasterList->vendorId ? 'selected="selected"' : '' }}
                        ...
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title">
                                 <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Finishing Entry</a>
                              </h4>
                           </div>
                                    ...
                                    <div class="table-wrap">
                                       <div class="table-responsive">
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                @if(count($WashingInhouseDetailList)>0)
                                                @php $no=1;$n=1; @endphp
                                                @foreach($WashingInhouseDetailList as $List) 
                                                <tr>
                                                   ...
                                                   <td>
                                                      ...
                                                      <select name="color_id[]"   id="color_id" style="width:250px; height:30px;" disabled>
                                                   ...
                                                   <td ><input style="width:80px; float:left;"  name="s@php echo $n; @endphp[]" class="size_id" type="number" max="{{$szQty}}" id="s@php echo $n; @endphp" value="{{$szQty}}" required />  </td>
                                                   @php $n=$n+1;  @endphp
                                                   @endforeach
               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$WashingInhouseMasterList->total_qty}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="vendor_amount" class="form-label">Total Amount</label>
                        <input type="text" name="vendor_amount" class="form-control" id="vendor_amount" value="{{$WashingInhouseMasterList->vendor_amount}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-sm-8">
                     <label for="formrow-inputState" class="form-label">Narration</label>
                     <div class="mb-3">
                        <input type="text" name="narration" class="form-control" id="narration"  value="{{$WashingInhouseMasterList->narration}}" />
                     </div>
                  </div>
               </div>
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                     ...
                     <a href="{{ Route('WashingInhouse.index') }}" class="btn btn-warning w-md">Cancel</a>
                  </div>
               </div>
         </div>
         </form>
...
<!-- end row -->
<!-- end row -->
<input type="hidden" id="vendor_rate" value="0">
         ...
         $("#footable_2 tr td  input[class='size_id']").each(function()
         {
             ...
             { 
                   ...
                   else
                   {
                        ...
                        $(current_size).val(0);
                        $(this).closest("tr").find('input[name="size_qty_total[]"]').val("");
                        $(this).closest("tr").find('input[name="size_qty_array[]"]').val("");
                   }
