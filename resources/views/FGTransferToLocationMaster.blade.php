...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">FG Transfer To Location</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            <form action="{{route('FGTransferToLocation.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="vpo_date" class="form-label">Entry Date</label>
                        <input type="date" name="fgt_date" class="form-control" id="fgt_date" value="{{date('Y-m-d')}}" required>
                  ...
                  <div class="col-md-6">
                     <div class="mb-5">
                        ...
                        <select name="sales_order_no[]" class="form-control select2" id="sales_order_no" required  onChange="getPackingInhouseDetails();" multiple disabled>
