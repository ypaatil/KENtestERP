...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Get WIP Report - 2</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            <form action="{{route('rptWIPReport2')}}" method="POST" enctype="multipart/form-data">
               @csrf 
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="job_status_id" class="form-label">Date</label>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="order_type" class="form-select select2"  id="order_type" >
                           <option value="0">--All--</option>
