            ...
            <main>
               ...
               <table class="table table-bordered text-1 table-sm" id="Summary" style="height:10vh; ">
                  ...
                  <tbody>
                     ...
                     DB::raw('(select ifnull(sum(packing_inhouse_detail.size_qty_total),0) from packing_inhouse_detail
                     INNER JOIN packing_inhouse_master ON packing_inhouse_master.pki_code = packing_inhouse_detail.pki_code
                     where packing_inhouse_detail.sales_order_no=buyer_purchase_order_detail.tr_code and
                     packing_inhouse_detail.color_id=buyer_purchase_order_detail.color_id AND packing_inhouse_master.packing_type_id = 2) as rtv_qty'),
                     
                     DB::raw("(SELECT sum(size_qty) FROM FGStockDataByTwo WHERE data_type_id = 2  AND 
                                invoice_no IS NOT NULL AND is_sale =0 AND sales_order_no = buyer_purchase_order_detail.tr_code AND color_id =buyer_purchase_order_detail.color_id) as invoice_qty"))
                     ...
                     @php
                        ...
                        $OutwardForPackingData = DB::select("SELECT sum(size_qty_total) as outward_for_packing_qty from outward_for_packing_detail WHERE sales_order_no = '".$List->tr_code."' AND color_id = '".$List->color_id."'");
                        $outward_for_packing_qty = isset($OutwardForPackingData[0]->outward_for_packing_qty) ? $OutwardForPackingData[0]->outward_for_packing_qty : 0;
                     @endphp
                     <tr>
                        ...
                        <td style="text-align: right;">{{number_format($WashingData[0]->wash_qty)  }}</td>
                        <td style="text-align: right;">{{number_format($outward_for_packing_qty)  }}</td>
                        <td style="text-align: right;">{{number_format($List->packing_order_qty-$List->rtv_qty)  }}</td>
                        <td style="text-align: right;">{{number_format($List->rtv_qty)  }}</td>
                        <td style="text-align: right;">{{number_format($List->cut_order_qty - $List->packing_order_qty + $List->rtv_qty - $reject_qty)  }}</td>
                        ...
                        <td style="text-align: right;">{{$List->pass_order_qty - $List->invoice_qty + $List->rtv_qty}}</td>
               ...
               <div class="">
                  ...
                  <table class="table table-bordered text-1 table-sm" style="height:10vh; ">
                     ...
                     <tbody>
                        ...
                        color_master.color_id=stitching_inhouse_size_detail.color_id where sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."' 
                       ...
                       // dd(DB::getQueryLog());
                        ...
                        color_master.color_id=qcstitching_inhouse_size_detail.color_id where sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."' 
                        ...
                        color_master.color_id=qcstitching_inhouse_size_reject_detail.color_id where sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."' 
                        ...
                        <tr>
                         ...
                         @endphp
                           <td style="text-align: right;">{{isset($rej_qty) ? $rej_qty : 0}}</td>
                           @endforeach
                        ...
                        $sizex=rtrim($sizex,',');
                         ...
                         //DB::enableQueryLog();
                        $WashingOutDataList = DB::select("SELECT vendor_purchase_order_size_detail.color_id,vendor_purchase_order_size_detail.size_array, color_name
                               from vendor_purchase_order_size_detail inner join color_master on 
                              color_master.color_id=vendor_purchase_order_size_detail.color_id where sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."' AND vendor_purchase_order_size_detail.process_id=4");
                        
                         // dd(DB::getQueryLog());
                        if(count($WashingOutDataList) > 0)
                        {
                            $washing_qty = explode(",", $WashingOutDataList[0]->size_array);
                        }
                        else
                        {
                           $washing_qty = 0;
                        ...
                        @endphp      
                        <tr>
                           <td><b>Washing Outward Qty</b></td>
                           @foreach($washing_qty as $val => $key)
                           @php
                       
                            //DB::enableQueryLog();

                            $washOutData = DB::select("SELECT sum(vendor_purchase_order_size_detail2.size_qty) as wash_outward_qty from  vendor_purchase_order_size_detail2  
                                WHERE vendor_purchase_order_size_detail2.sales_order_no = '".$List->tr_code."' 
                                AND vendor_purchase_order_size_detail2.color_id=".$List->color_id." AND vendor_purchase_order_size_detail2.size_id='".$key."' AND vendor_purchase_order_size_detail2.process_id=4");
                            // dd(DB::getQueryLog());  
                                if(count($washOutData) > 0)
                                {
                                    $wash_out_qty = $washOutData[0]->wash_outward_qty;
                                }
                                else
                                {
                                   $wash_out_qty = 0;
                                ...
                                $washOutTotal =  $washOutTotal + $wash_out_qty;
                         @endphp
                           <td style="text-align: right;">{{isset($wash_out_qty) ? $wash_out_qty : 0}}</td>
                           @endforeach
                           <td style="text-align: right;">{{$washOutTotal}}</td>
                        </tr>
                        ...
                        $sizex=rtrim($sizex,',');
                         ...
                         //DB::enableQueryLog();
                        $WashingDataList = DB::select("SELECT washing_inhouse_size_detail.color_id,washing_inhouse_size_detail.size_array, color_name
                               from washing_inhouse_size_detail inner join color_master on 
                              color_master.color_id=washing_inhouse_size_detail.color_id where sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."'");
                        
                         // dd(DB::getQueryLog());
                        if(count($WashingDataList) > 0)
                        {
                            $washing_qty = explode(",", $WashingDataList[0]->size_array);
                        }
                        else
                        {
                           $washing_qty = 0;
                        ...
                        @endphp      
                        <tr>
                           <td><b>Washing Inward Qty</b></td>
                           @foreach($washing_qty as $val => $key)
                           @php
                       
                            //DB::enableQueryLog();

                            $washData = DB::select("SELECT sum(washing_inhouse_size_detail2.size_qty) as wash_qty from  washing_inhouse_size_detail2  
                                WHERE washing_inhouse_size_detail2.sales_order_no = '".$List->tr_code."' 
                                AND washing_inhouse_size_detail2.color_id=".$List->color_id." AND washing_inhouse_size_detail2.size_id='".$key."'");
                            // dd(DB::getQueryLog());  
                                if(count($washData) > 0)
                                {
                                    $wash_qty = $washData[0]->wash_qty;
                                }
                                else
                                {
                                   $wash_qty = 0;
                                ...
                                $washTotal =  $washTotal + $wash_qty;
                         @endphp
                           <td style="text-align: right;">{{isset($wash_qty) ? $wash_qty : 0}}</td>
                           @endforeach
                           <td style="text-align: right;">{{$washTotal}}</td>
                        </tr>
                        ...
                        $sizex=rtrim($sizex,',');
                        $OutwardMasterdataList = DB::select("SELECT outward_for_packing_size_detail.color_id, color_name, ".$sizex.", 
                        ifnull(sum(size_qty_total),0) as size_qty_total  from outward_for_packing_size_detail inner join color_master on 
                        color_master.color_id=outward_for_packing_size_detail.color_id where sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."' 
                        and outward_for_packing_size_detail.color_id='".$List->color_id."'
                        group by outward_for_packing_size_detail.color_id");
                        if(count($OutwardMasterdataList)!=0){
                        @endphp      
                        <tr>
                           <td><b>Outward For Packing Qty</b></td>
                           @if(isset($OutwardMasterdataList[0]->s_1)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_1)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_2)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_2)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_3)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_3)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_4)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_4)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_5)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_5)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_6)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_6)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_7)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_7)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_8)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_8)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_9)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_9)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_10)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_10)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_11)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_11)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_12)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_12)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_13)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_13)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_14)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_14)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_15)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_15)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_16)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_16)}}</td>
                           @endif 
                           @if(isset($OutwardMasterdataList[0]->s_17)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_17)}}</td>
                           @endif 
                           @if(isset($OutwardMasterdataList[0]->s_18)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_18)}}</td>
                           @endif
                           @if(isset($OutwardMasterdataList[0]->s_19)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_19)}}</td>
                           @endif 
                           @if(isset($OutwardMasterdataList[0]->s_20)) 
                           <td style="text-align: right;">{{number_format($OutwardMasterdataList[0]->s_20)}}</td>
                           @endif
                           <td style="text-align: right;">{{ $OutwardMasterdataList[0]->size_qty_total }}</td>
                        </tr> 
                        @php
                        }
                        $sizex='';
                        ...
                        $MasterdataList = DB::select("SELECT packing_inhouse_size_detail.color_id, color_name, ".$sizex.", 
                            ...
                            color_master.color_id=packing_inhouse_size_detail.color_id where sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."'  
                            and packing_inhouse_size_detail.color_id='".$List->color_id."'
                            group by packing_inhouse_size_detail.color_id");
                        
                        $MasterdataList1234 = DB::select("SELECT packing_inhouse_size_detail.color_id, color_name, ".$sizex.", 
                            ...
                            inner join color_master on color_master.color_id=packing_inhouse_size_detail.color_id where packing_inhouse_size_detail.sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."'  
                            and packing_inhouse_size_detail.color_id='".$List->color_id."' AND packing_inhouse_master.packing_type_id = 2
                            group by packing_inhouse_size_detail.color_id");
                        ...
                        <tr>
                            ...
                            @for($i = 1; $i <= 20; $i++)
                                @php
                                    $masterVal = $MasterdataList[0]->{"s_$i"} ?? null;
                                    $subVal = isset($MasterdataList1234[0]) ? ($MasterdataList1234[0]->{"s_$i"} ?? 0) : 0;
                                @endphp
                                @if(!is_null($masterVal))
                                    <td style="text-align: right;">{{ number_format($masterVal - $subVal) }}</td>
                                @endif
                            @endfor
                        
                            @php
                                $totalMaster = $MasterdataList[0]->size_qty_total ?? 0;
                                $totalSub = isset($MasterdataList1234[0]) ? ($MasterdataList1234[0]->size_qty_total ?? 0) : 0;
                            @endphp
                            <td style="text-align: right;">{{ $totalMaster - $totalSub }}</td>
                        </tr>
                        @php
                        }
                        $sizex='';
                        ...
                        $sizex=rtrim($sizex,',');
                        $MasterdataList5 = DB::select("SELECT packing_inhouse_size_detail.color_id, color_name, ".$sizex.", 
                        ifnull(sum(size_qty_total),0) as size_qty_total  from packing_inhouse_size_detail
                        inner join packing_inhouse_master ON packing_inhouse_master.pki_code = packing_inhouse_size_detail.pki_code
                        inner join color_master on 
                        color_master.color_id=packing_inhouse_size_detail.color_id where packing_inhouse_size_detail.sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."'  
                        and packing_inhouse_size_detail.color_id='".$List->color_id."' AND packing_inhouse_master.packing_type_id = 2
                        group by packing_inhouse_size_detail.color_id");
                        if(count($MasterdataList5)!=0){
                        @endphp      
                        <tr>
                           <td><b>RTV Qty</b></td>
                           @if(isset($MasterdataList5[0]->s_1)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_1)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_2)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_2)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_3)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_3)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_4)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_4)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_5)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_5)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_6)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_6)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_7)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_7)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_8)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_8)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_9)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_9)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_10)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_10)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_11)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_11)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_12)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_12)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_13)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_13)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_14)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_14)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_15)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_15)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_16)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_16)}}</td>
                           @endif 
                           @if(isset($MasterdataList5[0]->s_17)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_17)}}</td>
                           @endif 
                           @if(isset($MasterdataList5[0]->s_18)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_18)}}</td>
                           @endif
                           @if(isset($MasterdataList5[0]->s_19)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_19)}}</td>
                           @endif 
                           @if(isset($MasterdataList5[0]->s_20)) 
                           <td style="text-align: right;">{{number_format($MasterdataList5[0]->s_20)}}</td>
                           @endif
                           <td style="text-align: right;">{{ $MasterdataList5[0]->size_qty_total }}</td>
                        </tr>
                        @php
                        }
                        $sizexx='';
                        ...
                        ifnull(sum(size_qty_total),0) as size_qty_total  from cut_panel_grn_size_detail inner join color_master on 
                        color_master.color_id=cut_panel_grn_size_detail.color_id where sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."'
                        and cut_panel_grn_size_detail.color_id='".$List->color_id."'
                        group by cut_panel_grn_size_detail.color_id");
                       ...
                       $RejectDataList =  DB::select("SELECT qcstitching_inhouse_size_reject_detail.color_id, color_name, ".$sizesss.", 
                            ifnull(sum(size_qty_total),0) as size_qty_total  from qcstitching_inhouse_size_reject_detail inner join color_master on 
                            color_master.color_id=qcstitching_inhouse_size_reject_detail.color_id where sales_order_no='".$Buyer_Purchase_Order_List[0]->tr_code."' 
                            and qcstitching_inhouse_size_reject_detail.color_id='".$List->color_id."'
                            group by qcstitching_inhouse_size_reject_detail.color_id"); 
                        ...
                        $RTVDataList =  DB::select("select ifnull(sum(packing_inhouse_detail.size_qty_total),0) as size_qty_total from packing_inhouse_detail
                                 INNER JOIN packing_inhouse_master ON packing_inhouse_master.pki_code = packing_inhouse_detail.pki_code
                                 where packing_inhouse_detail.sales_order_no = '".$Buyer_Purchase_Order_List[0]->tr_code."' and
                                 packing_inhouse_detail.color_id='".$List->color_id."' AND packing_inhouse_master.packing_type_id = 2");
                                 
                       //print_r($List21);exit; 
                        if(count($MasterdataList1) > 0 )
                        {
                       
                            if(isset($MasterdataList1[0]->s_1)) { $s1=0;}
                            //if(isset($MasterdataList1[0]->s_1)) { $s1=((intval(isset($MasterdataList1[0]) ?   $MasterdataList1[0]->s_1 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s1 : 0))-(intval(isset($List21[0]) ? $List21[0]->s1 : 0)));}
                            if(isset($MasterdataList1[0]->s_2)) { $s2=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_2 : 0  ))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s2 : 0))-(intval(isset($List21[0]) ? $List21[0]->s2 : 0)));}
                            if(isset($MasterdataList1[0]->s_3)) { $s3=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_3 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s3 : 0))-(intval(isset($List21[0]) ? $List21[0]->s3 : 0)));}
                            if(isset($MasterdataList1[0]->s_4)) { $s4=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_4 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s4 : 0))-(intval(isset($List21[0]) ? $List21[0]->s4 : 0)));}
                            if(isset($MasterdataList1[0]->s_5)) { $s5=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_5 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s5 : 0))-(intval(isset($List21[0]) ? $List21[0]->s5 : 0)));}
                            if(isset($MasterdataList1[0]->s_6)) { $s6=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_6 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s6 : 0))-(intval(isset($List21[0]) ? $List21[0]->s6 : 0)));}
                            if(isset($MasterdataList1[0]->s_7)) { $s7=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_7 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s7 : 0))-(intval(isset($List21[0]) ? $List21[0]->s7 : 0)));}
                            if(isset($MasterdataList1[0]->s_8)) { $s8=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_8 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s8 : 0))-(intval(isset($List21[0]) ? $List21[0]->s8 : 0)));}
                            if(isset($MasterdataList1[0]->s_9)) { $s9=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_9 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s9 : 0))-(intval(isset($List21[0]) ? $List21[0]->s9 : 0)));}
                            if(isset($MasterdataList1[0]->s_10)) { $s10=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_10 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s10 : 0))-(intval(isset($List21[0]) ? $List21[0]->s10 : 0)));}
                            if(isset($MasterdataList1[0]->s_11)) { $s11=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_11 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s11 : 0))-(intval(isset($List21[0]) ? $List21[0]->s11 : 0)));}
                            if(isset($MasterdataList1[0]->s_12)) { $s12=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_12 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s12 : 0))-(intval(isset($List21[0]) ? $List21[0]->s12 : 0)));}
                            if(isset($MasterdataList1[0]->s_13)) { $s13=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_13 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s13 : 0))-(intval(isset($List21[0]) ? $List21[0]->s13 : 0)));}
                            if(isset($MasterdataList1[0]->s_14)) { $s14=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_14 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s14 : 0))-(intval(isset($List21[0]) ? $List21[0]->s14 : 0)));}
                            if(isset($MasterdataList1[0]->s_15)) { $s15=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_15 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s15 : 0))-(intval(isset($List21[0]) ? $List21[0]->s15 : 0)));}
                            if(isset($MasterdataList1[0]->s_16)) { $s16=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_16 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s16 : 0))-(intval(isset($List21[0]) ? $List21[0]->s16 : 0)));}
                            if(isset($MasterdataList1[0]->s_17)) { $s17=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_17 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s17 : 0))-(intval(isset($List21[0]) ? $List21[0]->s17 : 0)));}
                            if(isset($MasterdataList1[0]->s_18)) { $s18=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_18 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s18 : 0))-(intval(isset($List21[0]) ? $List21[0]->s18 : 0)));}
                            if(isset($MasterdataList1[0]->s_19)) { $s19=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_19 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s19 : 0))-(intval(isset($List21[0]) ? $List21[0]->s19 : 0)));}
                            if(isset($MasterdataList1[0]->s_20)) { $s20=((intval(isset($MasterdataList1[0]) ? $MasterdataList1[0]->s_20 : 0))-(intval(isset($RejectDataList[0]) ? $RejectDataList[0]->s20 : 0))-(intval(isset($List21[0]) ? $List21[0]->s20 : 0)));}               
                        }
                        ...
                        <tr>
                           ...
                           @endif
                           @php
                                $tot_size_qty_total1 = isset($MasterdataList1[0]->size_qty_total) ? $MasterdataList1[0]->size_qty_total : 0; 
                                $tot_size_qty_total233 = isset($List21[0]->size_qty_total) ? $List21[0]->size_qty_total : 0; 
                                $tot_reject_size_qty_total2 = isset($RejectDataList[0]->size_qty_total) ? $RejectDataList[0]->size_qty_total : 0; 
                                $tot_rtv_size_qty_total2 = isset($RTVDataList[0]->size_qty_total) ? $RTVDataList[0]->size_qty_total : 0; 
                                
                                $tot_size_qty_total = $tot_size_qty_total1-$tot_reject_size_qty_total2-($tot_size_qty_total233-$tot_rtv_size_qty_total2);
                           @endphp
                           <td style="text-align: right;">{{ number_format($tot_size_qty_total) }}</td>
                        </tr>
                        @php }  
                        ...
                        $MasterdataList = DB::select("SELECT sum(size_qty) as qty FROM FGStockDataByTwo WHERE data_type_id = 2  
                                        AND  invoice_no IS NOT NULL AND is_sale =0 AND sales_order_no ='".$Buyer_Purchase_Order_List[0]->tr_code."' AND color_id = '".$List->color_id."' GROUP BY size_id");
                        ...
                        <tr>
                           ...
                           @foreach($MasterdataList as $rowss) 
                           <td style="text-align: right;">{{number_format($rowss->qty)}}</td> 
                           @php
                            $size_qty_total += $rowss->qty;
                           @endphp
                           @endforeach
                           <td style="text-align: right;">{{ $size_qty_total }}</td>
                        </tr>
                        @php
                        }
                        ...
                        $List2 = DB::select("SELECT sum(size_qty) as qty FROM FGStockDataByTwo WHERE data_type_id = 2  
                                        AND  invoice_no IS NOT NULL AND is_sale =0 AND sales_order_no ='".$Buyer_Purchase_Order_List[0]->tr_code."' AND color_id = '".$List->color_id."' GROUP BY size_id");
                                        
                                        
                        $List21 = DB::select("SELECT sum(size_qty) as qty FROM FGStockDataByTwo WHERE data_type_id = 2  
                                        AND  invoice_no IS NOT NULL AND is_sale =0 AND sales_order_no ='".$Buyer_Purchase_Order_List[0]->tr_code."' AND color_id = '".$List->color_id."'");
                                        
                       // echo $MasterdataList[0]->s1
                        if(isset($MasterdataList[0]->s_1)) {$s1=0; $s1=((intval(isset($MasterdataList[0]) ?   $MasterdataList[0]->s_1 : 0))-(intval(isset($List2[0]) ? $List2[0]->qty : 0)));  }
                        if(isset($MasterdataList[0]->s_2)) { $s2=0;  $s2=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_2 : 0  ))-(intval(isset($List2[1]) ? $List2[1]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_3)) {$s3=0; $s3=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_3 : 0))-(intval(isset($List2[2]) ? $List2[2]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_4)) {$s4=0; $s4=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_4 : 0))-(intval(isset($List2[3]) ? $List2[3]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_5)) {$s5=0; $s5=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_5 : 0))-(intval(isset($List2[4]) ? $List2[4]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_6)) {$s6=0; $s6=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_6 : 0))-(intval(isset($List2[5]) ? $List2[5]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_7)) {$s7=0; $s7=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_7 : 0))-(intval(isset($List2[6]) ? $List2[6]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_8)) {$s8=0; $s8=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_8 : 0))-(intval(isset($List2[7]) ? $List2[7]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_9)) {$s9=0; $s9=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_9 : 0))-(intval(isset($List2[8]) ? $List2[8]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_10)) {$s10=0; $s10=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_10 : 0))-(intval(isset($List2[9]) ? $List2[9]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_11)) {$s11=0; $s11=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_11 : 0))-(intval(isset($List2[10]) ? $List2[10]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_12)) {$s12=0; $s12=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_12 : 0))-(intval(isset($List2[11]) ? $List2[11]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_13)) {$s13=0; $s13=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_13 : 0))-(intval(isset($List2[12]) ? $List2[12]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_14)) {$s14=0; $s14=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_14 : 0))-(intval(isset($List2[13]) ? $List2[13]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_15)) {$s15=0; $s15=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_15 : 0))-(intval(isset($List2[14]) ? $List2[14]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_16)) {$s16=0; $s16=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_16 : 0))-(intval(isset($List2[15]) ? $List2[15]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_17)) {$s17=0; $s17=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_17 : 0))-(intval(isset($List2[16]) ? $List2[16]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_18)) {$s18=0; $s18=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_18 : 0))-(intval(isset($List2[17]) ? $List2[17]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_19)) {$s19=0; $s19=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_19 : 0))-(intval(isset($List2[18]) ? $List2[18]->qty : 0)));}
                        if(isset($MasterdataList[0]->s_20)) {$s20=0; $s20=((intval(isset($MasterdataList[0]) ? $MasterdataList[0]->s_20 : 0))-(intval(isset($List2[19]) ? $List2[19]->qty : 0)));}               
                       // echo count($MasterdataList);
                        ...
                        <tr>
                           ...
                           <td style="text-align: right;">{{number_format($s20)}}</td>
                           @endif
                           <td style="text-align: right;">{{ number_format(($MasterdataList[0]->size_qty_total) - $List21[0]->qty) }}</td>
                        </tr>
                        @php } @endphp
                     </tbody>
                     </tbody>
      ...
      $(document).ready(function()
      {
             ...
             $(result).each(function(){
                 ...
                 {  
                     ...
                     res.replace(',', '');
                     $('#Summary tr').last().append('<td class="text-right"><strong>'+res+'%</strong></td>')
                 }
                 else
                 {
                     //var res1 = otherNumbers.toFixed(2);
             ...
             var shipment_qty = $('#Summary tr').last().find('td:nth-child(15) strong').html().replace(/,/g , '');
             var cut_ship_per = ((parseFloat(shipment_qty)/parseFloat(cut_qty)) * 100).toFixed(2);
             var order_ship_per = ((parseFloat(shipment_qty)/parseFloat(order_qty))*100).toFixed(2);
             
             $('#Summary tr').last().find('td:nth-child(18)').html('<b>'+cut_ship_per+'</b>');
             $('#Summary tr').last().find('td:nth-child(19)').html('<b>'+order_ship_per+'</b>');
