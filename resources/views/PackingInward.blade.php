...
<head>
    ...
    <title>Inward For Packing</title>
    <!-- Web Fonts -->
        ...
        <div class="invoice">
            <main>
                <div id="printInvoice" class="outer-border">
                    ...
                    <h4 class="mb-0 fw-bold  text-center"> Gate Pass/ Delivery Note</h4>
                    ...
                    <div class="row g-0  border-top border-bottom ">
                        ...
                        <div class="col-md-6 p-2 border-end">
                            <div class="">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="colon">:</div>
                                    <div class="value">{{ $InwardForPackingMaster[0]->ifp_code }}</div>

                                </div>
                                <div class="info-row">
                                    <div class="label">Delivery Date</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ date("d-m-Y", strtotime($InwardForPackingMaster[0]->ifp_date)) }} </div>
                                </div>
                                <div class="info-row">
                                    <div class="label">Sales Order no</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ $InwardForPackingMaster[0]->sales_order_no }}</div>
                                </div>
                                <div class="info-row">
                                    <div class="label">Work Order No</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ $InwardForPackingMaster[0]->vw_code }}</div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 p-2">
                            ...
                            <div class="info-row">
                                ...
                                <div class="colon">:</div>
                                <div class="value"> {{ $InwardForPackingMaster[0]->mainstyle_name }} </div>
                            </div>
                            <div class="info-row">
                                <div class="label">Sub Style Name</div>
                                <div class="colon">:</div>
                                <div class="value">{{ $InwardForPackingMaster[0]->substyle_name }} </div>
                            </div>
                            <div class="info-row">
                                <div class="label">Style No</div>
                                <div class="colon">:</div>
                                <div class="value"> {{ $InwardForPackingMaster[0]->fg_name }}</div>
                            </div>
                            <div class="info-row">
                                <div class="label">Style Name</div>
                                <div class="colon">:</div>
                                <div class="value"> {{ $InwardForPackingMaster[0]->style_no }}</div>
                            </div>
                        ...
                        <div class="col-md-6 p-2 border-end">
                            <div class="">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="colon">:</div>
                                    <div class="value">{{ $InwardForPackingMaster[0]->Ac_name }}</div>
                                </div>
                                <div class="info-row">
                                    <div class="label">Address</div>
                                    <div class="colon">:</div>
                                    <div class="value"> {{ $InwardForPackingMaster[0]->address }}</div>
                                </div>
                                <div class="info-row">
                                    <div class="label">GST NO</div>
                                    <div class="colon">:</div>
                                    <div class="value"> {{ $InwardForPackingMaster[0]->gst_no }}</div>
                                </div>
                                <div class="info-row">
                                    <div class="label">PAN No</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ $InwardForPackingMaster[0]->pan_no }} </div>
                                </div>
                        ...
                        <!-- <div class="col-md-6 p-2">
                            <div class="">
                                ...
                                <div class="info-row">
                                    <div class="label">Vendor</div>
                                    <div class="colon">:</div>
                                    <div class="value"> Anita - Finish Goods Warehouse </div>
                                </div>
                                <div class="info-row">
                                    <div class="label">Address</div>
                                    <div class="colon">:</div>
                                    <div class="value"> PARVTI INDUSTRIES, YADRAV</div>
                                </div>
                                <div class="info-row">
                                    <div class="label">GST NO</div>
                                    <div class="colon">:</div>
                    ...
                    <!-- Assortment Table -->
                    <h4 class="text-center  fw-bold">Outward For Packing Details</h4>
                    <table class="table table-bordered second table-sm">
                        ...
                        <tr>
                            <th></th>
                            <td class="text-end" colspan="{{count($SizeDetailList) + 2}}">Total: </td>
