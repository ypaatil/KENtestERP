...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Get Cut Panel Issue Vs Production REPORT</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            <form action="{{route('rptCutPanelIssueVsProduction')}}" method="POST" enctype="multipart/form-data">
               @csrf 
               <div class="row">
                   <div class="col-md-2">
                     <div class="mb-3">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="line_id" class="form-control select2" id="line_id" required >
                            <option>--Line No--</option>
                        </select>
                     </div>
                  </div>
               </div>
