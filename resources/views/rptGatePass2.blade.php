...
<div id="invoice">
<section class="get_pass1" style="margin: 4px;">
        <div class="container1"> 
            <div class="row">
                ...
                <div class="col-md-7">
                  ...
                  <p class="get_pass">Get Pass-2<br/><b>From Date:</b>{{$fromDate}} - <b>To Date :</b>{{$toDate}}</p> 
                </div>
                <div class="col-md-2">
...
<section class="ken_table"  style="margin: 4px;">
      <div class="card"> 
            <div class="col-md-12">
                <table action="" class="get_pass2">
                    <thead>
                        <tr>
                              ...
                              <th class="t_head" nowrap>DC No.</th>
                               ...
                               <th class="t_head" nowrap>DC Type </th>
                               ...
                               <th class="t_head" nowrap>Amount</th>
                               <th class="t_head" nowrap>GST%</th>
                               <th class="t_head" nowrap>GST Amount</th>
                               <th class="t_head" nowrap>Total Amount</th>
                    ...
                    <tbody> 
                           ...
                           @endphp
                               ...
                               <td class="t_data text-center">{{$row->ac_name ? $row->ac_name : $row->otherBuyerorVendor}}</td>
                               ...
                               <td class="t_data text-center">{{$row->amount}}</td>
                               <td class="t_data text-center">{{$row->gst_per}}</td>
                               <td class="t_data text-center">{{$row->gst_amt}}</td>
                               <td class="t_data text-center">{{$row->total_amount}}</td>
      ...
      function html_table_to_excel(type)
       {
          ...
          XLSX.writeFile(file, 'Get Pass-2.' + type);
       }
