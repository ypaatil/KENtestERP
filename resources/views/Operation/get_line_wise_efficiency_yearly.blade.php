...
<form action="{{ route('show_line_wise_efficiency_yearly') }}" method="POST" id="insertform">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Unitwise Efficiency Yearly</div>
                    <div class="row">
                        ...
                        <!--            <option value="4">Ken Global Unit 1</option>-->
                        <!--             <option value="5">Ken Global Unit 2</option>  -->
                        <!--        </select>-->
                        <!--    </div>-->
                        <!--</div>-->
            <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Year <span class="spanclr">*</span></label>
                                  <select name="year[]" id="year" class="form-control" autocomplete="off" data-placeholder="Select" tabindex="26" multiple required>
