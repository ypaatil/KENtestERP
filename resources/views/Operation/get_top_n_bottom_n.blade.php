...
<form action="{{ route('show_top_n_bottom_n_efficiency') }}" method="POST" id="insertform">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Top And Bottom Report</div>
                    <div class="row">
                                     <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="dept_id[]" id="dept_id"
                                    class="form-control select2-show-search custom-select" autocomplete="off"
                                    data-placeholder="Select" tabindex="26"  multiple required>
                            ...
                            <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">TOP <span class="spanclr">*</span></label>
                          <input type="text" name="top_n" class="form-control" placeholder="Enter Number" value="" id="top_n" required>
                            </div>
                        </div>
                               <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">BOTTOM <span class="spanclr">*</span></label>
                          <input type="text" name="bottom_n" class="form-control" placeholder="Enter Number" value="" id="bottom_n" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
