...
<form action="{{ route('show_daily_production') }}" method="POST" id="insertform">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Daily Production Report</div>
                    <div class="row">
                                 <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Production Date <span class="spanclr">*</span></label>

                                <input type="text" name="fromDate" class="form-control datepickercls"
                                    placeholder="From Date" value="{{ date('Y-m-d') }}" id="fdate"
                        ...
                        <!--            placeholder="To Date" value="{{ date('Y-m-t',strtotime('-1 month')) }}" id="tdate"-->
                        <!--         >-->
                        <!--    </div>-->
                        <!--</div>-->
...
<div class="modal" id="myModalShow">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body" style="font-weight:bold;font-size:16px;">
                Attendance report generated successfully. Do you want to see report?
            </div>
            <!-- Modal footer -->
