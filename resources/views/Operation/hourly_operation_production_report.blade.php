 ...
 table {
      ...
      rder: #000000 solid 1px;
               ...
               <div id="printInvoice"  style="margin-right:10px;">
                 ...
                 <h5 class="text-center" style="color: #000;font-size:20px;font-weight:bold;">Line: {{ $line_name }}</h5>  
               <!-- Passenger Details -->
    ...
    <div class="table-wrapper">
                ...
                <thead>
                  ...
                  <tbody>
                        ...
                        <tr>
                             <td class="text-center">{{ date('d-m-Y',strtotime($OP->hourlyEntryDate)) }}</td>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.1/jquery.min.js" ></script>
   ...
   <script>  
     ...
     function html_table_to_excel(type)
     {
        ...
        XLSX.writeFile(file, 'Hourly Operation Production Report.' + type);
      }
