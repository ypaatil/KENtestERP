...
<form action="{{ route('unit_wise_efficiency') }}" method="POST" id="insertform">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Monthly Operator Efficiency</div>
                    <div class="row">
                               <div class="col-md-3">
                     <div class="form-group">
                        <label class="form-label">Report Type</label>
                        <select name="reportType" id="reportType"  class="form-control select2-show-search custom-select" required autocomplete="off" data-placeholder="Select" tabindex="26" onchange="getRoute(this.value);">
                           <option label="Select" value=""></option>
                           <option value="1" selected="selected">Wage Report</option>
                          <option value="2">PCS Report</option>
                        </select>
                     </div>
                  </div>     
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                               ...
                               <select name="dept_id[]" id="dept_id"
                                    class="form-control select2-show-search custom-select" autocomplete="off"
                                    data-placeholder="Select" tabindex="26" onChange="getemployee(this.value);" required multiple>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                               ...
                               <select name="employeeCode[]" id="employeeCode"
                                    class="form-control select2-show-search custom-select" autocomplete="off"
                                    data-placeholder="Select" tabindex="26"   multiple>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">From Date <span class="spanclr">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="toDate" class="form-control datepickercls" placeholder="To Date" value="{{ date('Y-m-t') }}" id="tdate"
                                 required>
                            </div>
                        </div>
...
$(function() {
    if ($("#user_type_id").val() == 1) {
        $("#sub_company_id").val(12).trigger('change');
    }
});
...
function getemployee(dept_id) {
    
    
    var mySelections = [];
        $('#dept_id option').each(function(i) {
    ...
    $.ajax({
        type: "POST",
        url: "{{ route('get_operators_list') }}",
        //dataType:"json",
        data: {
            dept_id:mySelections,
            "_token": "{{ csrf_token() }}"
        },
        success: function(response) {

            console.log(response);
            $('#employeeCode').append(response.html);
...
function getRoute(val) 
{
  ...
  $.ajax({
     ...
     success: function(data){
       ...
       //$("#insertform").html(data.html);
        
        $("#insertform").attr('action', data);
