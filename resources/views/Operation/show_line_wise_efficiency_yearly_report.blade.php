...
<tr style="background-color:#91d14f;font-weight: 700;">
   ...
   <th style="background-color:#91d14f;font-weight: 700;">Efficiency</th>  
    ...
    @endphp
       ...
       @foreach($year as $yearRow)
        ...
        <tr> 
          <td class="amount text-right"><a href="show_line_wise_efficiency_monthly/{{ $yearRow }}/{{ $sub_company_id }}">{{ $yearRow }}</a></td>    
 ...
 $producedMin=0;$total_present=0; 
             ...
             if (isset($dataMap[$rowFetch->line_id][$sub_company_id][$yearRow])) {
        foreach($dataMap[$rowFetch->line_id][$sub_company_id][$yearRow] as $record) {
