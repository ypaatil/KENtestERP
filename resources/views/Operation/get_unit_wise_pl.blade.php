...
<form action="{{ route('unit_wise_pl') }}" method="POST" id="insertform">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                               ...
                               <select name="sub_company_id" id="sub_company_id"
                                    ...
                                    data-placeholder="Select" tabindex="26" onChange="getemployee(this.value);" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                               ...
                               <select name="dept_id[]" id="dept_id"
                                    ...
                                    <option value="{{ $rowDept->dept_id }}">
                                        {{ $rowDept->dept_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
$("#gen").click(function(){
   ...
   if($('#sub_company_id').val()!=null && $('#fdate').val()!=null && $('#tdate').val()!=null)
  {
   $('#gen').prop('disabled',true);
    $('#gen').text('Please wait...');
   $('#insertform').submit();
  }
