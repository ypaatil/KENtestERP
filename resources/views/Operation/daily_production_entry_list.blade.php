...
<div class="page-header d-lg-flex d-block">
   <div class="page-leftheader">
      <h4 class="page-title">Daily Production Entry Master List</h4>
   </div>
   ...
   <div class="col-12">
      ...
      <div class="card">
         ...
         <div class="card-header border-bottom-0">
            <a href="{{ Route('daily_production_entry.create') }}"><input type='button' class="btn btn-info mt-2" value='Add New Record' ></a>
         </div>
       ...
       <div class="row">
                 <div class="col-md-2 col-lg-2 py-4 ml-4">
                        ...
                        <input type="date" id="daily_production_date" value="" class="form-control">
                        </div>
                        </div>
                        ...
                        <select name="sub_company_id" id="sub_company_id"  class="form-control" autocomplete="off" data-placeholder="Select" tabindex="26" onChange="getLines(this.value);">
                        ...
                        <option value="686">Ken Global Unit 5</option>  
                        </select>
                        </div>
                        </div>
                        ...
                        <select name="group_id" id="group_id"  class="form-control" autocomplete="off" data-placeholder="Select" tabindex="26">
                        <option label="Select" value="">Any</option>
                        @foreach($groupList as $rowG)
                        <option value="{{ $rowG->group_id }}">{{ $rowG->group_name }}</option>
                        @endforeach
                        </select>
                        </div>
                        </div>
                  ...
                  <thead>
                     <tr>
                         ...
                         <th class="border-bottom-0">Group</th>  
                          <th class="border-bottom-0">Sam</th>   
                          <th class="border-bottom-0">Output</th>  
                           <th class="border-bottom-0">Present</th>    
...
<script type="text/javascript"> 
  ...
  $(function () {
   ...
   function load_data(daily_production_date,sub_company_id,dept_id,group_id)
{   
    ...
    var url = window.location.href;  
       ...
       var table = $('#task-list').DataTable({
        ...
        serverSide: true,
           ...
           ajax: {
                  url:url,
         		  data:  {daily_production_date:daily_production_date,sub_company_id:sub_company_id,dept_id:dept_id,group_id:group_id},
         		  dataSrc: 'data'
               },
    ...
    // }], 
        columns: [
             ...
             {data: 'group_name', name: 'group_masters.group_name'},  
            {data: 'overall_sam', name: 'overall_sam'},  
            {data: 'overall_output', name: 'overall_output'},  
            ...
            var daily_production_date = $("#daily_production_date").val();
            var sub_company_id = $("#sub_company_id").val();
            var dept_id=$('#dept_id').val();
            var group_id=$('#group_id').val();
      
            load_data(daily_production_date,sub_company_id,dept_id,group_id);
