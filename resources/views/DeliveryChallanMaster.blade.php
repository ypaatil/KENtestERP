                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="WashTypeId" class="form-control select2" id="WashTypeId" >
                                                    ...
                                                    @foreach($WashTypeList as  $row) 
                                                        <option value="{{ $row->WashTypeId }}">{{ $row->WashTypeName }}</option> 
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <table  class="table  table-vcenter text-nowrap table-bordered border-bottom footable_2" id="footable_2">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="item_description[]" id="item_description"  tabindex="17" class="form-control"  required="required" style="width:450px;">
                                                    </td>

                                                    <td>
                                                        <select class="form-control select2" data-placeholder="Choose one" name="unit_id[]" style="width:120px;" tabindex="18" id="unit_id" required data-parsley-errors-container="#field1">
                                                    ...
                                                    <td>
                                                        <input type="number" name="rate[]" id="rate" class="form-control" onkeyup="mycalc();" tabindex="20" value="0" step="any"   style="width:120px;">
                                                    </td>
                                                    <td>
                                                        <input type="number" step="any" class="form-control AMT"  name="amount[]" onkeyup="mycalc();" value="0" id="amount1" style="width:80px;" readonly/> 
                                                    ...
                                                    <td>
                                                        <input type="number" step="any" class="form-control TAMT"  name="total_amount[]" onkeyup="mycalc();"  id="total_amount1" style="width:80px;" readonly />
                                                    </td>
