...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Vendor Work Order</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            @if(isset($VendorWorkOrderMasterList))
            <form action="{{ route('VendorWorkOrder.update',$VendorWorkOrderMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="vw_date" class="form-label">Entry Date</label>
                        <input type="date" name="vw_date" class="form-control" id="vw_date" value="{{$VendorWorkOrderMasterList->vw_date}}" required  >
                        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $VendorWorkOrderMasterList->c_code }}">
                        <input type="hidden" name="vw_code" class="form-control" id="vw_code" value="{{$VendorWorkOrderMasterList->vw_code}}" required readOnly>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="sales_order_no" class="form-control select2" id="sales_order_no" required  onChange="getSalesOrderDetails(this.value);" disabled>
                           <option value="">--Sales Order No--</option>
                           @foreach($SalesOrderList as  $row)
                           {
                           <option value="{{ $row->sales_order_no }}"
                           {{ $row->sales_order_no == $VendorWorkOrderMasterList->sales_order_no ? 'selected="selected"' : '' }} 
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="Ac_code" class="form-control  " id="Ac_code" required  disabled>
                           ...
                           {{ $row->ac_code == $VendorWorkOrderMasterList->Ac_code ? 'selected="selected"' : '' }} 
                           >{{ $row->ac_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <input type="hidden" name="order_rate"  id="order_rate" value="0">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="mainstyle_id" class="form-control" id="mainstyle_id"  onchange="getSubStyle(this.value)" required disabled>
                           ...
                           {{ $row->mainstyle_id == $VendorWorkOrderMasterList->mainstyle_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="substyle_id" class="form-control" id="substyle_id" onchange="getStyle(this.value)" required disabled>
                           ...
                           {{ $row->substyle_id == $VendorWorkOrderMasterList->substyle_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="fg_id" class="form-control" id="fg_id" required disabled>
                           ...
                           {{ $row->fg_id == $VendorWorkOrderMasterList->fg_id ? 'selected="selected"' : '' }} 
                           >{{ $row->fg_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$VendorWorkOrderMasterList->style_no}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$VendorWorkOrderMasterList->style_description}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="vendorId" class="form-control" id="vendorId" required  >
                           ...
                           {{  $rowvendor->ac_code == $VendorWorkOrderMasterList->vendorId ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="vpo_date" class="form-label">Delivery Date</label>
                        <input type="date" name="delivery_date" class="form-control" id="delivery_date" value="{{$VendorWorkOrderMasterList->delivery_date}}" required  >
                     </div>
                  </div>
               </div>
               <div class="row">
                     ...
                     <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title">
                                 <a data-toggle="collapse" data-parent="#accordion" href="#collapsex">Stitching GRN Against Work Order Qty</a>
                              </h4>
                           </div>
                        ...
                        <div class="panel panel-default">
                           <div class="panel-heading" style="display: flex;">
                                ...
                                <!--<a href="javascript:void(0);" onclick="setAllQty()" class="btn btn-warning form-control" style="width: 10%;margin-left: 18px;">Set Quantity</a>-->
                           </div>
                                    ...
                                    <div class="table-wrap">
                                       <div class="table-responsive">
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                @php $n=1;$n1=0; $sumAllTotal=0;$arrAllTotal=array(); @endphp
                                                @if(count($VendorWorkOrderDetailList)>0)
                                                @php $no=1; @endphp
                                                @foreach($VendorWorkOrderDetailList as $List) 
                                                <tr>
                                                   ...
                                                   <td>
                                                      ...
                                                      <input type="hidden" name="item_codeo[]"  value="{{$List->item_code}}" id="item_codeo" style="width:80px; height:30px; float:left;"  />
                                                   </td>
                                                   @php 
                                                   $n=1;   $SizeQtyList=explode(',', $List->size_qty_array); $total_sz = 0;
                                                   @endphp
                                                   ...
                                                   @php
                                                        ...
                                                        $nos = $n++;
                                                        $sz = 's'.$nos;
                                                        $min = isset($StitchingGRNList[$n1]->$sz) ? $StitchingGRNList[$n1]->$sz : 0;
                                                   @endphp
                                                   ...
                                                   @endforeach                                      
                                                   @php 
                                                        $arrAllTotal[] = $List->size_qty_total; 
                                                   @endphp
                                                   <td><input type="number" name="size_qty_total[]" class="size_qty_total" value="{{$List->size_qty_total}}" id="size_qty_total" readOnly style="width:80px; height:30px; float:left;"  />
                                                   ...
                                                   <td>  <input type="button" name="size_btn" class="size_btn btn-primary" id="size_btn" value="Calculate" ></td>
                                                </tr>
                                                @php 
                                                        $n1=$n1+1;
                                                        $no=$no+1;
                                          ...
                                          @php
                                                //$commaSeparated = implode(',', $SizeQtyList);
                                          @endphp
                                          <input type="hidden" name="allTotal" value="0" id="allTotal">
                                       ...
                                       <div class="table-responsive">
                                          <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                                             ...
                                             <tbody id="SewingData"> 
                                                ...
                                                $no=1;$colorspk=''; 
                                                    ...
                                                    $SewingTrimsList = App\Models\VendorWorkOrderSewingTrimsDetailModel::
                                                        select(
                                                            ...
                                                            'vendor_work_order_sewing_trims_details.class_id',
                                                            'unit_master.unit_name',
                                                            'vendor_work_order_sewing_trims_details.unit_id'
                                                        )
                                                ...
                                                @endphp
                                                @if(!empty($SewingTrimsList)) 
                                                @foreach($SewingTrimsList as $List) 
                                                @php
                                               
                                                    if (!empty($List->size_array) && isset($List->size_array)) {
                                                        $size_ids = explode(',', $List->size_array);
                                                    } else {
                                                    ...
                                                    ->where('item_code', $List->item_code)->where('sales_order_no', $BOMList[0]->sales_order_no)->get();
                                                    ...
                                                    $ColorList = DB::table('vendor_work_order_detail')
                                                        ->leftjoin('color_master', 'vendor_work_order_detail.color_id', '=', 'color_master.color_id')
                                                ...
                                                $ItemList3 = App\Models\ItemModel::where('delflag','=', '0')->where('item_code','=', $List->item_code)->get();
                                        
                                                $ClassList3 = App\Models\ClassificationModel::where('delflag','=', '0')->get();
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <select name="item_codess[]" class="item_packing_trims" id="item_codess" style="width:200px; height:30px;" disabled>
                                                   ...
                                                   <td >{{rtrim($sizes, ', ');}} </td>
                                                   <td>
                                                      <select name="class_idss[]"   id="class_idss" style="width:200px; height:30px;" disabled>
                                                   ...
                                                   <td><input type="number" step="any" name="consumptionss[]" value="{{$List->consumption}}" id="consumptionss" style="width:80px; height:30px;" readOnly/></td>
                                                   <td>
                                                      <select name="unit_idss[]" class="" id="unit_idss" style="width:100px; height:30px;" disabled>
                                                   ...
                                                   <td><input type="text" name="bom_qtyss[]" value="{{$List->totalbom_qty}}" id="bom_qtyss" style="width:80px; height:30px;" readOnly/></td>
                                                   <input type="hidden" name="bom_qtyss1[]" value="{{$List->actual_qty}}" id="bom_qtyss1" style="width:80px; height:30px;" readOnly/>
                                                   <input type="hidden" name="final_consss[]" value="{{$List->final_cons}}" id="final_consss'.$no.'" style="width:80px; height:30px;" readOnly />
                                                   <input type="hidden" name="size_qtyss[]" value="{{$List->size_qty}}" id="size_qtyss'.$no.'" style="width:80px; height:30px;" readOnly />
                                                </tr>
                                                @php $no=$no+1; @endphp 
                                                @endforeach
                                                @endif
               ...
               <div class="row">
                  ...
                  <div class="col-sm-2">
                     <label for="formrow-inputState" class="form-label">Vendor Rate</label>
                     <div class="mb-3">
                        <input type="number" name="vendorRate" min="0"  @if($user_type!=1) max="{{  $VendorWorkOrderMasterList->vendorRate }}" @else max="1000" @endif class="form-control" id="vendorRate"  value="{{  $VendorWorkOrderMasterList->vendorRate }}" required step="0.01" />
                     </div>
                  </div>
                  <div class="col-sm-2">
                     <label for="formrow-inputState" class="form-label">Total Qty</label>
                     <div class="mb-3">
                        <input type="number" required step="0.01" name="final_bom_qty" class="form-control" id="final_bom_qty"  value="{{$VendorWorkOrderMasterList->final_bom_qty}}"  />
                     </div>
                  </div>
                  <div class="col-sm-2">
                     <label for="formrow-inputState" class="form-label">Cons Per Piece</label>
                     <div class="mb-3">
                        <input type="number" step="any" name="cons_per_piece" class="form-control" id="cons_per_piece"  value="{{$VendorWorkOrderMasterList->cons_per_piece}}"  />
                     </div>
                  </div> 
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="endflag" class="form-control" id="endflag" required>
                           ...
                           {{ $row->job_status_id == $VendorWorkOrderMasterList->endflag ? 'selected="selected"' : '' }}     
                  ...
                  <div class="col-sm-6">
                     <label for="formrow-inputState" class="form-label">Remarks</label>
                     <div class="mb-3">
                        <input type="text" name="narration" class="form-control" id="narration"  value="{{$VendorWorkOrderMasterList->narration}}" />
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <label for="debit_reject_garment" class="form-label">Debit of Rejection Garment</label>
                     <div class="mb-3">
                         <textarea name="debit_reject_garment" rows="2" cols="12" class="form-control" id="debit_reject_garment" > {{ $VendorWorkOrderMasterList->debit_reject_garment ? $VendorWorkOrderMasterList->debit_reject_garment : 'We will be accepting 1% Diff and incase of Shortage we won’t pay charge CM for rejection Pcs In case of rejection more than 1% then Fabric & Trim charges for rejected pcs will be debited towards Invoice. (we won’t accept any CM Charges for these Pcs. )' }} </textarea> 
                     </div>
                  </div>
               </div>
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                     ...
                     <a href="{{ Route('VendorWorkOrder.index') }}" class="btn btn-warning w-md">Cancel</a>
                  </div>
               </div>
         </div>
         </form>
...
<script>
   ...
   $(document).ready(function() {
        ...
        setTimeout(function() {
            ...
            // Loop through each element with the class 'size_qty_total' inside table with id 'footable_2'
            $("#footable_2 .size_qty_total").each(function () {
                var color = $(this).closest('tr').find('select[name="color_id[]"]').val();
                let value = $(this).val() || $(this).text(); // Support both input values and plain text
        
                var color_qty = color + "=>" + value.trim(); // Concatenate properly
                columnSums.push(color_qty); // Add the value to array
            });
        
            let commaSeparatedSums = columnSums.join(","); // Convert array to comma-separated string
            $("#allTotal").val(commaSeparatedSums); // Set value to input with id 'allTotal'
        }, 500);
   ...
   function CalAllTotal()
   {
    ...
    function setAllQty()
    {
        var table = $('#footable_2 > tbody > tr');
        $.each(table, function (i) 
        {
            var td = $(this).find('td:not(:nth-child(1),:nth-child(2))').not(':last');
            console.log(td);
            $.each(td, function (i) 
            {
   ...
   $(document).on("change", 'input[class^="size_id"],input[name^="vendorRate"],input[class^="WASTAGE"],input[class^="WASTAGE1"],input[class^="WASTAGE2"],input[class^="WASTAGE3"]', function (event) 
   { 
       var value = $(this).val();
   ...
   function calculateBomWithWastage(row)
   {
    ...
    //   if(wastage <= max_qty)
    //   { 
           var total_bom = parseFloat(bom_qty1) + parseFloat(parseFloat(bom_qty1) * (wastage/100));
   ...
   function MainBtn()
   {
    ...
    function GetSizeWiseQty(row,size_qty_total) 
    {
       var no=1;
       ...
       var sumAllTotal=$("#final_bom_qty").val();
       var values = [];
    ...
    //   });
       ...
       var size_qty_total=$(row).closest("tr").find('input[name="size_qty_total[]"]').val();
       var size_qty_array=$(row).closest("tr").find('input[name="size_qty_array[]"]').val();
       var tbl_len = $('#footable_2 tbody tr').length;
       $.ajax({
       dataType: "json",
       url: "{{ route('GetWorkOrderSewingCreateConsumption1') }}",
       ...
       { 
            ...
            // Update the first occurrence of each itemCode with the accumulated values
            if(tbl_len > 1)
            {
                var itemCodeMap = {};
                $('#footable_3 tbody tr').each(function() {
                    ...
                    if (itemCodeMap[itemCode]) {
                        ...
                        if (!sizeIds.includes(",")) {
                            ...
                            itemCodeMap[itemCode].bomTotal += parseFloat(bomQty);
                        }
                ...
                $.each(itemCodeMap, function(itemCode, data) {
                   ...
                   // data.row.find('td input[name="bom_qtyss[]"]').val(data.bomTotal).trigger('change'); // Set summed BOM
            ...
            $('#footable_3 tbody').find('td input[name="wastagess[]"]').each(function()
            { 
     ...
     function checkCostingStatus(sales_order_no)
     {
         $.ajax({
               ...
               console.log(data);
                if(data[0]['count']==0)
                {
                    alert('Costing not approved you cant create Work Order and Process Order');
                }
                else
                {
   ...
   // $('table.footable_2').on('change', 'input[name^="s1[]"],input[name^="s2[]"],input[name^="s3[]"],input[name^="s4[]"],input[name^="s5[]"],input[name^="s6[]"],input[name^="s7[]"],input[name^="s8[]"],input[name^="s9[]"],input[name^="s10[]"],input[name^="s11[]"],input[name^="s12[]"],input[name^="s13[]"],input[name^="s14[]"],input[name^="s15[]"],input[name^="s16[]"],input[name^="s17[]"],input[name^="s18[]"],input[name^="s19[]"],input[name^="s20[]"]', function()
   // {
   //   // alert();
   ...
   {
       var total_qty = 0;
       var row = $(this).closest("tr").find('.size_id');
       
        $.each(row, function () 
        {
            total_qty = parseFloat(total_qty) + parseFloat($(this).val());
        });
       $(this).closest("tr").find('.size_qty_total').val(total_qty);
