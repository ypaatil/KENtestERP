...
<div class="row">
   ...
   <div class="col-md-3">
    ...
    <div class="col-md-6">
       <div class="card mini-stats-wid" style="background-color:#152d9f;" >
          <div class="card-body">
              <form action="/FabricStockDataTrialCloned" method="GET">
                  <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6 mt-4"> 
                            ...
                            <a href="/FabricStockDataTrialCloned" class="btn btn-warning">Clear</a>
                      </div>
                  </div>
              </form>
          </div>
    ...
    {       
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                const exportTitle = 'Fabric Stock Report - (' + formattedDate + ')';
                ...
                $('#dt').DataTable({
                    ...
                    columns: [
                       ...
                       { data: "qc_qty", className: 'text-right' },
