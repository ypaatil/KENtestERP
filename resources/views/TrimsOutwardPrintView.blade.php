                ...
                <div id="printInvoice" class="outer-border">
                        ...
                        <div class="col-md-6 p-3 border-end">
                            <div class="">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="colon">:</div>
                                    <div class="value">{{ $TrimsOutwardMaster[0]->trimOutCode }}</div>

                                </div>
                                <div class="info-row">
                                    <div class="label">Delivery Challan Date</div>
                                    <div class="colon">:</div>
                                    <div class="value">{{ $TrimsOutwardMaster[0]->tout_date }} </div>
                                </div>
                                <div class="info-row">
                    ...
                    <div class="row g-0  border-bottom ">
                        ...
                        <div class="col-md-6 p-2 border-end">
                            <div class="">
                                ...
                                <p><b>{{ isset($TrimsOutwardMaster[0]->Ac_name) ? $TrimsOutwardMaster[0]->Ac_name :"" }}</b> <br>{{ isset($TrimsOutwardMaster[0]->address) ? $TrimsOutwardMaster[0]->address :"" }}</p>
                                <p></p>
                                <div class="info-row">
                                    <div class="label">GST NO</div>
                                    <div class="colon">:</div>
                                    <div class="value"> {{ isset($TrimsOutwardMaster[0]->gst_no) ? $TrimsOutwardMaster[0]->gst_no :"" }}</div>
                                </div>
                                <div class="info-row">
                                    <div class="label">STATE</div>
                                    <div class="colon">:</div>
                    ...
                    <table class="table table-bordered table-sm second ">
                        ...
                        <tbody>
                            ...
                            DB::raw('SUM(DISTINCT trimsOutwardDetail.item_qty) as item_qty'),
                            DB::raw("(SELECT state_id
                            FROM ledger_details
                            WHERE ledger_details.trade_name = trimsOutwardDetail.ship_to
                            LIMIT 1) as state_id")
                            )
                            ...
                            $join->on('purchaseorder_detail.pur_code', '=', 'trimsOutwardDetail.po_code')
                            ->on('purchaseorder_detail.item_code', '=', 'trimsOutwardDetail.item_code');
                            })
