...
<div class="col-md-2">    
<h6  style="font-weight:bold;">Date:{{ date('d-m-Y',strtotime(isset($BOMList[0]->bom_date) ? $BOMList[0]->bom_date : date("Y-m-d"))) }}</h6>
</div>
</div>
...
<div id="printInvoice">
    ...
    <div  class="col-md-4">
      ...
      <b style="display: inline-block;text-align: left;" class="mt-1">BOM Date:  </b> <span style="display: inline-block;text-align: right;"> {{ isset($BOMList[0]->bom_date) ? $BOMList[0]->bom_date : date("Y-m-d") }} </span></br>     
      <b style="display: inline-block;text-align: left;" class="mt-1">BOM No:  </b> <span style="display: inline-block;text-align: right;"> {{ isset($BOMList[0]->bom_code) ? $BOMList[0]->bom_code : date("Y-m-d")  }} </span></br>
      <b style="display: inline-block;text-align: left;" class="mt-1">Sales Order no:  </b> <span style="display: inline-block;text-align: right;"> {{ isset($BOMList[0]->sales_order_no) ? $BOMList[0]->sales_order_no : ""  }} </span></br>
      <b style="display: inline-block;text-align: left;" class="mt-1">Buyer: </b>  <span style="display: inline-block;text-align: right;">{{  isset($BOMList[0]->Ac_name) ? $BOMList[0]->Ac_name : ""   }} </span></br>
      <b style="display: inline-block;text-align: left;" class="mt-1">Cost Type :</b>  <span style="display: inline-block;text-align: right;">{{ isset($BOMList[0]->cost_type_name) ? $BOMList[0]->cost_type_name : ""   }} </span></br>
      <b style="display: inline-block;text-align: left;" class="mt-1">FOB Rate :</b>  <span style="display: inline-block;text-align: right;">{{ isset($BOMList[0]->order_rate) ? $BOMList[0]->order_rate : ""   }} </span></br>
     <b style="display: inline-block;text-align: left;" class="mt-1">Season:</b>    <span style="display: inline-block;text-align: right;">{{ isset($BOMList[0]->season_name) ? $BOMList[0]->season_name : ""   }} </span></br>
</div>
    <div  class="col-md-4">         
    <b style="display: inline-block;text-align: left;" class="mt-1">Main Style Category:</b>    <span style="display: inline-block;text-align: right;">{{ isset($BOMList[0]->mainstyle_name) ? $BOMList[0]->mainstyle_name : ""  }} </span></br>
    <b style="display: inline-block;text-align: left;" class="mt-1">Sub Style Category:</b>    <span style="display: inline-block;text-align: right;">{{ isset($BOMList[0]->substyle_name) ? $BOMList[0]->substyle_name : ""  }} </span></br>
    <b style="display: inline-block;text-align: left;" class="mt-1">Style Name:</b>    <span style="display: inline-block;text-align: right;">{{ isset($BOMList[0]->fg_name) ? $BOMList[0]->fg_name : ""  }} </span></br>
    <b style="display: inline-block;text-align: left;" class="mt-1">Style No:</b>    <span style="display: inline-block;text-align: right;">{{ isset($BOMList[0]->style_no) ? $BOMList[0]->style_no : ""  }} </span></br>
    <b style="display: inline-block;text-align: left;" class="mt-1">Currency:</b>  <span style="display: inline-block;text-align: right;">{{ isset($BOMList[0]->currency_name) ? $BOMList[0]->currency_name : ""  }}</span></br>
    <b style="display: inline-block;text-align: left;" class="mt-1">Buyer Order No:</b>  <span style="display: inline-block;text-align: right;">{{  isset($BOMList[0]->bom_code) ? $BOMList[0]->bom_code : ""  }}</span></br>
    </div>
    <div  class="col-md-4" >
...
@php 
     ...
     $bom_code = isset($BOMList[0]->bom_code) ? $BOMList[0]->bom_code : 0;
     ...
     ->where('bom_fabric_details.bom_code','=', $bom_code)->get();   
...
@php
    $sales_order_no = isset($BOMList[0]->sales_order_no) ? $BOMList[0]->sales_order_no : 0;
    ...
    ->where('item_code','=',$rowDetail->item_code)->where('tr_code','=',$sales_order_no)->DISTINCT()->get();
...
<td style="text-align:right">{{ number_format($rowDetail->consumption)  }}</td>
<td>{{ $rowDetail->unit_name  }}</td>
<td style="text-align:right">{{ number_format($rowDetail->rate_per_unit)  }}</td>
<td >{{ $rowDetail->wastage  }}</td>
<td style="text-align:right">{{ number_format($rowDetail->bom_qty)  }}</td>
<td style="text-align:right">{{ number_format($rowDetail->total_amount) }}</td>
</tr>
@php
$FabricAmount = $FabricAmount + $rowDetail->total_amount;
$no=$no+1;
@endphp
@endforeach
</tbody>
...
@php 
     ...
     ->where('bom_trim_fabric_details.bom_code','=', $bom_code)->get();    
...
@php 
     ...
     ->where('bom_sewing_trims_details.bom_code','=', $bom_code)->get();    
...
<td style="text-align:right">{{ number_format($rowDetailtrims->consumption)  }}</td>
<td>{{ $rowDetailtrims->unit_name  }}</td>
<td style="text-align:right">{{ number_format($rowDetailtrims->rate_per_unit)  }}</td>
<td>{{ $rowDetailtrims->wastage  }}</td>
<td style="text-align:right">{{ number_format($rowDetailtrims->bom_qty)  }}</td>
<td style="text-align:right">{{ number_format($rowDetailtrims->total_amount)  }}</td>
</tr>
@php
...
@php 
      ...
      ->where('bom_packing_trims_details.bom_code','=', $bom_code)->get();
...
<td><a href="{{url('images/'.$rowDetailpacking->item_image_path)}}" target="_blank"><img src="{{url('thumbnail/'.$rowDetailpacking->item_image_path)}}"  ></a></td>
<td>{{ $rowDetailpacking->item_name }}</td>
<td>{{ $rowDetailpacking->class_name }}</td>
<td>{{ $rowDetailpacking->description  }}</td>
<td style="text-align:right">{{ number_format($rowDetailpacking->consumption)  }}</td>
<td>{{ $rowDetailpacking->unit_name  }}</td>
<td style="text-align:right">{{ number_format($rowDetailpacking->rate_per_unit)  }}</td>
<td >{{ $rowDetailpacking->wastage  }}</td>
<td style="text-align:right">{{ number_format($rowDetailpacking->bom_qty)  }}</td>
<td style="text-align:right">{{ number_format($rowDetailpacking->total_amount)  }}</td>
</tr>
@php
...
<tr>
<td style="text-align:right">{{ number_format($FabricAmount) }}</td>    
<td style="text-align:right"> {{ number_format((float)($BOMList[0]->sewing_trims_value ?? 0), 2) }}</td>
<td style="text-align:right"> {{ number_format((float)($BOMList[0]->packing_trims_value ?? 0), 2) }}</td>
<td style="text-align:right">{{ number_format((float)($BOMList[0]->total_cost_value ?? 0), 2) }}</td>
</tr>
