...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">WIP Adjustable Qty</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            @if(isset($WIPAdjustableQtyMasterList))
            <form action="{{ route('WIPAdjustableQty.update',$WIPAdjustableQtyMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="WIPAQ_date" class="form-label">Entry Date</label>
                        <input type="date" name="WIPAQ_date" class="form-control" id="WIPAQ_date" value="{{$WIPAdjustableQtyMasterList->WIPAQ_date}}" required  >
                        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $WIPAdjustableQtyMasterList->c_code }}">
                        <input type="hidden" name="WIPAQ_code" class="form-control" id="WIPAQ_code" value="{{$WIPAdjustableQtyMasterList->WIPAQ_code}}" required readOnly>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="vw_code" class="form-control select2" id="vw_code" required  onChange="getSalesOrderDetails(this.value);" disabled>
                           ...
                           {{ $row->vw_code == $WIPAdjustableQtyMasterList->vw_code ? 'selected="selected"' : '' }} 
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$WIPAdjustableQtyMasterList->sales_order_no}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="Ac_code" class="form-control select2" id="Ac_code" required  disabled>
                           ...
                           {{ $row->ac_code == $WIPAdjustableQtyMasterList->Ac_code ? 'selected="selected"' : '' }} 
                           >{{ $row->ac_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="vendor_rate" class="form-control" id="vendor_rate" value="{{$WIPAdjustableQtyMasterList->vendor_rate}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="mainstyle_id" class="form-control" id="mainstyle_id"  onchange="getSubStyle(this.value)" required disabled>
                           ...
                           {{ $row->mainstyle_id == $WIPAdjustableQtyMasterList->mainstyle_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="substyle_id" class="form-control" id="substyle_id" onchange="getStyle(this.value)" required disabled>
                           ...
                           {{ $row->substyle_id == $WIPAdjustableQtyMasterList->substyle_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="fg_id" class="form-control" id="fg_id" required disabled>
                           ...
                           {{ $row->fg_id == $WIPAdjustableQtyMasterList->fg_id ? 'selected="selected"' : '' }} 
                           >{{ $row->fg_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$WIPAdjustableQtyMasterList->style_no}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$WIPAdjustableQtyMasterList->style_description}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="vendorId" class="form-control" id="vendorId" required disabled >
                           ...
                           {{  $rowvendor->ac_code == $WIPAdjustableQtyMasterList->vendorId ? 'selected="selected"' : '' }}
                        ...
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title">
                                 <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">WIP Adjustable Qty Entry</a>
                              </h4>
                           </div>
                                    ...
                                    <div class="table-wrap">
                                       <div class="table-responsive">
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                @if(count($WIPAdjustableQtyDetailList)>0)
                                                @php $no=1;$n=1; @endphp
                                                @foreach($WIPAdjustableQtyDetailList as $List) 
                                                <tr>
               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$WIPAdjustableQtyMasterList->total_qty}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="vendor_amount" class="form-label">Total Amount</label>
                        <input type="text" name="vendor_amount" class="form-control" id="vendor_amount" value="{{$WIPAdjustableQtyMasterList->vendor_amount}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="total_workers" class="form-label">Total Operators</label>
                        <input type="text" name="total_workers" class="form-control" id="total_workers" value="{{$WIPAdjustableQtyMasterList->total_workers}}" required  >
                     </div>
                  </div>
                  <div class="col-sm-8">
                     <label for="formrow-inputState" class="form-label">Narration</label>
                     <div class="mb-3">
                        <input type="text" name="narration" class="form-control" id="narration"  value="{{$WIPAdjustableQtyMasterList->narration}}" />
                     </div>
                  </div>
               </div>
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                     ...
                     <a href="{{ Route('WIPAdjustableQty.index') }}" class="btn btn-warning w-md">Cancel</a>
                  </div>
               </div>
         </div>
         </form>
