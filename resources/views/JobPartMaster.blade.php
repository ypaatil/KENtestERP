...
@else
<form action="{{route('JobPart.store')}}" method="POST">
@csrf 
<div class="row">
...
<div class="col-md-4">
<div class="mb-3">
<label for="jpart_name" class="form-label">Job Part (Short Code)</label>
...
<div class="col-md-4">
<div class="mb-3">
<label for="jpart_description" class="form-label">Job Description</label>
