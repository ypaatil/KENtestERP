...
<body>
  ...
  <script> 
    ...
    function calculateTotal(row) 
    {
        ...
        $.ajax({
            dataType: "json",
            url: "{{ route('StoreQualityControlDataTrial') }}",
    ...
    function StorePopupData(row)
    {
        ...
        $.ajax({
            dataType: "json",
            url: "{{ route('StoreAlterQualityControlDataTrial') }}",
    ...
    function ReadEachDefectData(row)
    {
        ...
        $.ajax({
            dataType: "json",
            url: "{{ route('ReadEachDefectDataTrial') }}",
    ...
    function GetWOrkOrderTable(vw_code)
    {
        $.ajax({
            dataType: "json",
            url: "{{ route('GetQualityControlVWTableTrial') }}",
    ...
    $('.close-btn, .popup-overlay').click(function(e) 
    {
          ...
          $.ajax({
            dataType: "json",
            url: "{{ route('ReadFinalAlterDataTrial') }}",
