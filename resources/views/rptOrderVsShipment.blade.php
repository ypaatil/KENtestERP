                  ...
                  <table class="table table-bordered text-1 table-sm" style="height:10vh; " id="Sales">
                     ...
                     <tbody>
                        ...
                        else
                        {
                         ...
                         //DB::enableQueryLog();  
                        $Buyer_Purchase_Order_List = DB::select("SELECT order_category.OrderCategoryName,buyer_purchse_order_master.*,order_type_master.order_type,usermaster.username,
                            ...
                            LEFT JOIN order_type_master ON order_type_master.orderTypeId = buyer_purchse_order_master.order_type 
                       ...
                       // ->get(['buyer_purchse_order_master.*','usermaster.username','ledger_master.Ac_name','fg_master.fg_name','merchant_master.merchant_name','job_status_master.job_status_name','main_style_master.mainstyle_name' ]);
                        ...
                        //    ->leftJoin('merchant_master', 'merchant_master.merchant_id', '=', 'buyer_purchse_order_master.merchant_id')
                         ...
                         //   ->get();
                   //  DB::enableQueryLog();  
                           $SaleTransactionDetails = DB::select("SELECT order_category.OrderCategoryName, buyer_purchse_order_master.*,order_type_master.order_type, fg_master.fg_name,merchant_master.merchant_name,
                            job_status_master.job_status_name,main_style_master.mainstyle_name, lm1.Ac_name, sale_transaction_master.freight_charges,
                            sale_transaction_master.sale_code,sale_transaction_detail.order_rate as sale_rate,sale_transaction_master.sale_date,
                            sale_transaction_detail.Ac_code, sale_transaction_detail.sales_order_no, hsn_code,
                            ...
                            sum(total_amount) as total_amount,sale_transaction_master.narration as Narr2, ifnull(sales_order_costing_master.sam,0) FROM sale_transaction_detail 
                            left JOIN sale_transaction_master ON sale_transaction_master.sr_no = sale_transaction_detail.sr_no
                            ...
                            LEFT JOIN order_category ON order_category.orderCategoryId = buyer_purchse_order_master.orderCategoryId 
                            LEFT JOIN order_type_master ON order_type_master.orderTypeId = buyer_purchse_order_master.order_type 
                            WHERE sale_transaction_master.sales_head_id IN(1,2,3,5,6,8) AND sale_transaction_detail.sales_order_no = '".$order->tr_code."' AND sale_transaction_detail.Ac_code = '".$order->Ac_code."'".$filterDate1." GROUP BY sale_transaction_master.sale_code");
                      // dd(DB::getQueryLog());  
                        ...
                        @php
                            ...
                            $costingData = DB::SELECT("SELECT * FROM sales_order_costing_master WHERE sales_order_no='".$sales->tr_code."'");
                            
                            $total_cost_value = isset($costingData[0]->total_cost_value) ? $costingData[0]->total_cost_value : 0;
                            $other_value = isset($costingData[0]->other_value) ? $costingData[0]->other_value : 0;
                            $order_rate = isset($costingData[0]->order_rate) ? $costingData[0]->order_rate : 0;
                            $production_value = isset($costingData[0]->production_value) ? $costingData[0]->production_value : 0;
                            $dbk_value = isset($costingData[0]->dbk_value) ? $costingData[0]->dbk_value1 : 0;
                            
                            $profit_value=0.0;
                            $profit_value=  ($order_rate - $total_cost_value);
                          
                            $cmohp1 = $production_value + $profit_value + $other_value + $dbk_value;
                            $cmohp2 = $sales->sam;
                            if($cmohp1 && $cmohp2)
                            {
                                $cmohp = $cmohp1/$cmohp2;
                            ...
                            $cmohp_value = $sales->order_qty*$cmohp;
