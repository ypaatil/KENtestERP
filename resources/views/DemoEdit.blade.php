               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="hidden" name="pki_code" class="form-control" id="pki_code" value="{{$PackingInhouseMasterList->pki_code}}" readOnly>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$PackingInhouseMasterList->sales_order_no}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="vendor_rate" class="form-control" id="vendor_rate" value="{{$PackingInhouseMasterList->vendor_rate}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$PackingInhouseMasterList->style_no}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$PackingInhouseMasterList->style_description}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   @php  
                                                        ...
                                                        $cartonPackedData = DB::SELECT("SELECT COALESCE(SUM($size_ids),0) as carton_packed_qty 
                                                            FROM carton_packing_inhouse_size_detail 
                                                            WHERE sales_order_no = ? AND color_id = ?
                                                        ", [$PackingInhouseMasterList->sales_order_no, $List->color_id]);
                                                
                                                        $carton_qty = isset($cartonPackedData[0]->carton_packed_qty) ? intval($cartonPackedData[0]->carton_packed_qty) : 0;
                                                        
                                                        
                                                        $PackedData = DB::SELECT("SELECT COALESCE(SUM($size_ids),0) as packed_qty 
                                                            FROM packing_inhouse_size_detail 
                                                            WHERE sales_order_no = ? AND color_id = ?
                                                        ", [$PackingInhouseMasterList->sales_order_no, $List->color_id]);
                                                
                                                        $packing_qty = isset($PackedData[0]->packed_qty) ? intval($PackedData[0]->packed_qty) : 0;
                                                        
                                                        $combined = ($carton_qty - $szQty);
                                                        
                                                        $combined1 = ($packing_qty - $carton_qty);
                                                        
                                                        if ($carton_qty == $szQty && $szQty == $packing_qty) 
                                                        {
                                                            $min = 'min='.$szQty;
                                                        } 
                                                        else if($carton_qty == $szQty && $carton_qty == $packing_qty) 
                                                        {
                                                            $min = 'min='.abs(min($combined,$szQty));
                                                        } 
                                                        else if($combined1 == 0) 
                                                        {
                                                            $min = 'min='.$szQty;
                                                        } 
                                                        else if($carton_qty == $packing_qty) 
                                                        {
                                                            $min = 'min='.$szQty;
                                                        } 
                                                        else if($carton_qty < $packing_qty) 
                                                        {
                                                            if ($packing_qty > $carton_qty)
                                                            {
                                                                $min = 'min=0';
                                                            } 
                                                            else
                                                   ...
                                                   @endphp
                                                   <td ><input style="width:80px; float:left;"  name="s@php echo $n; @endphp[]" class="size_id" type="number" packing="{{$packing_qty}}"
                                                            carton="{{$carton_qty}}" {{$max}} onchange="validateSize(this);" id="s@php echo $n; @endphp" value="{{$szQty}}" required />  </td>
                                                   @php $n=$n+1;  @endphp
                                                   @endforeach
                                                   <td>
                                                   ...
                                                   <input type="hidden" name="is_transfered[]" value="{{$List->is_transfered}}" id="is_transfered" style="width:80px; height:30px; float:left;" readOnly  />
...
<script>
    ...
    function validateSize(row) 
    {
        ...
        var packing = $(row).attr('packing');
        var carton = $(row).attr('carton'); 
        var maxQty = $(row).attr('max');
        var combined = parseFloat(carton) - parseFloat(packing);
        var minQty = Math.abs(maxQty) - Math.abs(combined);
   ...
   // });
    ...
    $(document).on("input", ".size_id", function () {
