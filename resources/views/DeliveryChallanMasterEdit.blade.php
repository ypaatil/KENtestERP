                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                <label class="WashTypeId">(Select Only for Washing Sample)</label>
                                                <select name="WashTypeId" class="form-control select2" id="WashTypeId" >
                                                    <option value="">--Select--</option>
                                                    @foreach($WashTypeList as  $row) 
                                                        <option value="{{ $row->WashTypeId }}" {{ $row->WashTypeId == $DeliveryChallanMasterList->WashTypeId ? 'selected="selected"' : '' }}>{{ $row->WashTypeName }}</option> 
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="sales_order_no" class="form-control select2" id="sales_order_no" >
                                                    ...
                                                    @foreach($salesOrderList as  $row) 
                                                        <option value="{{ $row->tr_code }}" {{ $row->tr_code == $DeliveryChallanMasterList->sales_order_no ? 'selected="selected"' : '' }}>{{ $row->tr_code }}</option> 
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <table  class="table  table-vcenter text-nowrap table-bordered border-bottom footable_2" id="footable_2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="delivery">
                                                    ...
                                                    <td>
                                                        <input type="text" name="item_description[]" id="item_description"  tabindex="17" class="form-control" value="{{$rowDetail->item_description}}"  required="required" style="width:450px;" @if($DeliveryChallanMasterList->issue_case_id == 2) readonly @endif>
                                                    </td>

                                                    <td>
                                                        <select class="form-control select2" data-placeholder="Choose one" name="unit_id[]" style="width:120px;" tabindex="18" id="unit_id" required data-parsley-errors-container="#field1" @if($DeliveryChallanMasterList->issue_case_id == 2) disabled @endif>
                                                    ...
                                                    <td>
                                                        <select name="gst_per[]" class="form-control" style="width:70px;"  id="gst_per" onchange="setGST(this);">
                                                            <option value="">-</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <button type="submit"  id="Submit" class="btn btn-primary w-md" id="Submit">Update</button>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#DeliveryChallan').submit(function() {
