            ...
            <div class="">
               <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                  ...
                  <tbody>
                     ...
                     $po_codes1 = "";
                     foreach($purchaseData1 as $purs1 )
                     {
                        $po_codes1 .= $purs1->pur_code.",";
                     } 
                     @endphp
                     <tr>
                        <td>{{ $no }}</td>
                     ...
                     $po_codes2 = "";
                     foreach($purchaseData2 as $purs2 )
                     {
                        $po_codes2 .= $purs2->pur_code.",";
                     } 
                     @endphp
                     <tr>
                        <td>{{ $no }}</td>
                     ...
                     $po_codes3 = "";
                     foreach($purchaseData3 as $purs3 )
                     {
                        $po_codes3 .= $purs3->pur_code.",";
                     } 
                     @endphp
                     <tr>
                        <td>{{ $nos }}</td>
