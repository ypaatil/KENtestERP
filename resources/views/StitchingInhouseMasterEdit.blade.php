...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Stitching Inhouse</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            @if(isset($StitchingInhouseMasterList))
            <form action="{{ route('StitchingInhouse.update',$StitchingInhouseMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="sti_date" class="form-label">Entry Date</label>
                        <input type="date" name="sti_date" class="form-control" id="sti_date" value="{{$StitchingInhouseMasterList->sti_date}}" readOnly  >
                        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $StitchingInhouseMasterList->c_code }}">
                        <input type="hidden" name="sti_code" class="form-control" id="sti_code" value="{{$StitchingInhouseMasterList->sti_code}}" required readOnly>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="vw_code" class="form-control select2" id="vw_code" required  onChange="getSalesOrderDetails(this.value);" disabled>
                           ...
                           {{ $row->vw_code == $StitchingInhouseMasterList->vw_code ? 'selected="selected"' : '' }} 
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$StitchingInhouseMasterList->sales_order_no}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="Ac_code" class="form-control select2" id="Ac_code" required  disabled>
                           ...
                           {{ $row->ac_code == $StitchingInhouseMasterList->Ac_code ? 'selected="selected"' : '' }} 
                           >{{ $row->ac_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="vendor_rate" class="form-control" id="vendor_rate" value="{{$StitchingInhouseMasterList->vendor_rate}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="mainstyle_id" class="form-control" id="mainstyle_id"  onchange="getSubStyle(this.value)" required disabled>
                           ...
                           {{ $row->mainstyle_id == $StitchingInhouseMasterList->mainstyle_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="substyle_id" class="form-control" id="substyle_id" onchange="getStyle(this.value)" required disabled>
                           ...
                           {{ $row->substyle_id == $StitchingInhouseMasterList->substyle_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="fg_id" class="form-control" id="fg_id" required disabled>
                           ...
                           {{ $row->fg_id == $StitchingInhouseMasterList->fg_id ? 'selected="selected"' : '' }} 
                           >{{ $row->fg_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$StitchingInhouseMasterList->style_no}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$StitchingInhouseMasterList->style_description}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="vendorId" class="form-control" id="vendorId" required disabled >
                           ...
                           {{  $rowvendor->ac_code == $StitchingInhouseMasterList->vendorId ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="line_id" class="form-control" id="line_id" required  >
                           ...
                           {{  $rowline->line_id == $StitchingInhouseMasterList->line_id ? 'selected="selected"' : '' }}
                                    ...
                                    <div class="table-wrap">
                                       <div class="table-responsive">
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                @if(count($StitchingInhouseDetailList)>0)
                                                @php $no=1;$n=1; @endphp
                                                @foreach($StitchingInhouseDetailList as $List) 
                                                <tr>
                                                   ...
                                                   @php  
                                                    //DB::enableQueryLog();
                                                        $packingData = DB::SELECT("SELECT ((SELECT SUM(size_qty_total) FROM stitching_inhouse_size_detail WHERE sales_order_no = '".$StitchingInhouseMasterList->sales_order_no."' AND color_id = ".$List->color_id.") - (SELECT SUM(size_qty_total) FROM packing_inhouse_detail WHERE sales_order_no = '".$StitchingInhouseMasterList->sales_order_no."' AND color_id = ".$List->color_id.")) as size_qty_total");
                                                    //dd(DB::getQueryLog());  
                                                    
                                                        $packing_qty = isset($packingData[0]->size_qty_total) ? $packingData[0]->size_qty_total : 0; 
                                                        if($packing_qty > 0)
                                                        {
                                                            $min = $szQty - $packing_qty;
                                                        }
                                                        else
                                                        {
                                                            $min = 0;
                                                   ...
                                                   @endphp
                                                   <td ><input style="width:80px; float:left;"  name="s@php echo $n; @endphp[]" class="size_id" type="number" onchange="validateSize(this);" step="any"  min="{{ max($min, 0) }}" max="{{$szQty}}" id="s@php echo $n; @endphp" value="{{$szQty}}" required />  </td>
                                                   @php $n=$n+1;  @endphp
                                                   @endforeach
               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$StitchingInhouseMasterList->total_qty}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="vendor_amount" class="form-label">Total Amount</label>
                        <input type="text" name="vendor_amount" class="form-control" id="vendor_amount" value="{{$StitchingInhouseMasterList->vendor_amount}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-2">
                    <div class="mb-3">
                    <label for="total_helpers" class="form-label">Total Helpers</label>
                    <input type="text" name="total_helpers" class="form-control" id="total_helpers" value="{{$StitchingInhouseMasterList->total_helpers}}" required  >
                    </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="total_workers" class="form-label">Total Operators</label>
                        <input type="text" name="total_workers" class="form-control" id="total_workers" value="{{$StitchingInhouseMasterList->total_workers}}" required  >
                     </div>
                  </div>
                  <div class="col-sm-8">
                     <label for="formrow-inputState" class="form-label">Narration</label>
                     <div class="mb-3">
                        <input type="text" name="narration" class="form-control" id="narration"  value="{{$StitchingInhouseMasterList->narration}}" />
                     </div>
                  </div>
               </div>
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                     ...
                     <a href="{{ Route('StitchingInhouse.index') }}" class="btn btn-warning w-md">Cancel</a>
                  </div>
               </div>
         </div>
         </form>
