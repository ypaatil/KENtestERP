     ...
     <section class="get_pass1" style="margin: 38px;">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
              ...
              <p class="get_pass"><b>Get Pass-1</b><br/><br/><b> From Date:</b>{{$fromDate}} - <b>To Date :</b>{{$toDate}}</p> 
            </div>
            <div class="col-md-2">
                    ...
                    <thead>
                        <tr>
                              ...
                              <th class="t_head" nowrap>Return DC No.</th>
                               <th class="t_head" nowrap>Return DC Date </th> 
                               ...
                               <th class="t_head" nowrap>Return Amount</th>
                               <th class="t_head" nowrap>GST%</th>
                               <th class="t_head" nowrap>Return GST Amount</th>
                               <th class="t_head" nowrap>Balance Total Amount</th>
      ...
      function html_table_to_excel(type)
       {
          ...
          XLSX.writeFile(file, 'Get Pass-1.' + type);
       }
