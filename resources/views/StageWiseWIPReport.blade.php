...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">Stage Wise WIP Report</h4>
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="javascript: void(0);">Transaction</a></li>
               <li class="breadcrumb-item active">Stage Wise WIP Report</li>
            </ol>
         </div>
      </div>
   </div>
...
<div class="row">
    ...
    <div class="col-md-12">
       <div class="card mini-stats-wid">
          <div class="card-body">
              <form action="/StageWiseWIPReport" method="GET">
                  <div class="row">  
                      ...
                      <div class="col-md-6 mt-3"> 
                            ...
                            <a href="/StageWiseWIPReport" class="btn btn-warning">Clear</a>
                      </div>
                  </div>
              </form>
          </div>
                           ...
                           //   {
                            //    $pack_order_qty = isset($packingOrderQty[0]->pack_order_qty) ? $packingOrderQty[0]->pack_order_qty : 0;
                             ...
                             // else
                              ...
                              $production_value = isset($SalesCostingData[0]->production_value) ? $SalesCostingData[0]->production_value : 0;   
                              ...
                              $total_cost_value = isset($SalesCostingData[0]->total_cost_value) ? $SalesCostingData[0]->total_cost_value : 0;  
                              $dbk_value1 = isset($SalesCostingData[0]->dbk_value1) ? $SalesCostingData[0]->dbk_value1 : 0;            
                              
                              $profit_value = ($row->order_rate - $total_cost_value + $dbk_value1);
                            ...
                            <tr>
                               ...
                               <td nowrap class="text-right">{{ money_format("%!.0n",(($fabric_value + (($production_value/100)*10)) * ($VendorData[0]->work_order_qty - $cutPanelIssueQty))) }}</td>
                               
                               <td class="text-right" nowrap>{{ money_format("%!.0n",($stichingQty))}}</td>
                               <td class="text-right" nowrap>{{ money_format("%!.0n",($sewing)) }} </td>
                               
                               <td nowrap class="text-right">{{ money_format("%!.0n",(($fabric_value + $sewing_trims_value + (($production_value/100)*80)) * ($sewing))) }}</td>
                               ...
                               <td class="text-right">{{ money_format("%!.0n",($fabric_value + $sewing_trims_value + $packing_trims_value + (($production_value/100)*100)) * ($stichingQty - $pack_order_qty - $rejectionQty)) }} </td>
                               ...
                               <td class="text-right" nowrap>{{money_format("%!.0n",((($fabric_value + (($production_value/100)*10)) * ($VendorData[0]->work_order_qty - $cutPanelIssueQty)) + (($fabric_value + $sewing_trims_value + (($production_value/100)*80)) * ($sewing)) + (($fabric_value + $sewing_trims_value + $packing_trims_value + (($production_value/100)*100)) * ($stichingQty - $pack_order_qty - $rejectionQty)))) }}</td>
                             </tr>
                             @php
                              ...
                              $head_total_WIPValue += ((($fabric_value + (($production_value/100)*10)) * ($VendorData[0]->work_order_qty - $cutPanelIssueQty)) + (($fabric_value + $sewing_trims_value + (($production_value/100)*80)) * ($sewing)) + (($fabric_value + $sewing_trims_value + $packing_trims_value + (($production_value/100)*100)) * ($stichingQty - $pack_order_qty - $rejectionQty)));
                             @endphp
                            @endforeach
                         </tbody>
                      </table>
