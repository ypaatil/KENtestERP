                ...
                <div class="row">
                    <div class="col-md-2">
                         <div class="mb-3">
                            ...
                            <input type="date" name="fromDate" id="fromDate" class="form-control" value="{{isset($_GET['fromDate']) ? $_GET['fromDate'] : date('Y-m-d',strtotime("-1 days"))}}">
                         </div>
                      </div> 
                      <div class="col-md-2">
                         <div class="mb-3">
                            <label for="toDate" class="form-label">To Date</label>
                            <input type="date" name="toDate" id="toDate" class="form-control" value="{{isset($_GET['toDate']) ? $_GET['toDate'] :  date('Y-m-d',strtotime("-1 days"))}}">
                         </div>
                      </div>
                       <div class="col-md-2">
                         <div class="mb-3">
        ...
        // ajax: "{{ route('CutPanelIssueReport') }}",
         ajax: {
                  url:"{{ route('CutPanelIssueReport') }}",
         		  data:  {'formFlag':formFlag,'fromDate':fromDate,'toDate':toDate,'Ac_code':Ac_code,'vendorId':vendorId,'sales_order_no':sales_order_no,'clause':clause},
         		  dataSrc: 'data'
         },
         dom: 'lBfrtip',
         buttons: [
