...
<div class="row">
   ...
   <div class="col-md-3">
    ...
    <div class="col-md-6">
       <div class="card mini-stats-wid" style="background-color:#152d9f;" >
          <div class="card-body">
              <form action="/FabricStockDataTrialCloned1" method="GET">
                  <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6 mt-4"> 
                            ...
                            <a href="/FabricStockDataTrialCloned1" class="btn btn-warning">Clear</a>
                      </div>
                  </div>
              </form>
          </div>
               ...
               <table id="dt" class="table table-bordered  nowrap w-100">
                  <thead>
                     <tr style="text-align:center; white-space:nowrap">
                        ...
                        <th>Rate</th>
                        <th>Value</th>
                        <th colspan="2" class="text-center">0-30 Days</th>
                        ...
                        <th colspan="2" class="text-center">180+ Days</th>
                     </tr>
                     <tr style="text-align:center; white-space:nowrap">
                        <th></th>
                        <th></th>
...
<script>
    ...
    function filters(value,row)
    {
        ...
        LoadFabricStockDataTrialCloned1(value);
    }
    ...
    function LoadFabricStockDataTrialCloned1(job_status_id)
    {       
        ...
        var URL = "LoadFabricStockDataTrialCloned2?currentDate="+currentDate+"&job_status_id="+job_status_id;    
        $.ajax({
            dataType: "json",
            type: "GET", 
            url: URL,
    ...
    function UpdateFoutDumpData() 
    {
        $.ajax({
            ...
            success: function(data)
            {
                LoadFabricStockDataTrialCloned1();
            }
        });
    }
