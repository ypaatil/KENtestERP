...
<form action="{{route('Task.store')}}" method="POST" enctype="multipart/form-data" id="frmData">
@csrf 
<div class="row">
...
<div class="col-md-2">
    <div class="mb-3">
     ...
     <input type="hidden" name="task_id" class="form-control" id="task_id" value="{{ 'TSK'.'-'.$row->tr_no }}">
...
@foreach($Ledger as  $rowvendor)
{
    ...
    {{ $rowvendor->ac_code ==  56 ? 'selected="selected"' : '' }} 
...
<div class="col-md-2">
    <div class="mb-3">
        <label for="job_code" class="form-label">Vendor PO</label>
            ...
            @foreach($VPOrderList as  $rowvpo)
            {
                <option value="{{ $rowvpo->vpo_code }}"
               >{{ $rowvpo->vpo_code }} ({{ $rowvpo->sales_order_no }})</option>
            }
            @endforeach
            </select>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text" name="table_avg" class="form-control" id="table_avg" value="" required>
    </div>
</div>
...
<div class="col-md-2">
    <div class="mb-3">
        ...
        <input type="text" name="layers" class="form-control" id="layers" value="" required>
    </div>
</div>
 <div class="col-md-2">
    <div class="mb-3">
        <label for="layers" class="form-label">Width</label>
