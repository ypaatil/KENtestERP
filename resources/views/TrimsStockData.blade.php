...
$Amt=$Amt + round(($row->item_qty-$row->out_qty)*$row->item_rate);
 ...
 if(isset($TrimsInwardDetails2))
 {
 
    foreach($TrimsInwardDetails2 as $row1)  
    {
     $Amt=$Amt + round(($row1->item_qty-$row1->out_qty)*$row1->item_rate);
    }
 }
               ...
               <table id="datatable-buttons" class="table table-bordered   nowrap w-100">
                  <thead>
                     <tr style="text-align:center; white-space:nowrap;background: bisque;" id="total_head">
                        ...
                        <th id="head_total_value">{{money_format('%!i',round($Amt,2))}}</th>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
