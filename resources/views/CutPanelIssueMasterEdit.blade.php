...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Cut Panel Issue</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            @endif
            @if(isset($CutPanelIssueMasterList))
            <form action="{{ route('CutPanelIssue.update',$CutPanelIssueMasterList) }}" method="POST" enctype="multipart/form-data" id="frmData">
               @method('put')
               @csrf
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        <label for="cpi_date" class="form-label">Entry Date</label>
                        <input type="date" name="cpi_date" class="form-control" id="cpi_date" value="{{$CutPanelIssueMasterList->cpi_date}}" required  >
                        <input type="hidden" name="c_code" class="form-control" id="c_code" value="{{ $CutPanelIssueMasterList->c_code }}">
                        <input type="hidden" name="cpi_code" class="form-control" id="cpi_code" value="{{$CutPanelIssueMasterList->cpi_code}}" required readOnly>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="vw_code" class="form-control select2" id="vw_code" required  onChange="getSalesOrderDetails(this.value);" disabled>
                           <option value="">--Vendor Work Order No--</option>
                           @foreach($VendorWorkOrderList as  $row)
                           {
                           <option value="{{ $row->vw_code }}"
                           {{ $row->vw_code == $CutPanelIssueMasterList->vw_code ? 'selected="selected"' : '' }} 
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="sales_order_no" class="form-control" id="sales_order_no" value="{{$CutPanelIssueMasterList->sales_order_no}}" required readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="formrow-inputState" class="form-label">Buyer/Party</label>
                        <select name="Ac_code" class="form-control select2" id="Ac_code" required  disabled>
                           <option value="">--Select Buyer--</option>
                           @foreach($Ledger as  $row)
                           {
                           <option value="{{ $row->ac_code }}"
                           {{ $row->ac_code == $CutPanelIssueMasterList->Ac_code ? 'selected="selected"' : '' }} 
                           >{{ $row->ac_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <input type="hidden" name="vendor_rate" class="form-control" id="vendor_rate" value="{{$CutPanelIssueMasterList->vendor_rate}}">
                  <!-- <div class="col-md-2">-->
                  <!--<div class="mb-3">-->
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="mainstyle_id" class="form-control" id="mainstyle_id"  onchange="getSubStyle(this.value)" required disabled>
                           ...
                           {{ $row->mainstyle_id == $CutPanelIssueMasterList->mainstyle_id ? 'selected="selected"' : '' }}  
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="substyle_id" class="form-control" id="substyle_id" onchange="getStyle(this.value)" required disabled>
                           ...
                           {{ $row->substyle_id == $CutPanelIssueMasterList->substyle_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <select name="fg_id" class="form-control" id="fg_id" disabled>
                           ...
                           {{ $row->fg_id == $CutPanelIssueMasterList->fg_id ? 'selected="selected"' : '' }} 
                           >{{ $row->fg_name }}</option>
                           }
                           @endforeach
                        </select>
                  ...
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="style_no" class="form-control" id="style_no" value="{{$CutPanelIssueMasterList->style_no}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="style_description" class="form-label">Style Description</label>
                        <input type="text" name="style_description" class="form-control" id="style_description" value="{{$CutPanelIssueMasterList->style_description}}" readOnly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="vendorId" class="form-control" id="vendorId" disabled >
                           ...
                           {{  $rowvendor->ac_code == $CutPanelIssueMasterList->vendorId ? 'selected="selected"' : '' }}
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <select name="line_id" class="form-control" id="line_id" required  >
                           ...
                           {{  $rowline->line_id == $CutPanelIssueMasterList->line_id ? 'selected="selected"' : '' }}
                  ...
                  <div class="  "  >
                     <div class="panel-group" id="accordion">
                        ...
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title">
                                 <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Cut Panel Issue Entry</a>
                              </h4>
                           </div>
                                    ...
                                    <div class="table-wrap">
                                       <div class="table-responsive">
                                          <table id="footable_2" class="table  table-bordered table-striped m-b-0  footable_2">
                                             ...
                                             <tbody>
                                                @if(count($CutPanelIssueDetailList)>0)
                                                @php $no=1;$n=1; @endphp
                                                @foreach($CutPanelIssueDetailList as $List) 
                                                <tr>
                                                   ...
                                                   @php  
                                                        ...
                                                        $stitchingData = DB::SELECT("SELECT ((SELECT SUM(size_qty_total) FROM stitching_inhouse_detail WHERE vw_code = '".$CutPanelIssueMasterList->vw_code."' AND sales_order_no = '".$CutPanelIssueMasterList->sales_order_no."' AND color_id = ".$List->color_id.") 
                                                                        - (SELECT SUM(size_qty_total) FROM cut_panel_issue_size_detail WHERE vw_code = '".$CutPanelIssueMasterList->vw_code."' AND sales_order_no = '".$CutPanelIssueMasterList->sales_order_no."' AND color_id = ".$List->color_id.")) as size_qty_total");
                                                        //dd(DB::getQueryLog());
                                                        $stitching_qty = isset($stitchingData[0]->size_qty_total) ? $stitchingData[0]->size_qty_total : 0;
                                                      
                                                        $min = $szQty - abs($stitching_qty);
                                                       
                                                   @endphp
                                                   <td ><input style="width:80px; float:left;"  name="s@php echo $n; @endphp[]" original="{{$szQty}}" max="{{$szQty}}"  onchange="validateSize(this);" min="{{$min}}" class="size_id" type="number" id="s@php echo $n; @endphp" value="{{$szQty}}" required />  </td>
                                                   @php $n=$n+1;  @endphp
                                                   @endforeach
                                                   <td><input type="number" name="size_qty_total[]" class="size_qty_total" original="{{$List->size_qty_total}}" max="{{$List->size_qty_total}}" value="{{$List->size_qty_total}}" id="size_qty_total" style="width:80px; height:30px; float:left;"  />
               ...
               <div class="row">
                  <div class="col-md-2">
                     <div class="mb-3">
                        ...
                        <input type="text" name="total_qty" class="form-control" id="total_qty" value="{{$CutPanelIssueMasterList->total_qty}}" readOnly>
                     </div>
                  </div>
                  <input type="hidden" name="vendor_amount" class="form-control" id="vendor_amount" value="{{$CutPanelIssueMasterList->vendor_amount}}">
                  <!--<div class="col-md-2">-->
                  <!--<div class="mb-3">-->
                  <!--<label for="vendor_amount" class="form-label">Total Amount</label>-->
                  <!--<input type="text" name="vendor_amount" class="form-control" id="vendor_amount" value="{{$CutPanelIssueMasterList->vendor_amount}}" required readOnly>-->
                  <!--</div>-->
                  <!--</div>   -->
                  <div class="col-sm-8">
                     <label for="formrow-inputState" class="form-label">Narration</label>
                     <div class="mb-3">
                        <input type="text" name="narration" class="form-control" id="narration"  value="{{$CutPanelIssueMasterList->narration}}" />
                     </div>
                  </div>
               </div>
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                     ...
                     <a href="{{ Route('CutPanelIssue.index') }}" class="btn btn-warning w-md">Cancel</a>
                  </div>
               </div>
         </div>
         </form>
...
<script>
   ...
   var size_array = sizes.split(',');
     ...
     $("#footable_2 tr td  input[class='size_id']").each(function() {
        ...
        // var number = parseFloat($(this).val()) || 0;
        // var maxNumber = parseFloat($(this).attr('max')) || 0; 
        // var total = parseFloat($(this).closest('tr').find('td input[name="size_qty_total[]"]').val()) || 0;
        // var original = parseFloat($(this).attr('original')) || 0; 
        // // Check if the number exceeds either maxNumber or workOrderQty
        // if (total > maxNumber) 
        // { 
        //     Swal.fire({
        //         title: 'Warning!',
        //         text: `The number ${total} exceeds the maximum allowed value of ${maxNumber}.`,
        //         icon: 'warning',
        //         confirmButtonText: 'OK'
        //     });
    
        //     // Reset the input field and update other related fields
        //     $(this).val(original);
        //     $(this).closest('tr').find('td input[name="size_qty_total[]"]').val(total-number+original);
        //     mycalc();
        // }
       mycalc();
   });
   ...
   function getVendorWorkOrderDetails(vw_code)
   {
     ...
     $.ajax({
           type: "GET",
           dataType:"json",
           url: "{{ route('VendorWorkOrderDetails') }}",
