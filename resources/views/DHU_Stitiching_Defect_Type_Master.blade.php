   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            @if(isset($dhuList))
            <form action="{{ route('StitchingOperation.update',$dhuList) }}" method="POST">
               @method('put')
               @csrf 
               <div class="row">
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="formrow-email-input" class="form-label">Style</label>
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="formrow-email-input" class="form-label">Stitiching Operation Name</label>
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="dhu_sdt_marathi_Name" class="form-label">Stitiching Operation Marathi Name</label>
                        <input type="text" name="dhu_sdt_marathi_Name" class="form-control" id="dhu_sdt_marathi_Name" value="{{$dhuList->dhu_sdt_marathi_Name}}" >
                     </div>
                  </div>
               </div>
               <div>
                  <button type="submit" class="btn btn-primary w-md">Submit</button>
                  <a href="{{route('StitchingOperation.index')}}" class="btn btn-danger w-md">Cancel</a>
               </div>
            </form>
            @else
            <form action="{{route('StitchingOperation.store')}}" method="POST">
               @csrf 
               <div class="row">
                  <div class="col-md-4">
                     <div class="mb-3">
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="dhu_sdt_marathi_Name" class="form-label">Stitiching Operation Marathi Name</label>
                        <input type="text" name="dhu_sdt_marathi_Name" class="form-control" id="dhu_sdt_marathi_Name" value="" >
                     </div>
                  </div>
               </div>
               <div>
